...
import tudatpy.kernel.dynamics.environment_setup.ephemeris
import typing
__all__: list[str] = ['BodySettings', 'Horizons', 'HorizonsBatch', 'HorizonsQuery', 'Time', 'TimeDelta', 'astropy', 'constants', 'datetime', 'ephemeris', 'jpl_horizons', 'math', 'np', 'pd', 're', 'u', 'vstack']
class HorizonsBatch:
    def __init__(self, query_id_list: typing.List[str], location: str, epoch_list: typing.Optional[list] = None, epoch_start: typing.Union[datetime.datetime, float, NoneType] = None, epoch_end: typing.Union[datetime.datetime, float, NoneType] = None, epoch_step: typing.Optional[str] = None, extended_query: bool = False) -> None:
        """
...
class HorizonsQuery:
    ...
    def cartesian(self, frame_orientation: str = 'ECLIPJ2000', aberations: str = 'geometric') -> numpy.ndarray:
        ...
        """
    def create_ephemeris_tabulated(self, frame_origin: str, frame_orientation: str = 'ECLIPJ2000', aberations: str = 'geometric') -> tudatpy.kernel.dynamics.environment_setup.ephemeris.EphemerisSettings:
        """
    ...
    def interpolated_observations(self, degrees: bool = False, reference_system: str = 'J2000', extra_precision: bool = True, *args, **kwargs) -> numpy.ndarray:
        ...
        """
    def interpolated_station_angles(self, degrees: bool = False, reference_system: str = 'J2000', extra_precision: bool = True, *args, **kwargs) -> numpy.ndarray:
        """
        Retrieves interpolated Right Ascension and Declination from the Horizons ephemerides API.
                Note that these values are not real observations but instead interpolated
                values based on the Horizons ephemeris system.
...
def jpl_horizons(horizons_query: str, horizons_location: str, frame_origin: str, frame_orientation: str = 'ECLIPJ2000', query_type: str = 'default', epoch_start: typing.Union[datetime.datetime, float, NoneType] = None, epoch_end: typing.Union[datetime.datetime, float, NoneType] = None, epoch_step: typing.Optional[str] = None, epoch_list: typing.Optional[list] = None, extended_query: bool = False, aberations: str = 'geometric'):
    ...
    """
Horizons: astroquery.jplhorizons.core.HorizonsClass  # value = <astroquery.jplhorizons.core.HorizonsClass object>
