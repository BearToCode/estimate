...
__all__: list[str] = ['DependentVariableDictionary', 'VariableSettings', 'create_dependent_variable_dictionary', 'get_dependent_variable_id', 'get_dependent_variable_shape', 'getmro', 'np', 'result2array']
class DependentVariableDictionary(dict):
    ...
    """
    def _DependentVariableDictionary__read_key(self, key: tudatpy.kernel.dynamics.propagation_setup.dependent_variable.VariableSettings):
        """
        ...
        """
    def __getitem__(self, _DependentVariableDictionary__key: tudatpy.kernel.dynamics.propagation_setup.dependent_variable.VariableSettings):
        """
    ...
    def __repr__(self) -> str:
        ...
        """
    def __setitem__(self, _DependentVariableDictionary__key: tudatpy.kernel.dynamics.propagation_setup.dependent_variable.VariableSettings, _DependentVariableDictionary__value: typing.Any) -> None:
        """
    ...
    def __summary__(self) -> str:
        ...
        """
    def asarray(self, key: tudatpy.kernel.dynamics.propagation_setup.dependent_variable.VariableSettings) -> numpy.ndarray:
        """
