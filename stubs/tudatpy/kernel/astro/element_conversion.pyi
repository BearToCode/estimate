...
class KeplerianElementIndices:
    ...
    """
    __members__: typing.ClassVar[dict[str, KeplerianElementIndices]]  # value = {'semi_major_axis_index': <KeplerianElementIndices.semi_major_axis_index: 0>, 'semi_latus_rectum_index': <KeplerianElementIndices.semi_major_axis_index: 0>, 'eccentricity_index': <KeplerianElementIndices.eccentricity_index: 1>, 'inclination_index': <KeplerianElementIndices.inclination_index: 2>, 'argument_of_periapsis_index': <KeplerianElementIndices.argument_of_periapsis_index: 3>, 'longitude_of_ascending_node_index': <KeplerianElementIndices.longitude_of_ascending_node_index: 4>, 'true_anomaly_index': <KeplerianElementIndices.true_anomaly_index: 5>}
    argument_of_periapsis_index: typing.ClassVar[KeplerianElementIndices]  # value = <KeplerianElementIndices.argument_of_periapsis_index: 3>
    eccentricity_index: typing.ClassVar[KeplerianElementIndices]  # value = <KeplerianElementIndices.eccentricity_index: 1>
    inclination_index: typing.ClassVar[KeplerianElementIndices]  # value = <KeplerianElementIndices.inclination_index: 2>
    longitude_of_ascending_node_index: typing.ClassVar[KeplerianElementIndices]  # value = <KeplerianElementIndices.longitude_of_ascending_node_index: 4>
    semi_latus_rectum_index: typing.ClassVar[KeplerianElementIndices]  # value = <KeplerianElementIndices.semi_major_axis_index: 0>
    semi_major_axis_index: typing.ClassVar[KeplerianElementIndices]  # value = <KeplerianElementIndices.semi_major_axis_index: 0>
    true_anomaly_index: typing.ClassVar[KeplerianElementIndices]  # value = <KeplerianElementIndices.true_anomaly_index: 5>
...
class PositionElementTypes:
    ...
    """
    __members__: typing.ClassVar[dict[str, PositionElementTypes]]  # value = {'cartesian_position_type': <PositionElementTypes.cartesian_position_type: 0>, 'spherical_position_type': <PositionElementTypes.spherical_position_type: 1>, 'geodetic_position_type': <PositionElementTypes.geodetic_position_type: 2>}
    cartesian_position_type: typing.ClassVar[PositionElementTypes]  # value = <PositionElementTypes.cartesian_position_type: 0>
    geodetic_position_type: typing.ClassVar[PositionElementTypes]  # value = <PositionElementTypes.geodetic_position_type: 2>
    spherical_position_type: typing.ClassVar[PositionElementTypes]  # value = <PositionElementTypes.spherical_position_type: 1>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class SphericalOrbitalStateElementIndices:
    ...
    """
    __members__: typing.ClassVar[dict[str, SphericalOrbitalStateElementIndices]]  # value = {'radius_index': <SphericalOrbitalStateElementIndices.radius_index: 0>, 'latitude_index': <SphericalOrbitalStateElementIndices.latitude_index: 1>, 'longitude_index': <SphericalOrbitalStateElementIndices.longitude_index: 2>, 'speed_index': <SphericalOrbitalStateElementIndices.speed_index: 3>, 'flight_path_index': <SphericalOrbitalStateElementIndices.flight_path_index: 4>, 'heading_angle_index': <SphericalOrbitalStateElementIndices.heading_angle_index: 5>}
    flight_path_index: typing.ClassVar[SphericalOrbitalStateElementIndices]  # value = <SphericalOrbitalStateElementIndices.flight_path_index: 4>
    heading_angle_index: typing.ClassVar[SphericalOrbitalStateElementIndices]  # value = <SphericalOrbitalStateElementIndices.heading_angle_index: 5>
    latitude_index: typing.ClassVar[SphericalOrbitalStateElementIndices]  # value = <SphericalOrbitalStateElementIndices.latitude_index: 1>
    longitude_index: typing.ClassVar[SphericalOrbitalStateElementIndices]  # value = <SphericalOrbitalStateElementIndices.longitude_index: 2>
    radius_index: typing.ClassVar[SphericalOrbitalStateElementIndices]  # value = <SphericalOrbitalStateElementIndices.radius_index: 0>
    speed_index: typing.ClassVar[SphericalOrbitalStateElementIndices]  # value = <SphericalOrbitalStateElementIndices.speed_index: 3>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
    ...
    def value(self) -> int:
        ...
def cartesian_to_keplerian(cartesian_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], gravitational_parameter: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
    ...
    """
def cartesian_to_mee(cartesian_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], gravitational_parameter: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
    ...
    """
def cartesian_to_mee_manual_singularity(cartesian_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], gravitational_parameter: typing.SupportsFloat, singularity_at_zero_inclination: bool) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
     Convert Cartesian to Modified equinoctial elements.
     ...
     numpy.ndarray
         Modified equinoctial elements, as computed from Cartesian element input.
    """
def cartesian_to_spherical(cartesian_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
    ...
    """
def cartesian_to_usm_6(cartesian_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], gravitational_parameter: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[7, 1]"]:
    """
    ...
    """
def cartesian_to_usm_7(cartesian_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], gravitational_parameter: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[7, 1]"]:
    """
    ...
    """
def cartesian_to_usm_em(cartesian_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], gravitational_parameter: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[7, 1]"]:
    """
    ...
    """
def convert_cartesian_to_geodetic_coordinates(cartesian_coordinates: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"], equatorial_radius: typing.SupportsFloat, flattening: typing.SupportsFloat, tolerance: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
    """
    ...
    """
def convert_geographic_to_geodetic_latitude(geographic_latitude: typing.SupportsFloat, equatorial_radius: typing.SupportsFloat, flattening: typing.SupportsFloat, altitude: typing.SupportsFloat, tolerance: typing.SupportsFloat, maximum_number_of_iterations: typing.SupportsInt) -> float:
    """
    ...
    """
def convert_position_elements(original_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"], original_element_type: PositionElementTypes, new_element_type: PositionElementTypes, shape_model: ..., tolerance: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
    """
     ...
     numpy.ndarray
         Keplerian elements, as computed from Cartesian element input.
    """
def delta_mean_anomaly_to_elapsed_time(mean_anomaly_change: typing.SupportsFloat, gravitational_parameter: typing.SupportsFloat, semi_major_axis: typing.SupportsFloat) -> float:
    """
    ...
    """
def eccentric_to_mean_anomaly(eccentric_anomaly: typing.SupportsFloat, eccentricity: typing.SupportsFloat) -> float:
    """
    ...
    """
def eccentric_to_true_anomaly(eccentric_anomaly: typing.SupportsFloat, eccentricity: typing.SupportsFloat) -> float:
    """
    ...
    """
def eclipj2000_to_j2000() -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
    """
    ...
    """
def elapsed_time_to_delta_mean_anomaly(elapsed_time: typing.SupportsFloat, gravitational_parameter: typing.SupportsFloat, semi_major_axis: typing.SupportsFloat) -> float:
    """
    ...
    """
def exponential_map_to_quaternion(exponential_map: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[4, 1]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[4, 1]"]:
    """
    ...
    """
def flip_mee_singularity(keplerian_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"]) -> bool:
    """
     ...
     bool
         Singularity at 0 degrees inclination if false, 180 degrees if true
    """
def j2000_to_eclipj2000() -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
    """
    ...
    """
def j2000_to_teme(epoch: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
    """
    ...
    """
def keplerian_to_cartesian(keplerian_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], gravitational_parameter: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
    ...
    """
def keplerian_to_cartesian_elementwise(semi_major_axis: typing.SupportsFloat, eccentricity: typing.SupportsFloat, inclination: typing.SupportsFloat, argument_of_periapsis: typing.SupportsFloat, longitude_of_ascending_node: typing.SupportsFloat, true_anomaly: typing.SupportsFloat, gravitational_parameter: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
     ...
     numpy.ndarray
         Cartesian elements, as computed from Keplerian element input.
    """
def keplerian_to_mee(keplerian_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
    ...
    """
def keplerian_to_mee_manual_singularity(keplerian_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], singularity_at_zero_inclination: bool) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
     Convert Keplerian to Modified equinoctial elements.
    ...
    """
def mean_motion_to_semi_major_axis(mean_motion: typing.SupportsFloat, gravitational_parameter: typing.SupportsFloat) -> float:
    """
    ...
    """
def mean_to_eccentric_anomaly(eccentricity: typing.SupportsFloat, mean_anomaly: typing.SupportsFloat, use_default_initial_guess: bool = True, non_default_initial_guess: typing.SupportsFloat = ..., root_finder: tudatpy.kernel.math.root_finders.RootFinderCore = None) -> float:
    """
    ...
    """
def mean_to_true_anomaly(eccentricity: typing.SupportsFloat, mean_anomaly: typing.SupportsFloat, use_default_initial_guess: bool = True, non_default_initial_guess: typing.SupportsFloat = ..., root_finder: tudatpy.kernel.math.root_finders.RootFinderCore = None) -> float:
    """
     ...
     float
         Value of the true anomaly
    """
def mee_to_cartesian(modified_equinoctial_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], gravitational_parameter: typing.SupportsFloat, singularity_at_zero_inclination: bool) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
    ...
    """
def mee_to_keplerian(modified_equinoctial_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], singularity_at_zero_inclination: bool) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
    ...
    """
def modified_rodrigues_parameters_to_quaternion(modified_rodrigues_parameters: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[4, 1]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[4, 1]"]:
    """
     ...
     numpy.ndarray
         Equivalent quaternion elements
    """
def quaternion_entries_to_rotation_matrix(quaternion_entries: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[4, 1]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
    """
    ...
    """
def quaternion_to_exponential_map(quaternion_entries: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[4, 1]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[4, 1]"]:
    """
    ...
    """
def quaternion_to_modified_rodrigues_parameters(quaternion_entries: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[4, 1]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[4, 1]"]:
    """
    ...
    """
def rotation_matrix_to_quaternion_entries(rotation_matrix: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 3]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[4, 1]"]:
    """
    ...
    """
def semi_major_axis_to_mean_motion(semi_major_axis: typing.SupportsFloat, gravitational_parameter: typing.SupportsFloat) -> float:
    """
     ...
     float
         Semi-major axis corresponding to mean motion
    """
def spherical_to_cartesian(spherical_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
    ...
    """
def spherical_to_cartesian_elementwise(radial_distance: typing.SupportsFloat, latitude: typing.SupportsFloat, longitude: typing.SupportsFloat, speed: typing.SupportsFloat, flight_path_angle: typing.SupportsFloat, heading_angle: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
     ...
     numpy.ndarray
         Cartesian elements, as computed from spherical element input.
    """
def teme_to_j2000(epoch: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
    """
    ...
    """
def true_to_eccentric_anomaly(true_anomaly: typing.SupportsFloat, eccentricity: typing.SupportsFloat) -> float:
    """
     ...
     float
         Hyperbolic eccentric anomaly, if eccentricity is larger than 1, elliptical eccentric anomaly if it is smaller than 1
    """
def true_to_mean_anomaly(eccentricity: typing.SupportsFloat, true_anomaly: typing.SupportsFloat) -> float:
    """
     ...
     float
         Value of the mean anomaly
    """
def usm_6_to_cartesian(usm_6_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[7, 1]"], gravitational_parameter: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
    ...
    """
def usm_7_to_cartesian(usm_7_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[7, 1]"], gravitational_parameter: typing.SupportsFloat, normalize_quaternion: bool = True) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
     ...
     numpy.ndarray
         Cartesian elements, as computed from USM element input.
    """
def usm_em_to_cartesian(usm_em_elements: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[7, 1]"], gravitational_parameter: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
     ...
     numpy.ndarray
         Cartesian elements, as computed from USM element input.
    """
argument_of_periapsis_index: KeplerianElementIndices  # value = <KeplerianElementIndices.argument_of_periapsis_index: 3>
cartesian_position_type: PositionElementTypes  # value = <PositionElementTypes.cartesian_position_type: 0>
eccentricity_index: KeplerianElementIndices  # value = <KeplerianElementIndices.eccentricity_index: 1>
flight_path_index: SphericalOrbitalStateElementIndices  # value = <SphericalOrbitalStateElementIndices.flight_path_index: 4>
geodetic_position_type: PositionElementTypes  # value = <PositionElementTypes.geodetic_position_type: 2>
heading_angle_index: SphericalOrbitalStateElementIndices  # value = <SphericalOrbitalStateElementIndices.heading_angle_index: 5>
inclination_index: KeplerianElementIndices  # value = <KeplerianElementIndices.inclination_index: 2>
latitude_index: SphericalOrbitalStateElementIndices  # value = <SphericalOrbitalStateElementIndices.latitude_index: 1>
longitude_index: SphericalOrbitalStateElementIndices  # value = <SphericalOrbitalStateElementIndices.longitude_index: 2>
longitude_of_ascending_node_index: KeplerianElementIndices  # value = <KeplerianElementIndices.longitude_of_ascending_node_index: 4>
radius_index: SphericalOrbitalStateElementIndices  # value = <SphericalOrbitalStateElementIndices.radius_index: 0>
semi_latus_rectum_index: KeplerianElementIndices  # value = <KeplerianElementIndices.semi_major_axis_index: 0>
semi_major_axis_index: KeplerianElementIndices  # value = <KeplerianElementIndices.semi_major_axis_index: 0>
speed_index: SphericalOrbitalStateElementIndices  # value = <SphericalOrbitalStateElementIndices.speed_index: 3>
spherical_position_type: PositionElementTypes  # value = <PositionElementTypes.spherical_position_type: 1>
true_anomaly_index: KeplerianElementIndices  # value = <KeplerianElementIndices.true_anomaly_index: 5>
