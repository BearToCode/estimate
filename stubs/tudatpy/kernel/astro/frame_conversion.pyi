...
def body_fixed_to_inertial_rotation_matrix(pole_declination: typing.SupportsFloat, pole_right_ascension: typing.SupportsFloat, pole_meridian: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
    """
    ...
    """
def inertial_to_body_fixed_rotation_matrix(pole_declination: typing.SupportsFloat, pole_right_ascension: typing.SupportsFloat, prime_meridian_longitude: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
    """
     ...
     Euler angle rotation (see :cite:t:`Archinal2018`).
    """
def inertial_to_rsw_rotation_matrix(inertial_cartesian_state: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
    """
    ...
    """
def inertial_to_tnw_rotation_matrix(inertial_cartesian_state: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], n_axis_points_away_from_central_body: bool = True) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
    """
    ...
    """
def rotate_state_to_frame(original_state: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], rotation_matrix: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 3]"], rotation_matrix_time_derivative: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 3]"] = ...) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
    ...
    """
def rsw_to_inertial_rotation_matrix(inertial_cartesian_state: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
    """
    ...
    """
def tnw_to_inertial_rotation_matrix(inertial_cartesian_state: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], n_axis_points_away_from_central_body: bool = True) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
    """
