...
import numpy.typing
import typing
__all__: list[str] = ['compute_shadow_function']
def compute_shadow_function(occulted_body_position: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"], occulted_body_radius: typing.SupportsFloat, occulting_body_position: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"], occulting_body_radius: typing.SupportsFloat, satellite_position: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"]) -> float:
    """
