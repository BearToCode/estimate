...
import numpy.typing
import typing
__all__: list[str] = ['legendre_normalization_factor', 'normalize_spherical_harmonic_coefficients', 'spherical_harmonic_coefficients_from_inertia', 'unnormalize_spherical_harmonic_coefficients']
def legendre_normalization_factor(degree: typing.SupportsInt, order: typing.SupportsInt) -> float:
    """
...
def normalize_spherical_harmonic_coefficients(unnormalized_cosine_coefficients: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], unnormalized_sine_coefficients: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]) -> tuple[typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]]:
    ...
    """
def spherical_harmonic_coefficients_from_inertia(inertia_tensor: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 3]"], gravitational_parameter: typing.SupportsFloat, reference_radius: typing.SupportsFloat, output_normalized_coefficients: bool = True) -> tuple[typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"], float]:
    """
