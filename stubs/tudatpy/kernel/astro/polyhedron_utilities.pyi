...
def centroid(vertices_coordinates: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], vertices_defining_each_facet: typing.Annotated[numpy.typing.ArrayLike, numpy.int32, "[m, n]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
    """
    ...
    """
def inertia_tensor_from_density(vertices_coordinates: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], vertices_defining_each_facet: typing.Annotated[numpy.typing.ArrayLike, numpy.int32, "[m, n]"], density: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
    """
...
def modify_centroid(vertices_coordinates: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], vertices_defining_each_facet: typing.Annotated[numpy.typing.ArrayLike, numpy.int32, "[m, n]"], desired_centroid: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
    ...
    """
def surface_area(vertices_coordinates: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], vertices_defining_each_facet: typing.Annotated[numpy.typing.ArrayLike, numpy.int32, "[m, n]"]) -> float:
    """
     ...
     float
         Surface area.
    """
def volume(vertices_coordinates: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], vertices_defining_each_facet: typing.Annotated[numpy.typing.ArrayLike, numpy.int32, "[m, n]"]) -> float:
    """
