...
class DateTime:
    ...
    def from_python_datetime(datetime: datetime.datetime) -> DateTime:
        ...
        """
    @staticmethod
    def from_year_and_day_of_year(year: typing.SupportsInt, day_of_year: typing.SupportsInt) -> DateTime:
        """
        ...
        """
    def __init__(self, year: typing.SupportsInt, month: typing.SupportsInt, day: typing.SupportsInt, hour: typing.SupportsInt = 12, minute: typing.SupportsInt = 0, seconds: typing.SupportsFloat = 0.0) -> None:
        ...
    def __repr__(self) -> str:
        ...
    def __str__(self) -> str:
        ...
    def add_days(self, days_to_add: float) -> DateTime:
        """
    ...
    def epoch_time_object(self) -> Time:
        ...
    def iso_string(self, add_T: bool = False, number_of_digits_seconds: typing.SupportsInt = 15) -> str:
        """
         .. warning::
    ...
    def to_epoch_time_object(self) -> Time:
        ...
    def to_iso_string(self, add_T: bool = False, number_of_digits_seconds: typing.SupportsInt = 15) -> str:
        """
         Function to get the ISO-compatible string.
    ...
    def day(self) -> int:
        ...
        """
    @day.setter
    def day(self, arg1: typing.SupportsInt) -> None:
        ...
    @property
    def hour(self) -> int:
        """
        ...
        """
    @hour.setter
    def hour(self, arg1: typing.SupportsInt) -> None:
        ...
    @property
    def minute(self) -> int:
        """
        ...
        """
    @minute.setter
    def minute(self, arg1: typing.SupportsInt) -> None:
        ...
    @property
    def month(self) -> int:
        """
        ...
        """
    @month.setter
    def month(self, arg1: typing.SupportsInt) -> None:
        ...
    @property
    def seconds(self) -> float:
        ...
        """
    @seconds.setter
    def seconds(self, arg1: typing.SupportsFloat) -> None:
        ...
    @property
    def year(self) -> int:
        """
        ...
        """
    @year.setter
    def year(self, arg1: typing.SupportsInt) -> None:
        ...
class Time:
    """
    ...
    def __init__(self, seconds_since_j2000: float) -> None:
        ...
        """
    @typing.overload
    def __init__(self, seconds_since_j2000: typing.SupportsInt) -> None:
        ...
    @typing.overload
    def __init__(self, full_periods: typing.SupportsInt, seconds_into_full_period: typing.SupportsFloat) -> None:
        """
...
class TimeScaleConverter:
    ...
    """
    def convert_time(self, input_scale: TimeScales, output_scale: TimeScales, input_value: float, earth_fixed_position: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"] = ...) -> float:
        ...
    def convert_time_object(self, input_scale: TimeScales, output_scale: TimeScales, input_value: Time, earth_fixed_position: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"] = ...) -> Time:
        ...
    def get_time_difference(self, input_scale: TimeScales, output_scale: TimeScales, input_value: float, earth_fixed_position: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"] = ...) -> float:
        ...
    def get_time_object_difference(self, input_scale: TimeScales, output_scale: TimeScales, input_value: Time, earth_fixed_position: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"] = ...) -> Time:
        ...
class TimeScales:
    """
    ...
    """
    __members__: typing.ClassVar[dict[str, TimeScales]]  # value = {'tai_scale': <TimeScales.tai_scale: 0>, 'tt_scale': <TimeScales.tt_scale: 1>, 'tdb_scale': <TimeScales.tdb_scale: 2>, 'utc_scale': <TimeScales.utc_scale: 3>, 'ut1_scale': <TimeScales.ut1_scale: 4>}
    tai_scale: typing.ClassVar[TimeScales]  # value = <TimeScales.tai_scale: 0>
    tdb_scale: typing.ClassVar[TimeScales]  # value = <TimeScales.tdb_scale: 2>
    tt_scale: typing.ClassVar[TimeScales]  # value = <TimeScales.tt_scale: 1>
    ut1_scale: typing.ClassVar[TimeScales]  # value = <TimeScales.ut1_scale: 4>
    utc_scale: typing.ClassVar[TimeScales]  # value = <TimeScales.utc_scale: 3>
...
def TDB_to_TCB(TDB_time: float) -> float:
    """
     ...
     epoch : astro.time_representation.Time
         Time object representing the epoch as seconds since J2000, in the TCB time scale.
    """
def TDB_to_TT(TDB_time: Time, earth_fixed_position: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"]) -> Time:
    """
...
def TT_to_TCG(TT_time: float) -> float:
    """
     ...
     astro.time_representation.Time
        Time object representing the epoch as seconds since J2000, in the TCG time scale.
    """
def TT_to_TDB(TT_time: Time, earth_fixed_position: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"]) -> Time:
    """
...
def calendar_date_to_julian_day_since_epoch(calendar_date: datetime.datetime, days_since_julian_day_zero: float = 2451545.0) -> float:
    ...
def date_time_components_to_epoch(year: typing.SupportsInt, month: typing.SupportsInt, day: typing.SupportsInt, hour: typing.SupportsInt, minute: typing.SupportsInt, seconds: typing.SupportsFloat) -> float:
    """
    ...
    """
def date_time_components_to_epoch_time_object(year: typing.SupportsInt, month: typing.SupportsInt, day: typing.SupportsInt, hour: typing.SupportsInt, minute: typing.SupportsInt, seconds: typing.SupportsFloat) -> Time:
    """
...
def default_time_scale_converter() -> TimeScaleConverter:
    ...
    """
def epoch_from_date_time_components(year: typing.SupportsInt, month: typing.SupportsInt, day: typing.SupportsInt, hour: typing.SupportsInt, minute: typing.SupportsInt, seconds: typing.SupportsFloat) -> Time:
    """
     .. warning::
...
def epoch_from_date_time_iso_string(iso_datetime: str) -> Time:
    """
     ...
     float
         Time in seconds since J2000.
    """
def get_days_in_month(month: typing.SupportsInt, year: typing.SupportsInt) -> int:
    """
    ...
    """
def is_leap_year(year: typing.SupportsInt) -> bool:
    """
...
def seconds_since_epoch_to_julian_years_since_epoch(seconds_since_epoch: float) -> float:
    ...
    """
def year_and_days_in_year_to_calendar_date(year: typing.SupportsInt, days_in_year: typing.SupportsInt) -> DateTime:
    """
    .. warning::
    ...
    .. code-block:: python
        ...
        print(currentDate)  # prints (2020, 5, 2, 0, 0)
    """
tai_scale: TimeScales  # value = <TimeScales.tai_scale: 0>
tdb_scale: TimeScales  # value = <TimeScales.tdb_scale: 2>
tt_scale: TimeScales  # value = <TimeScales.tt_scale: 1>
ut1_scale: TimeScales  # value = <TimeScales.ut1_scale: 4>
utc_scale: TimeScales  # value = <TimeScales.utc_scale: 3>
