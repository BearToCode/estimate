...
import tudatpy.kernel.math.geometry
...
class AerodynamicAngleCalculator:
    ...
    """
    def get_angle(self, angle_type: ...) -> float:
        """
        ...
        """
    def get_rotation_matrix_between_frames(self, original_frame: ..., target_frame: ...) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
        """
        ...
        """
    def set_body_orientation_angle_functions(self, angle_of_attack_function: collections.abc.Callable[[], float] = None, angle_of_sideslip_function: collections.abc.Callable[[], float] = None, bank_angle_function: collections.abc.Callable[[], float] = None, angle_update_function: collections.abc.Callable[[typing.SupportsFloat], None] = None, silence_warnings: bool = False) -> None:
        ...
    def set_body_orientation_angles(self, angle_of_attack: typing.SupportsFloat = ..., angle_of_sideslip: typing.SupportsFloat = ..., bank_angle: typing.SupportsFloat = ..., silence_warnings: bool = False) -> None:
        ...
class AerodynamicAngleRotationalEphemeris(RotationalEphemeris):
    def reset_aerodynamic_angle_function(self, arg0: collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]]) -> None:
        ...
...
class AerodynamicCoefficientInterface:
    ...
    """
    def current_control_surface_force_coefficient_increment(self, control_surface_name: str) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
        ...
        """
    def current_control_surface_moment_coefficient_increment(self, control_surface_name: str) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
        ...
        """
    def set_control_surface_increments(self, control_surface_list: collections.abc.Mapping[str, ...]) -> None:
        """
        No documentation found.
        """
    def update_coefficients(self, independent_variables: collections.abc.Sequence[typing.SupportsFloat], time: typing.SupportsFloat) -> None:
        """
                 ...
                 numpy.ndarray
                     Contribution from the requested control surface to the aerodynamic moment coefficients
        """
    def update_full_coefficients(self, independent_variables: collections.abc.Sequence[typing.SupportsFloat], control_surface_independent_variables: collections.abc.Mapping[str, collections.abc.Sequence[typing.SupportsFloat]], time: typing.SupportsFloat, check_force_contribution: bool = True) -> None:
        """
        ...
        """
    @property
    def control_surface_independent_variable_names(self) -> dict[str, list[...]]:
        """
                 **read-only**
        ...
        """
    @property
    def current_coefficients(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
        """
                 **read-only**
        ...
        """
    @property
    def current_control_surface_free_force_coefficients(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
                 **read-only**
        ...
        """
    @property
    def current_control_surface_free_moment_coefficients(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
                 **read-only**
        ...
        """
    @property
    def current_force_coefficients(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
                 **read-only**
        ...
        """
    @property
    def current_moment_coefficients(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
                 **read-only**
        ...
        """
    @property
    def force_coefficient_frame(self) -> ...:
        """
                 **read-only**
        ...
        """
    @property
    def independent_variable_names(self) -> list[...]:
        """
                 **read-only**
        ...
        """
    @property
    def moment_coefficient_frame(self) -> ...:
        """
                 **read-only**
...
class AtmosphereModel:
    ...
    """
    def get_density(self, altitude: typing.SupportsFloat, longitude: typing.SupportsFloat, latitude: typing.SupportsFloat, time: typing.SupportsFloat) -> float:
        """
        ...
        """
    def get_number_density(self, species: ..., altitude: typing.SupportsFloat, longitude: typing.SupportsFloat, latitude: typing.SupportsFloat, time: typing.SupportsFloat) -> float:
        """
        ...
        """
    def get_pressure(self, altitude: typing.SupportsFloat, longitude: typing.SupportsFloat, latitude: typing.SupportsFloat, time: typing.SupportsFloat) -> float:
        """
        ...
        """
    def get_speed_of_sound(self, altitude: typing.SupportsFloat, longitude: typing.SupportsFloat, latitude: typing.SupportsFloat, time: typing.SupportsFloat) -> float:
        """
        ...
        """
    def get_temperature(self, altitude: typing.SupportsFloat, longitude: typing.SupportsFloat, latitude: typing.SupportsFloat, time: typing.SupportsFloat) -> float:
        """
...
class AtmosphericFlightConditions(FlightConditions):
    ...
    def airspeed(self) -> float:
        ...
        """
    @property
    def airspeed_velocity(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
                 **read-only**
...
class Body:
    ...
    def get_ionosphere_model(self) -> IonosphereModel:
        ...
    def state_in_base_frame_from_ephemeris(self, time: tudatpy.kernel.astro.time_representation.Time) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
        """
    ...
    def atmosphere_model(self, arg1: AtmosphereModel) -> None:
        ...
    @property
    def body_fixed_angular_velocity(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
                 **read-only**
        ...
        """
    @property
    def body_fixed_to_inertial_frame(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
        """
                 **read-only**
        ...
        """
    @property
    def body_fixed_to_inertial_frame_derivative(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
        """
                 **read-only**
    ...
    def ground_station_list(self) -> dict[str, GroundStation]:
        ...
        """
    @property
    def inertia_tensor(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
        """
    ...
    def inertia_tensor(self, arg1: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 3]"]) -> None:
        ...
    @property
    def inertial_angular_velocity(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
                 **read-only**
        ...
        """
    @property
    def inertial_to_body_fixed_frame(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
        """
                 **read-only**
        ...
        """
    @property
    def inertial_to_body_fixed_frame_derivative(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
        """
                 **read-only**
    ...
    def radiation_pressure_target_models(self, arg1: collections.abc.Sequence[RadiationPressureTargetModel]) -> None:
        ...
    @property
    ...
    def shape_model(self, arg1: BodyShapeModel) -> None:
        ...
    @property
    def state(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
        """
                 **read-only**
    ...
    def system_models(self, arg1: VehicleSystems) -> None:
        ...
    @property
    def velocity(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
                 **read-only**
...
class CannonballRadiationPressureTargetModel(RadiationPressureTargetModel):
    ...
    def radiation_pressure_coefficient(self, arg1: typing.SupportsFloat) -> None:
        ...
class ConstantEphemeris(Ephemeris):
    ...
    """
    @typing.overload
    def __init__(self, constant_state_function: collections.abc.Callable[[], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]], reference_frame_origin: str = 'SSB', reference_frame_orientation: str = 'ECLIPJ2000') -> None:
        ...
    @typing.overload
    def __init__(self, constant_state: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], reference_frame_origin: str = 'SSB', reference_frame_orientation: str = 'ECLIPJ2000') -> None:
        ...
    def update_constant_state(self, new_state: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"]) -> None:
        """
        No documentation found.
        """
class ConstantTransmittingFrequencyCalculator(TransmittingFrequencyCalculator):
    def __init__(self, frequency: typing.SupportsFloat) -> None:
        ...
class ContinuousInterpolatedMeteoData(StationMeteoData):
    def __init__(self, interpolator: tudatpy.kernel.math.interpolators.OneDimensionalInterpolatorVector, vector_entries: collections.abc.Mapping[MeteoDataEntries, typing.SupportsInt]) -> None:
        ...
...
class CustomBodyFixedDirectionCalculator(InertialBodyFixedDirectionCalculator):
    inertial_body_axis_direction_function: collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]]
class CustomControlSurfaceIncrementAerodynamicInterface(ControlSurfaceIncrementAerodynamicInterface):
    """
    <no_doc, only_dec>
    """
    def __init__(self, coefficient_function: collections.abc.Callable[[collections.abc.Sequence[typing.SupportsFloat]], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]], independent_variable_names: collections.abc.Sequence[...]) -> None:
        ...
...
class DirectLongitudeLibrationCalculator(LongitudeLibrationCalculator):
    def __init__(self, scaled_libration_amplitude: typing.SupportsFloat) -> None:
        ...
class EarthOrientationAnglesCalculator:
    ...
    """
    def get_gcrs_to_itrs_rotation_angles(self, epoch: tudatpy.kernel.astro.time_representation.Time, time_scale: tudatpy.kernel.astro.time_representation.TimeScales = ...) -> tuple[typing.Annotated[numpy.typing.NDArray[numpy.float64], "[5, 1]"], tudatpy.kernel.astro.time_representation.Time]:
        """
...
class Ephemeris:
    ...
    """
    def cartesian_position(self, current_time: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
        ...
        """
    def cartesian_state(self, current_time: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
        """
        ...
        """
    def cartesian_velocity(self, current_time: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
...
class FlightConditions:
    ...
    """
    def update_conditions(self, current_time: typing.SupportsFloat) -> None:
        ...
    @property
    ...
    def altitude(self) -> float:
        ...
        """
    @property
    def body_centered_body_fixed_state(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
        """
                 **read-only**
...
class GravityFieldModel:
    ...
    """
    def __init__(self, gravitational_parameter: typing.SupportsFloat, update_inertia_tensor: collections.abc.Callable[[], None] = None) -> None:
        ...
    ...
    def gravitational_parameter(self, arg1: typing.SupportsFloat) -> None:
        ...
...
class GroundStation:
    ...
    def pointing_angles_calculator(self) -> ...:
        ...
        """
    @property
    def pressure_function(self) -> collections.abc.Callable[[typing.SupportsFloat], float]:
        """
        ...
        """
    @property
    def relative_humidity_function(self) -> collections.abc.Callable[[typing.SupportsFloat], float]:
        """
    ...
    def station_state(self) -> GroundStationState:
        ...
        """
    @property
    def temperature_function(self) -> collections.abc.Callable[[typing.SupportsFloat], float]:
        """
...
class GroundStationState:
    ...
    """
    def get_cartesian_position(self, current_time: typing.SupportsFloat, target_frame_origin: str = '') -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
        ...
        """
    def get_cartesian_state(self, current_time: typing.SupportsFloat, target_frame_origin: str = '') -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
        ...
    @property
    def cartesian_positon_at_reference_epoch(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
                 **read-only**
        ...
        """
    @property
    def geodetic_position_at_reference_epoch(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
                 **read-only**
        ...
        """
    @property
    def rotation_matrix_body_fixed_to_topocentric(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
        """
                 **read-only**
        ...
        """
    @property
    def spherical_positon_at_reference_epoch(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
                 **read-only**
...
class HypersonicLocalInclinationAnalysis(AerodynamicCoefficientGenerator36):
    def __init__(self, independent_variable_points: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsFloat]], body_shape: tudatpy.kernel.math.geometry.SurfaceGeometry, number_of_lines: collections.abc.Sequence[typing.SupportsInt], number_of_points: collections.abc.Sequence[typing.SupportsInt], invert_orders: collections.abc.Sequence[bool], selected_methods: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]], reference_area: typing.SupportsFloat, reference_length: typing.SupportsFloat, moment_reference_point: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"], save_pressure_coefficients: bool = False) -> None:
        """
...
class MeteoDataEntries:
    ...
    """
    __members__: typing.ClassVar[dict[str, MeteoDataEntries]]  # value = {'temperature_meteo_data': <MeteoDataEntries.temperature_meteo_data: 0>, 'pressure_meteo_data': <MeteoDataEntries.pressure_meteo_data: 1>, 'water_vapor_pressure_meteo_data': <MeteoDataEntries.water_vapor_pressure_meteo_data: 2>, 'relative_humidity_meteo_data': <MeteoDataEntries.relative_humidity_meteo_data: 3>, 'dew_point_meteo_data': <MeteoDataEntries.dew_point_meteo_data: 4>}
    dew_point_meteo_data: typing.ClassVar[MeteoDataEntries]  # value = <MeteoDataEntries.dew_point_meteo_data: 4>
    pressure_meteo_data: typing.ClassVar[MeteoDataEntries]  # value = <MeteoDataEntries.pressure_meteo_data: 1>
    relative_humidity_meteo_data: typing.ClassVar[MeteoDataEntries]  # value = <MeteoDataEntries.relative_humidity_meteo_data: 3>
    temperature_meteo_data: typing.ClassVar[MeteoDataEntries]  # value = <MeteoDataEntries.temperature_meteo_data: 0>
    water_vapor_pressure_meteo_data: typing.ClassVar[MeteoDataEntries]  # value = <MeteoDataEntries.water_vapor_pressure_meteo_data: 2>
...
class MultiArcEphemeris(Ephemeris):
    def __init__(self, single_arc_ephemerides: collections.abc.Mapping[typing.SupportsFloat, Ephemeris], reference_frame_origin: str = 'SSB', reference_frame_orientation: str = 'ECLIPJ2000') -> None:
        ...
class PiecewiseLinearFrequencyInterpolator(TransmittingFrequencyCalculator):
    def __init__(self, start_times: collections.abc.Sequence[tudatpy.kernel.astro.time_representation.Time], end_times: collections.abc.Sequence[tudatpy.kernel.astro.time_representation.Time], ramp_rates: collections.abc.Sequence[typing.SupportsFloat], start_frequency: collections.abc.Sequence[typing.SupportsFloat]) -> None:
        ...
    def compute_current_frequency(self, lookup_time_original: tudatpy.kernel.astro.time_representation.Time) -> float:
        ...
    @property
    def end_times(self) -> list[tudatpy.kernel.astro.time_representation.Time]:
        ...
    @property
    def ramp_rates(self) -> list[float]:
        ...
    @property
    def start_frequencies(self) -> list[float]:
        ...
    @property
    def start_times(self) -> list[tudatpy.kernel.astro.time_representation.Time]:
        ...
class PointingAnglesCalculator:
    def calculate_azimuth_angle(self, inertial_vector_to_target: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"], time: typing.SupportsFloat) -> float:
        """
        ...
        """
    def calculate_elevation_angle(self, inertial_vector_to_target: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"], time: typing.SupportsFloat) -> float:
        """
        ...
        """
    def convert_inertial_vector_to_topocentric(self, inertial_vector: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"], time: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        ...
class PolyhedronGravityField(GravityFieldModel):
    @property
    def vertices_coordinates(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        ...
    @property
    def vertices_defining_each_facet(self) -> typing.Annotated[numpy.typing.NDArray[numpy.int32], "[m, n]"]:
        ...
    @property
...
class RigidBodyProperties:
    ...
    """
    def update(self, time: typing.SupportsFloat) -> None:
        """
        ...
        """
    @property
    def current_center_of_mass(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
        ...
        """
    @property
    def current_inertia_tensor(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
        """
...
class RotationalEphemeris:
    ...
    """
    def angular_velocity_in_body_fixed_frame(self, time: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
        ...
        """
    def angular_velocity_in_inertial_frame(self, time: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
        """
                 ...
                 numpy.ndarray
                     Angular velocity vector of the body  :math:`\\boldsymbol{\\omega}^{(B)}` expressed in the body-fixed frame :math:`B`
        """
    def body_fixed_to_inertial_rotation(self, time: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
        """
        ...
        """
    def inertial_to_body_fixed_rotation(self, time: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
        """
                 ...
                 current_time : astro.time_representation.Time
                     Time object representing seconds since J2000 (TDB) at which the rotation matrix is evaluated
        """
    def time_derivative_body_fixed_to_inertial_rotation(self, time: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
        """
        ...
        """
    def time_derivative_inertial_to_body_fixed_rotation(self, time: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
        """
...
class SphericalHarmonicsGravityField(GravityFieldModel):
    ...
    """
    @property
    def cosine_coefficients(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
    ...
    def cosine_coefficients(self, arg1: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]) -> None:
        ...
    @property
    ...
    def reference_radius(self) -> float:
        ...
        """
    @property
    def sine_coefficients(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
    ...
    def sine_coefficients(self, arg1: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]) -> None:
        ...
...
class TabulatedEphemeris(Ephemeris):
    interpolator: tudatpy.kernel.math.interpolators.OneDimensionalInterpolatorVector
class TimeDependentSphericalHarmonicsGravityField(SphericalHarmonicsGravityField):
    ...
    def gravity_field_variation_models(self) -> list[...]:
        ...
        """
    @property
    def nominal_cosine_coefficients(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
    ...
    def nominal_cosine_coefficients(self, arg1: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]) -> None:
        ...
    @property
    def nominal_sine_coefficients(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
    ...
    def nominal_sine_coefficients(self, arg1: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]) -> None:
        ...
class TimingSystem:
    """
    No documentation found.
    """
    @typing.overload
    def __init__(self, arc_times: collections.abc.Sequence[tudatpy.kernel.astro.time_representation.Time], all_arcs_polynomial_drift_coefficients: collections.abc.Sequence[typing.SupportsFloat] = [], clock_noise_generation_function: collections.abc.Callable[[typing.SupportsFloat, typing.SupportsFloat, typing.SupportsFloat], collections.abc.Callable[[typing.SupportsFloat], float]] = None, clock_noise_time_step: typing.SupportsFloat = 0.001) -> None:
        ...
    @typing.overload
    def __init__(self, arc_times: collections.abc.Sequence[tudatpy.kernel.astro.time_representation.Time], polynomial_drift_coefficients: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsFloat]], clock_noise_generation_function: collections.abc.Callable[[typing.SupportsFloat, typing.SupportsFloat, typing.SupportsFloat], collections.abc.Callable[[typing.SupportsFloat], float]] = None, clock_noise_time_step: typing.SupportsFloat = 0.001) -> None:
        ...
    @typing.overload
    def __init__(self, polynomial_drift_coefficients: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsFloat]], stochastic_clock_noise_functions: collections.abc.Sequence[collections.abc.Callable[[typing.SupportsFloat], float]], arc_times: collections.abc.Sequence[tudatpy.kernel.astro.time_representation.Time]) -> None:
        ...
class Tle:
    @typing.overload
...
class VehicleSystems:
    ...
    def get_engine_model(self, engine_name: str) -> ...:
        ...
        """
    def set_control_surface_deflection(self, control_surface_id: str, deflection_angle: typing.SupportsFloat) -> None:
        """
    ...
    def set_default_transponder_turnaround_ratio_function(self) -> None:
        """
        Retrieve standard, DSN turnaround ratios based on the frequency bands of the link
        """
    @typing.overload
    def set_reference_point(self, reference_point: str, location: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"], frame_origin: str = '', frame_orientation: str = '') -> None:
        """
        No documentation found.
        """
    @typing.overload
    def set_reference_point(self, reference_point: str, ephemeris: Ephemeris) -> None:
        """
        No documentation found.
        """
    def set_timing_system(self, timing_system: ...) -> None:
        ...
    def set_transmitted_frequency_calculator(self, transmitted_frequency_calculator: ...) -> None:
        """
        ...
        """
    def set_transponder_turnaround_ratio(self, transponder_ratio_per_uplink_and_downlink_frequency_band: collections.abc.Mapping[tuple[..., ...], typing.SupportsFloat]) -> None:
        """
        No documentation found.
        """
...
def get_default_local_inclination_sideslip_angle_points() -> list[float]:
    ...
def get_local_inclination_mesh(local_inclination_analysis_object: HypersonicLocalInclinationAnalysis) -> tuple[list[typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]], list[typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]]]:
    ...
...
def save_vehicle_mesh_to_file(local_inclination_analysis_object: HypersonicLocalInclinationAnalysis, output_directory: str, output_file_prefix: str = '') -> None:
    ...
    """
def transform_to_inertial_orientation(state_in_body_fixed_frame: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], current_time: typing.SupportsFloat, rotational_ephemeris: RotationalEphemeris) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
    ...
    """
dew_point_meteo_data: MeteoDataEntries  # value = <MeteoDataEntries.dew_point_meteo_data: 4>
pressure_meteo_data: MeteoDataEntries  # value = <MeteoDataEntries.pressure_meteo_data: 1>
relative_humidity_meteo_data: MeteoDataEntries  # value = <MeteoDataEntries.relative_humidity_meteo_data: 3>
temperature_meteo_data: MeteoDataEntries  # value = <MeteoDataEntries.temperature_meteo_data: 0>
water_vapor_pressure_meteo_data: MeteoDataEntries  # value = <MeteoDataEntries.water_vapor_pressure_meteo_data: 2>
