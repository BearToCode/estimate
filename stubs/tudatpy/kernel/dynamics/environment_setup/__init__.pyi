...
class BodySettings:
    ...
    def constant_mass(self, arg0: typing.SupportsFloat) -> None:
        ...
    @property
    ...
    def gravity_field_variation_settings(self, arg0: collections.abc.Sequence[gravity_field_variation.GravityFieldVariationSettings]) -> None:
        ...
    @property
    ...
    def ground_station_settings(self, arg0: collections.abc.Sequence[ground_station.GroundStationSettings]) -> None:
        ...
    @property
    ...
    def radiation_pressure_settings(self, arg0: collections.abc.Mapping[str, radiation_pressure.RadiationPressureInterfaceSettings]) -> None:
        ...
    @property
    ...
    def shape_deformation_settings(self, arg0: collections.abc.Sequence[shape_deformation.BodyDeformationSettings]) -> None:
        ...
    @property
    ...
    def vehicle_shape_settings(self, arg0: vehicle_systems.FullPanelledBodySettings) -> None:
        ...
def add_aerodynamic_coefficient_interface(bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, body_name: str, coefficient_settings: aerodynamic_coefficients.AerodynamicCoefficientSettings) -> None:
    """
    ...
    """
def add_empty_tabulated_ephemeris(bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, body_name: str, ephemeris_origin: str = '', is_part_of_multi_arc: bool = False) -> None:
    """
    No documentation found.
    """
def add_engine_model(body_name: str, engine_name: str, thrust_magnitude_settings: ..., bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, body_fixed_thrust_direction: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"] = ...) -> None:
    """
    ...
    """
def add_flight_conditions(bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, body_name: str, central_body_name: str) -> None:
    """
    ...
    """
def add_gravity_field_model(bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, body_name: str, gravity_field_settings: gravity_field.GravityFieldSettings, gravity_field_variation_settings: collections.abc.Sequence[gravity_field_variation.GravityFieldVariationSettings] = []) -> None:
    """
    No documentation found.
    """
@typing.overload
def add_ground_station(body: tudatpy.kernel.dynamics.environment.Body, ground_station_name: str, ground_station_position: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"], position_type: tudatpy.kernel.astro.element_conversion.PositionElementTypes = ..., station_motion_settings: collections.abc.Sequence[ground_station.GroundStationMotionSettings] = []) -> None:
    ...
@typing.overload
def add_ground_station(body: tudatpy.kernel.dynamics.environment.Body, ground_station_settings: ground_station.GroundStationSettings) -> None:
    """
    No documentation found.
    """
def add_mass_properties_model(bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, body_name: str, mass_property_settings: rigid_body.RigidBodyPropertiesSettings) -> None:
    ...
def add_radiation_pressure_interface(bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, body_name: str, radiation_pressure_settings: radiation_pressure.RadiationPressureInterfaceSettings) -> None:
    ...
def add_radiation_pressure_target_model(bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, body_name: str, radiation_pressure_target_settings: radiation_pressure.RadiationPressureTargetModelSettings) -> None:
    """
    ...
    """
def add_rigid_body_properties(bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, body_name: str, rigid_body_property_settings: rigid_body.RigidBodyPropertiesSettings) -> None:
    """
    ...
    """
def add_rotation_model(bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, body_name: str, rotation_model_settings: rotation_model.RotationModelSettings) -> None:
    """
    ...
    """
def add_variable_direction_engine_model(body_name: str, engine_name: str, thrust_magnitude_settings: ..., bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, body_fixed_thrust_direction_function: collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]]) -> None:
    """
     Function that creates an engine model (to be used for thrust calculations), and adds it to an existing body.
    ...
    """
def convert_ground_station_state_between_itrf_frames(ground_station_state: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], epoch: typing.SupportsFloat, base_frame: str, target_frame: str) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
    No documentation found.
    """
@typing.overload
def create_aerodynamic_coefficient_interface(coefficient_settings: aerodynamic_coefficients.AerodynamicCoefficientSettings, body: str) -> tudatpy.kernel.dynamics.environment.AerodynamicCoefficientInterface:
    ...
@typing.overload
def create_aerodynamic_coefficient_interface(coefficient_settings: aerodynamic_coefficients.AerodynamicCoefficientSettings, body: str, bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies) -> tudatpy.kernel.dynamics.environment.AerodynamicCoefficientInterface:
    """
    No documentation found.
    """
def create_body_ephemeris(ephemeris_settings: ephemeris.EphemerisSettings, body_name: str) -> tudatpy.kernel.dynamics.environment.Ephemeris:
    """
    ...
    """
def create_ground_station_ephemeris(arg0: tudatpy.kernel.dynamics.environment.Body, arg1: str, arg2: tudatpy.kernel.dynamics.environment.SystemOfBodies) -> tudatpy.kernel.dynamics.environment.Ephemeris:
    """
    station_name
    """
def create_radiation_pressure_interface(radiationPressureInterfaceSettings: radiation_pressure.RadiationPressureInterfaceSettings, body_name: str, body_dict: tudatpy.kernel.dynamics.environment.SystemOfBodies) -> ...:
    ...
def create_simplified_system_of_bodies(initial_time: typing.SupportsFloat = 0) -> tudatpy.kernel.dynamics.environment.SystemOfBodies:
    """
    ...
    """
def create_system_of_bodies(body_settings: BodyListSettings) -> tudatpy.kernel.dynamics.environment.SystemOfBodies:
    """
     ...
     :class:`~tudatpy.dynamics.environment.SystemOfBodies`
         Object containing the objects for bodies and environment models constituting the physical environment
    """
def create_tabulated_ephemeris_from_spice(body: str, initial_time: tudatpy.kernel.astro.time_representation.Time, end_time: tudatpy.kernel.astro.time_representation.Time, time_step: tudatpy.kernel.astro.time_representation.Time, observer_name: str, reference_frame_name: str, interpolator_settings: tudatpy.kernel.math.interpolators.InterpolatorSettings = ...) -> tudatpy.kernel.dynamics.environment.Ephemeris:
    ...
def get_default_body_settings(bodies: collections.abc.Sequence[str], base_frame_origin: str = 'SSB', base_frame_orientation: str = 'ECLIPJ2000') -> BodyListSettings:
    """
    ...
    """
def get_default_body_settings_time_limited(bodies: collections.abc.Sequence[str], initial_time: typing.SupportsFloat, final_time: typing.SupportsFloat, base_frame_origin: str = 'SSB', base_frame_orientation: str = 'ECLIPJ2000', time_step: typing.SupportsFloat = 300.0) -> BodyListSettings:
    """
...
def get_default_single_alternate_body_settings(body_name: str, source_body_name: str, base_frame_orientation: str = 'ECLIPJ2000') -> BodySettings:
    ...
    """
def get_default_single_alternate_body_settings_time_limited(body_name: str, source_body_name: str, initial_time: typing.SupportsFloat, final_time: typing.SupportsFloat, base_frame_orientation: str = 'ECLIPJ2000', time_step: typing.SupportsFloat = 300.0) -> BodySettings:
    """
...
def get_default_single_body_settings(body_name: str, base_frame_orientation: str = 'ECLIPJ2000') -> BodySettings:
    """
     ...
     BodySettings
         Object containing the settings for the body that is to be created
    """
def get_default_single_body_settings_time_limited(body_name: str, initial_time: typing.SupportsFloat, final_time: typing.SupportsFloat, base_frame_orientation: str = 'ECLIPJ2000', time_step: typing.SupportsFloat = 300.0) -> BodySettings:
    """
     Function that retrieves the default settings for a single body, with a limited valid time interval.
     ...
     BodySettings
         Object containing the settings for the body that is to be created
    """
def get_ground_station_list(body: tudatpy.kernel.dynamics.environment.Body) -> list[tuple[str, str]]:
    ...
def get_safe_interpolation_interval(ephemeris_model: tudatpy.kernel.dynamics.environment.Ephemeris) -> tuple[float, float]:
    ...
def set_aerodynamic_guidance(aerodynamic_guidance: ..., body: tudatpy.kernel.dynamics.environment.Body, silence_warnings: bool = False) -> None:
    ...
def set_aerodynamic_orientation_functions(body: tudatpy.kernel.dynamics.environment.Body, angle_of_attack_function: collections.abc.Callable[[], float] = None, sideslip_angle_function: collections.abc.Callable[[], float] = None, bank_angle_function: collections.abc.Callable[[], float] = None, update_function: collections.abc.Callable[[typing.SupportsFloat], None] = None) -> None:
    ...
def set_constant_aerodynamic_orientation(body: tudatpy.kernel.dynamics.environment.Body, angle_of_attack: typing.SupportsFloat, sideslip_angle: typing.SupportsFloat, bank_angle: typing.SupportsFloat, silence_warnings: bool = False) -> None:
    ...
