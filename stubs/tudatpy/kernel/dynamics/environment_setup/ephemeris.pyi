...
class CustomEphemerisSettings(EphemerisSettings):
    ...
    """
    @property
    def get_custom_state_function(self) -> collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]]:
        """
        No documentation found.
        """
...
class EphemerisSettings:
    ...
    """
    @property
    def ephemeris_type(self) -> EphemerisType:
        """
                 **read-only**
...
class EphemerisType:
    ...
    Members:
      ...
      scaled_ephemeris
    """
    __members__: typing.ClassVar[dict[str, EphemerisType]]  # value = {'approximate_planet_positions': <EphemerisType.approximate_planet_positions: 0>, 'direct_spice_ephemeris': <EphemerisType.direct_spice_ephemeris: 1>, 'tabulated_ephemeris': <EphemerisType.tabulated_ephemeris: 2>, 'auto_generated_tabulated_ephemeris': <EphemerisType.auto_generated_tabulated_ephemeris: 3>, 'interpolated_spice': <EphemerisType.interpolated_spice: 4>, 'constant_ephemeris': <EphemerisType.constant_ephemeris: 5>, 'kepler_ephemeris': <EphemerisType.kepler_ephemeris: 6>, 'custom_ephemeris': <EphemerisType.custom_ephemeris: 7>, 'direct_tle_ephemeris': <EphemerisType.direct_tle_ephemeris: 8>, 'interpolated_tle_ephemeris': <EphemerisType.interpolated_tle_ephemeris: 9>, 'scaled_ephemeris': <EphemerisType.scaled_ephemeris: 10>}
    approximate_planet_positions: typing.ClassVar[EphemerisType]  # value = <EphemerisType.approximate_planet_positions: 0>
    auto_generated_tabulated_ephemeris: typing.ClassVar[EphemerisType]  # value = <EphemerisType.auto_generated_tabulated_ephemeris: 3>
    constant_ephemeris: typing.ClassVar[EphemerisType]  # value = <EphemerisType.constant_ephemeris: 5>
    custom_ephemeris: typing.ClassVar[EphemerisType]  # value = <EphemerisType.custom_ephemeris: 7>
    direct_spice_ephemeris: typing.ClassVar[EphemerisType]  # value = <EphemerisType.direct_spice_ephemeris: 1>
    direct_tle_ephemeris: typing.ClassVar[EphemerisType]  # value = <EphemerisType.direct_tle_ephemeris: 8>
    interpolated_spice: typing.ClassVar[EphemerisType]  # value = <EphemerisType.interpolated_spice: 4>
    interpolated_tle_ephemeris: typing.ClassVar[EphemerisType]  # value = <EphemerisType.interpolated_tle_ephemeris: 9>
    kepler_ephemeris: typing.ClassVar[EphemerisType]  # value = <EphemerisType.kepler_ephemeris: 6>
    scaled_ephemeris: typing.ClassVar[EphemerisType]  # value = <EphemerisType.scaled_ephemeris: 10>
    tabulated_ephemeris: typing.ClassVar[EphemerisType]  # value = <EphemerisType.tabulated_ephemeris: 2>
...
class KeplerEphemerisSettings(EphemerisSettings):
    ...
    def epoch_of_initial_state(self) -> float:
        ...
        """
    @property
    def initial_state_in_keplerian_elements(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
        """
        No documentation found.
        """
    @property
...
class TabulatedEphemerisSettings(EphemerisSettings):
    ...
    """
    @property
    def body_state_history(self) -> dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]]:
        """
                 **read-only**
...
def approximate_jpl_model(body_name: str) -> EphemerisSettings:
    ...
    """
def constant(constant_state: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], frame_origin: str = 'SSB', frame_orientation: str = 'ECLIPJ2000') -> EphemerisSettings:
    """
    ...
    """
def create_ephemeris(ephemeris_settings: EphemerisSettings, body_name: str) -> tudatpy.kernel.dynamics.environment.Ephemeris:
    """
    No documentation found.
    """
def custom(custom_state_function: collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]], frame_origin: str = 'SSB', frame_orientation: str = 'ECLIPJ2000') -> EphemerisSettings:
    """
    Deprecated function. Use custom_ephemeris instead.
    """
def custom_ephemeris(custom_state_function: collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]], frame_origin: str = 'SSB', frame_orientation: str = 'ECLIPJ2000') -> EphemerisSettings:
    """
...
def direct_spice(frame_origin: str = 'SSB', frame_orientation: str = 'ECLIPJ2000', body_name_to_use: str = '') -> EphemerisSettings:
    ...
    """
def interpolated_spice(initial_time: typing.SupportsFloat, final_time: typing.SupportsFloat, time_step: typing.SupportsFloat, frame_origin: str = 'SSB', frame_orientation: str = 'ECLIPJ2000', interpolator_settings: tudatpy.kernel.math.interpolators.InterpolatorSettings = ..., body_name_to_use: str = '') -> EphemerisSettings:
    """
    ...
    """
def keplerian(initial_keplerian_state: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], initial_state_epoch: typing.SupportsFloat, central_body_gravitational_parameter: typing.SupportsFloat, frame_origin: str = 'SSB', frame_orientation: str = 'ECLIPJ2000', root_finder_absolute_tolerance: typing.SupportsFloat = 4.440892098500626e-14, root_finder_maximum_iterations: typing.SupportsFloat = 1000.0) -> EphemerisSettings:
    """
     ...
     .. code-block:: python
       ...
       body_settings.get( "Jupiter" ).ephemeris_settings = environment_setup.ephemeris.keplerian(
           ...
           frame_origin, frame_orientation )
    """
def keplerian_from_spice(body: str, initial_state_epoch: typing.SupportsFloat, central_body_gravitational_parameter: typing.SupportsFloat, frame_origin: str = 'SSB', frame_orientation: str = 'ECLIPJ2000', root_finder_absolute_tolerance: typing.SupportsFloat = 4.440892098500626e-14, root_finder_maximum_iterations: typing.SupportsFloat = 1000.0) -> EphemerisSettings:
    """
    ...
    """
def scaled_by_constant(unscaled_ephemeris_settings: EphemerisSettings, scaling_constant: typing.SupportsFloat, is_scaling_absolute: bool = False) -> EphemerisSettings:
    """
    ...
    """
def scaled_by_vector(unscaled_ephemeris_settings: EphemerisSettings, scaling_vector: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"], is_scaling_absolute: bool = False) -> EphemerisSettings:
    """
     Function for creating scaled ephemeris model settings.
    ...
    """
def scaled_by_vector_function(unscaled_ephemeris_settings: EphemerisSettings, scaling_vector_function: collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]], is_scaling_absolute: bool = False) -> EphemerisSettings:
    """
     Function for creating scaled ephemeris model settings.
    ...
    """
def sgp4(tle_line_1: str, tle_line_2: str, frame_origin: str = 'Earth', frame_orientation: str = 'J2000') -> EphemerisSettings:
    """
    ...
    """
def tabulated(body_state_history: collections.abc.Mapping[typing.SupportsFloat, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[6, 1]"]], frame_origin: str = 'SSB', frame_orientation: str = 'ECLIPJ2000') -> EphemerisSettings:
    """
     ...
     .. code-block:: python
       ...
       body_settings.get( "Jupiter" ).ephemeris_settings = environment_setup.ephemeris.tabulated( body_state_history,
           ...
           frame_orientation )
    """
def tabulated_from_existing(ephemeris_settings: EphemerisSettings, start_time: typing.SupportsFloat, end_time: typing.SupportsFloat, time_step: typing.SupportsFloat, interpolator_settings: tudatpy.kernel.math.interpolators.InterpolatorSettings = ...) -> EphemerisSettings:
    """
