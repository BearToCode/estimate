...
import numpy.typing
import typing
__all__: list[str] = ['CentralGravityFieldSettings', 'FromFileSphericalHarmonicsGravityFieldSettings', 'GravityFieldSettings', 'GravityFieldType', 'PolyhedronGravityFieldSettings', 'PredefinedSphericalHarmonicsModel', 'SphericalHarmonicsGravityFieldSettings', 'central', 'central_gravity', 'central_spice', 'central_spice_gravity', 'egm96', 'from_file_spherical_harmonic', 'gggrx1200', 'ggm02c', 'ggm02s', 'glgm3150', 'goco05c', 'jgmess160a', 'jgmro120d', 'lpe200', 'polyhedron_from_density', 'polyhedron_from_mu', 'polyhedron_gravity', 'predefined_spherical_harmonic', 'ring_gravity', 'ring_model', 'sh_triaxial_ellipsoid_from_density', 'sh_triaxial_ellipsoid_from_gravitational_parameter', 'shgj180u', 'spherical_harmonic', 'spherical_harmonic_gravity', 'spherical_harmonic_triaxial_body']
...
class GravityFieldType:
    ...
    """
    __members__: typing.ClassVar[dict[str, GravityFieldType]]  # value = {'central_gravity': <GravityFieldType.central_gravity: 0>, 'central_spice_gravity': <GravityFieldType.central_spice_gravity: 1>, 'spherical_harmonic_gravity': <GravityFieldType.spherical_harmonic_gravity: 2>, 'polyhedron_gravity': <GravityFieldType.polyhedron_gravity: 3>, 'ring_gravity': <GravityFieldType.ring_gravity: 4>}
    central_gravity: typing.ClassVar[GravityFieldType]  # value = <GravityFieldType.central_gravity: 0>
    central_spice_gravity: typing.ClassVar[GravityFieldType]  # value = <GravityFieldType.central_spice_gravity: 1>
    polyhedron_gravity: typing.ClassVar[GravityFieldType]  # value = <GravityFieldType.polyhedron_gravity: 3>
    ring_gravity: typing.ClassVar[GravityFieldType]  # value = <GravityFieldType.ring_gravity: 4>
    spherical_harmonic_gravity: typing.ClassVar[GravityFieldType]  # value = <GravityFieldType.spherical_harmonic_gravity: 2>
...
class PredefinedSphericalHarmonicsModel:
    ...
    """
    __members__: typing.ClassVar[dict[str, PredefinedSphericalHarmonicsModel]]  # value = {'egm96': <PredefinedSphericalHarmonicsModel.egm96: 1>, 'ggm02c': <PredefinedSphericalHarmonicsModel.ggm02c: 2>, 'ggm02s': <PredefinedSphericalHarmonicsModel.ggm02s: 3>, 'goco05c': <PredefinedSphericalHarmonicsModel.goco05c: 4>, 'glgm3150': <PredefinedSphericalHarmonicsModel.glgm3150: 5>, 'lpe200': <PredefinedSphericalHarmonicsModel.lpe200: 6>, 'gggrx1200': <PredefinedSphericalHarmonicsModel.gggrx1200: 7>, 'jgmro120d': <PredefinedSphericalHarmonicsModel.jgmro120d: 8>, 'jgmess160a': <PredefinedSphericalHarmonicsModel.jgmess160a: 9>, 'shgj180u': <PredefinedSphericalHarmonicsModel.shgj180u: 10>}
    egm96: typing.ClassVar[PredefinedSphericalHarmonicsModel]  # value = <PredefinedSphericalHarmonicsModel.egm96: 1>
    gggrx1200: typing.ClassVar[PredefinedSphericalHarmonicsModel]  # value = <PredefinedSphericalHarmonicsModel.gggrx1200: 7>
    ggm02c: typing.ClassVar[PredefinedSphericalHarmonicsModel]  # value = <PredefinedSphericalHarmonicsModel.ggm02c: 2>
    ggm02s: typing.ClassVar[PredefinedSphericalHarmonicsModel]  # value = <PredefinedSphericalHarmonicsModel.ggm02s: 3>
    glgm3150: typing.ClassVar[PredefinedSphericalHarmonicsModel]  # value = <PredefinedSphericalHarmonicsModel.glgm3150: 5>
    goco05c: typing.ClassVar[PredefinedSphericalHarmonicsModel]  # value = <PredefinedSphericalHarmonicsModel.goco05c: 4>
    jgmess160a: typing.ClassVar[PredefinedSphericalHarmonicsModel]  # value = <PredefinedSphericalHarmonicsModel.jgmess160a: 9>
    jgmro120d: typing.ClassVar[PredefinedSphericalHarmonicsModel]  # value = <PredefinedSphericalHarmonicsModel.jgmro120d: 8>
    lpe200: typing.ClassVar[PredefinedSphericalHarmonicsModel]  # value = <PredefinedSphericalHarmonicsModel.lpe200: 6>
    shgj180u: typing.ClassVar[PredefinedSphericalHarmonicsModel]  # value = <PredefinedSphericalHarmonicsModel.shgj180u: 10>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class SphericalHarmonicsGravityFieldSettings(GravityFieldSettings):
    ...
    def gravitational_parameter(self, arg1: typing.SupportsFloat) -> None:
        ...
    @property
    def normalized_cosine_coefficients(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
    ...
    def normalized_cosine_coefficients(self, arg1: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]) -> None:
        ...
    @property
    def normalized_sine_coefficients(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
    ...
    def normalized_sine_coefficients(self, arg1: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]) -> None:
        ...
    @property
    ...
    def scaled_mean_moment_of_inertia(self, arg1: typing.SupportsFloat) -> None:
        ...
def central(gravitational_parameter: typing.SupportsFloat) -> GravityFieldSettings:
    """
...
def central_spice(body_name_to_use: str = '') -> GravityFieldSettings:
    ...
    """
def from_file_spherical_harmonic(file: str, maximum_degree: typing.SupportsInt, maximum_order: typing.SupportsInt, associated_reference_frame: str = '', gravitational_parameter_index: typing.SupportsInt = 0, reference_radius_index: typing.SupportsInt = 1) -> GravityFieldSettings:
    """
    ...
    """
def polyhedron_from_density(density: typing.SupportsFloat, vertices_coordinates: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], vertices_defining_each_facet: typing.Annotated[numpy.typing.ArrayLike, numpy.int32, "[m, n]"], associated_reference_frame: str, gravitational_constant: typing.SupportsFloat = 6.67259e-11) -> GravityFieldSettings:
    """
    ...
    """
def polyhedron_from_mu(gravitational_parameter: typing.SupportsFloat, vertices_coordinates: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], vertices_defining_each_facet: typing.Annotated[numpy.typing.ArrayLike, numpy.int32, "[m, n]"], associated_reference_frame: str, gravitational_constant: typing.SupportsFloat = 6.67259e-11) -> GravityFieldSettings:
    """
     ...
     PolyhedronGravityFieldSettings
         Instance of the :class:`~tudatpy.dynamics.environment_setup.gravity_field.GravityFieldSettings` derived :class:`~tudatpy.dynamics.environment_setup.gravity_field.PolyhedronGravityFieldSettings` class
    """
def predefined_spherical_harmonic(predefined_model: PredefinedSphericalHarmonicsModel, maximum_degree: typing.SupportsInt = -1) -> GravityFieldSettings:
    """
    ...
    """
def ring_model(gravitational_parameter: typing.SupportsFloat, ring_radius: typing.SupportsFloat, associated_reference_frame: str, elliptic_integral_s_from_d_and_b: bool) -> GravityFieldSettings:
    """
    ...
    """
def sh_triaxial_ellipsoid_from_density(axis_a: typing.SupportsFloat, axis_b: typing.SupportsFloat, axis_c: typing.SupportsFloat, density: typing.SupportsFloat, maximum_degree: typing.SupportsInt, maximum_order: typing.SupportsInt, associated_reference_frame: str, gravitational_constant: typing.SupportsFloat = 6.67259e-11) -> SphericalHarmonicsGravityFieldSettings:
    """
    ...
    """
def sh_triaxial_ellipsoid_from_gravitational_parameter(axis_a: typing.SupportsFloat, axis_b: typing.SupportsFloat, axis_c: typing.SupportsFloat, maximum_degree: typing.SupportsInt, maximum_order: typing.SupportsInt, associated_reference_frame: str, gravitational_parameter: typing.SupportsFloat) -> SphericalHarmonicsGravityFieldSettings:
    """
     ...
     SphericalHarmonicsGravityFieldSettings
         Instance of the :class:`~tudatpy.dynamics.environment_setup.gravity_field.GravityFieldSettings` derived :class:`~tudatpy.dynamics.environment_setup.gravity_field.SphericalHarmonicsGravityFieldSettings` class
    """
def spherical_harmonic(gravitational_parameter: typing.SupportsFloat, reference_radius: typing.SupportsFloat, normalized_cosine_coefficients: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], normalized_sine_coefficients: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], associated_reference_frame: str) -> GravityFieldSettings:
    """
    ...
    """
def spherical_harmonic_triaxial_body(axis_a: typing.SupportsFloat, axis_b: typing.SupportsFloat, axis_c: typing.SupportsFloat, density: typing.SupportsFloat, maximum_degree: typing.SupportsInt, maximum_order: typing.SupportsInt, associated_reference_frame: str, gravitational_constant: typing.SupportsFloat = 6.67259e-11) -> GravityFieldSettings:
    ...
central_gravity: GravityFieldType  # value = <GravityFieldType.central_gravity: 0>
central_spice_gravity: GravityFieldType  # value = <GravityFieldType.central_spice_gravity: 1>
egm96: PredefinedSphericalHarmonicsModel  # value = <PredefinedSphericalHarmonicsModel.egm96: 1>
gggrx1200: PredefinedSphericalHarmonicsModel  # value = <PredefinedSphericalHarmonicsModel.gggrx1200: 7>
ggm02c: PredefinedSphericalHarmonicsModel  # value = <PredefinedSphericalHarmonicsModel.ggm02c: 2>
ggm02s: PredefinedSphericalHarmonicsModel  # value = <PredefinedSphericalHarmonicsModel.ggm02s: 3>
glgm3150: PredefinedSphericalHarmonicsModel  # value = <PredefinedSphericalHarmonicsModel.glgm3150: 5>
goco05c: PredefinedSphericalHarmonicsModel  # value = <PredefinedSphericalHarmonicsModel.goco05c: 4>
jgmess160a: PredefinedSphericalHarmonicsModel  # value = <PredefinedSphericalHarmonicsModel.jgmess160a: 9>
jgmro120d: PredefinedSphericalHarmonicsModel  # value = <PredefinedSphericalHarmonicsModel.jgmro120d: 8>
lpe200: PredefinedSphericalHarmonicsModel  # value = <PredefinedSphericalHarmonicsModel.lpe200: 6>
polyhedron_gravity: GravityFieldType  # value = <GravityFieldType.polyhedron_gravity: 3>
ring_gravity: GravityFieldType  # value = <GravityFieldType.ring_gravity: 4>
shgj180u: PredefinedSphericalHarmonicsModel  # value = <PredefinedSphericalHarmonicsModel.shgj180u: 10>
spherical_harmonic_gravity: GravityFieldType  # value = <GravityFieldType.spherical_harmonic_gravity: 2>
