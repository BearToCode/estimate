...
class BodyDeformationTypes:
    ...
    """
    __members__: typing.ClassVar[dict[str, BodyDeformationTypes]]  # value = {'basic_solid_body': <BodyDeformationTypes.basic_solid_body: 0>, 'iers_2010_tidal': <BodyDeformationTypes.iers_2010_tidal: 5>, 'tabulated_deformation': <BodyDeformationTypes.tabulated_deformation: 2>, 'periodic_variation': <BodyDeformationTypes.periodic_variation: 3>, 'polynomial_variation': <BodyDeformationTypes.polynomial_variation: 4>, 'ocean_tide': <BodyDeformationTypes.ocean_tide: 7>, 'pole_tide': <BodyDeformationTypes.pole_tide: 6>}
    basic_solid_body: typing.ClassVar[BodyDeformationTypes]  # value = <BodyDeformationTypes.basic_solid_body: 0>
    iers_2010_tidal: typing.ClassVar[BodyDeformationTypes]  # value = <BodyDeformationTypes.iers_2010_tidal: 5>
    ocean_tide: typing.ClassVar[BodyDeformationTypes]  # value = <BodyDeformationTypes.ocean_tide: 7>
    periodic_variation: typing.ClassVar[BodyDeformationTypes]  # value = <BodyDeformationTypes.periodic_variation: 3>
    pole_tide: typing.ClassVar[BodyDeformationTypes]  # value = <BodyDeformationTypes.pole_tide: 6>
    polynomial_variation: typing.ClassVar[BodyDeformationTypes]  # value = <BodyDeformationTypes.polynomial_variation: 4>
    tabulated_deformation: typing.ClassVar[BodyDeformationTypes]  # value = <BodyDeformationTypes.tabulated_deformation: 2>
...
class GravityFieldVariationSettings:
    ...
    """
def mode_coupled_solid_body_tide(deforming_bodies: collections.abc.Sequence[str], love_numbers: collections.abc.Mapping[tuple[typing.SupportsInt, typing.SupportsInt], collections.abc.Mapping[tuple[typing.SupportsInt, typing.SupportsInt], typing.SupportsFloat]]) -> GravityFieldVariationSettings:
    """
    ...
    """
def periodic(cosine_coefficient_amplitudes_cosine_time: collections.abc.Sequence[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]], cosine_coefficient_amplitudes_sine_time: collections.abc.Sequence[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]], sine_coefficient_amplitudes_cosine_time: collections.abc.Sequence[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]], sine_coefficient_amplitudes_sine_time: collections.abc.Sequence[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]], angular_frequencies: collections.abc.Sequence[typing.SupportsFloat], reference_epoch: typing.SupportsFloat, minimum_degree: typing.SupportsInt = 2, minimum_order: typing.SupportsInt = 0) -> GravityFieldVariationSettings:
    """
    ...
    GravityFieldVariationSettings
        Instance of a :class:`~tudatpy.dynamics.environment_setup.gravity_field_variation.GravityFieldVariationSettings` derived class containing required settings
    """
def polynomial(cosine_amplitudes_per_power: collections.abc.Mapping[typing.SupportsInt, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]], sine_amplitudes_per_power: collections.abc.Mapping[typing.SupportsInt, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]], reference_epoch: typing.SupportsFloat, minimum_degree: typing.SupportsInt = 2, minimum_order: typing.SupportsInt = 0) -> GravityFieldVariationSettings:
    """
    ...
    GravityFieldVariationSettings
        Instance of a :class:`~tudatpy.dynamics.environment_setup.gravity_field_variation.GravityFieldVariationSettings` derived class containing required settings
    """
def single_period_periodic(cosine_coefficient_amplitude_cosine_time: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], cosine_coefficient_amplitude_sine_time: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], sine_coefficient_amplitude_cosine_time: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], sine_coefficient_amplitude_sine_time: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], angular_frequency: typing.SupportsFloat, reference_epoch: typing.SupportsFloat, minimum_degree: typing.SupportsInt = 2, minimum_order: typing.SupportsInt = 0) -> GravityFieldVariationSettings:
    """
    ...
    GravityFieldVariationSettings
        Instance of a :class:`~tudatpy.dynamics.environment_setup.gravity_field_variation.GravityFieldVariationSettings` derived class containing required settings
    """
def single_power_polynomial(cosine_amplitudes: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], sine_amplitudes: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], polynomial_power: typing.SupportsInt, reference_epoch: typing.SupportsFloat, minimum_degree: typing.SupportsInt = 2, minimum_order: typing.SupportsInt = 0) -> GravityFieldVariationSettings:
    """
    ...
    GravityFieldVariationSettings
        Instance of a :class:`~tudatpy.dynamics.environment_setup.gravity_field_variation.GravityFieldVariationSettings` derived class containing required settings
    """
def solid_body_tide(tide_raising_body: str, love_number: typing.SupportsFloat, degree: typing.SupportsInt) -> GravityFieldVariationSettings:
    """
    ...
    """
def solid_body_tide_complex_k(tide_raising_body: str, love_number: complex, degree: typing.SupportsInt) -> GravityFieldVariationSettings:
    """
     Function for creating solid body tides.
     ...
     BasicSolidBodyGravityFieldVariationSettings
         Instance of the :class:`~tudatpy.dynamics.environment_setup.gravity_field_variation.BasicSolidBodyGravityFieldVariationSettings` derived :class:`~tudatpy.dynamics.environment_setup.gravity_field_variation.GravityFieldVariationSettings` class
    """
def solid_body_tide_degree_order_variable_complex_k(tide_raising_body: str, love_number_per_degree_and_order: collections.abc.Mapping[typing.SupportsInt, collections.abc.Sequence[complex]]) -> GravityFieldVariationSettings:
    """
    Function for creating solid body tides.
    ...
    BasicSolidBodyGravityFieldVariationSettings
        Instance of the :class:`~tudatpy.dynamics.environment_setup.gravity_field_variation.BasicSolidBodyGravityFieldVariationSettings` derived :class:`~tudatpy.dynamics.environment_setup.gravity_field_variation.GravityFieldVariationSettings` class
    """
def solid_body_tide_degree_order_variable_k(tide_raising_body: str, love_number_per_degree_and_order: collections.abc.Mapping[typing.SupportsInt, collections.abc.Sequence[typing.SupportsFloat]]) -> GravityFieldVariationSettings:
    """
    Function for creating solid body tides.
    ...
    .. code-block:: python
        ...
        body_settings.get( "Earth" ).gravity_field_variation_settings = gravity_field_variation_list
    """
def solid_body_tide_degree_variable_complex_k(tide_raising_body: str, love_number_per_degree: collections.abc.Mapping[typing.SupportsInt, complex]) -> GravityFieldVariationSettings:
    """
    Function for creating solid body tides.
    ...
    -------
     BasicSolidBodyGravityFieldVariationSettings
         Instance of the :class:`~tudatpy.dynamics.environment_setup.gravity_field_variation.BasicSolidBodyGravityFieldVariationSettings` derived :class:`~tudatpy.dynamics.environment_setup.gravity_field_variation.GravityFieldVariationSettings` class
    """
def solid_body_tide_degree_variable_k(tide_raising_body: str, love_number_per_degree: collections.abc.Mapping[typing.SupportsInt, typing.SupportsFloat]) -> GravityFieldVariationSettings:
    """
    Function for creating solid body tides.
    ...
    .. code-block:: python
        ...
        body_settings.get( "Earth" ).gravity_field_variation_settings = gravity_field_variation_list
    """
def solid_multi_body_tide_degree_order_variable_k(tide_raising_bodies: collections.abc.Sequence[str], love_number_per_degree_and_order: collections.abc.Mapping[typing.SupportsInt, collections.abc.Sequence[typing.SupportsFloat]]) -> GravityFieldVariationSettings:
    """
    ...
    BasicSolidBodyGravityFieldVariationSettings
         Instance of the :class:`~tudatpy.dynamics.environment_setup.gravity_field_variation.BasicSolidBodyGravityFieldVariationSettings` derived :class:`~tudatpy.dynamics.environment_setup.gravity_field_variation.GravityFieldVariationSettings` class
    """
def tabulated(cosine_variations_table: collections.abc.Mapping[typing.SupportsFloat, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]], sine_variations_table: collections.abc.Mapping[typing.SupportsFloat, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]], minimum_degree: typing.SupportsInt, minimum_order: typing.SupportsInt, interpolation_settings: tudatpy.kernel.math.interpolators.InterpolatorSettings) -> GravityFieldVariationSettings:
    """
    ...
    GravityFieldVariationSettings
        Instance of a :class:`~tudatpy.dynamics.environment_setup.gravity_field_variation.GravityFieldVariationSettings` derived class containing required settings
    """
basic_solid_body: BodyDeformationTypes  # value = <BodyDeformationTypes.basic_solid_body: 0>
iers_2010_tidal: BodyDeformationTypes  # value = <BodyDeformationTypes.iers_2010_tidal: 5>
ocean_tide: BodyDeformationTypes  # value = <BodyDeformationTypes.ocean_tide: 7>
periodic_variation: BodyDeformationTypes  # value = <BodyDeformationTypes.periodic_variation: 3>
pole_tide: BodyDeformationTypes  # value = <BodyDeformationTypes.pole_tide: 6>
polynomial_variation: BodyDeformationTypes  # value = <BodyDeformationTypes.polynomial_variation: 4>
tabulated_deformation: BodyDeformationTypes  # value = <BodyDeformationTypes.tabulated_deformation: 2>
