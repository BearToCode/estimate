...
class KnockeTypeSurfacePropertyDistributionModel:
    ...
    Members:
      ...
      emissivity_knocke
    """
    __members__: typing.ClassVar[dict[str, KnockeTypeSurfacePropertyDistributionModel]]  # value = {'custom': <KnockeTypeSurfacePropertyDistributionModel.custom: 0>, 'albedo_knocke': <KnockeTypeSurfacePropertyDistributionModel.albedo_knocke: 1>, 'emissivity_knocke': <KnockeTypeSurfacePropertyDistributionModel.emissivity_knocke: 2>}
    albedo_knocke: typing.ClassVar[KnockeTypeSurfacePropertyDistributionModel]  # value = <KnockeTypeSurfacePropertyDistributionModel.albedo_knocke: 1>
    custom: typing.ClassVar[KnockeTypeSurfacePropertyDistributionModel]  # value = <KnockeTypeSurfacePropertyDistributionModel.custom: 0>
    emissivity_knocke: typing.ClassVar[KnockeTypeSurfacePropertyDistributionModel]  # value = <KnockeTypeSurfacePropertyDistributionModel.emissivity_knocke: 2>
...
class RadiationPressureTargetModelType:
    ...
    Members:
      ...
      undefined_target
    """
    __members__: typing.ClassVar[dict[str, RadiationPressureTargetModelType]]  # value = {'cannonball_target': <RadiationPressureTargetModelType.cannonball_target: 0>, 'paneled_target': <RadiationPressureTargetModelType.paneled_target: 1>, 'multi_type_target': <RadiationPressureTargetModelType.multi_type_target: 2>, 'undefined_target': <RadiationPressureTargetModelType.undefined_target: 3>}
    cannonball_target: typing.ClassVar[RadiationPressureTargetModelType]  # value = <RadiationPressureTargetModelType.cannonball_target: 0>
    multi_type_target: typing.ClassVar[RadiationPressureTargetModelType]  # value = <RadiationPressureTargetModelType.multi_type_target: 2>
    paneled_target: typing.ClassVar[RadiationPressureTargetModelType]  # value = <RadiationPressureTargetModelType.paneled_target: 1>
    undefined_target: typing.ClassVar[RadiationPressureTargetModelType]  # value = <RadiationPressureTargetModelType.undefined_target: 3>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class RadiationPressureType:
    ...
    """
    __members__: typing.ClassVar[dict[str, RadiationPressureType]]  # value = {'cannonball_radiation_pressure_interface': <RadiationPressureType.cannonball_radiation_pressure_interface: 0>}
    cannonball_radiation_pressure_interface: typing.ClassVar[RadiationPressureType]  # value = <RadiationPressureType.cannonball_radiation_pressure_interface: 0>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class SphericalHarmonicsSurfacePropertyDistributionModel:
    ...
    Members:
      ...
      albedo_dlam1
    """
    __members__: typing.ClassVar[dict[str, SphericalHarmonicsSurfacePropertyDistributionModel]]  # value = {'albedo_dlam1': <SphericalHarmonicsSurfacePropertyDistributionModel.albedo_dlam1: 1>}
    albedo_dlam1: typing.ClassVar[SphericalHarmonicsSurfacePropertyDistributionModel]  # value = <SphericalHarmonicsSurfacePropertyDistributionModel.albedo_dlam1: 1>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class SurfacePropertyDistributionSettings:
    ...
    """
def cannonball(source_body: str, reference_area: typing.SupportsFloat, radiation_pressure_coefficient: typing.SupportsFloat, occulting_bodies: collections.abc.Sequence[str] = []) -> RadiationPressureInterfaceSettings:
    ...
def cannonball_radiation_target(reference_area: typing.SupportsFloat, radiation_pressure_coefficient: typing.SupportsFloat, per_source_occulting_bodies: collections.abc.Mapping[str, collections.abc.Sequence[str]] = {}) -> RadiationPressureTargetModelSettings:
    """
    ...
    """
def constant_albedo_surface_radiosity(constant_albedo: typing.SupportsFloat, original_source_name: str) -> PanelRadiosityModelSettings:
    """
    ...
    """
def constant_luminosity(luminosity: typing.SupportsFloat) -> LuminosityModelSettings:
    """
    ...
    """
def constant_radiosity(radiosity: typing.SupportsFloat) -> PanelRadiosityModelSettings:
    """
     ...
     PanelRadiosityModelSettings
         Object defining settings for source panel radiosity
    """
def constant_surface_property_distribution(constant_value: typing.SupportsFloat) -> SurfacePropertyDistributionSettings:
    """
    ...
    """
def custom_surface_property_distribution(custom_function: collections.abc.Callable[[typing.SupportsFloat, typing.SupportsFloat, typing.SupportsFloat], float]) -> SurfacePropertyDistributionSettings:
    """
     ...
     SurfacePropertyDistributionSettings
         Object defining settings for surface property distribution
    """
def irradiance_based_constant_luminosity(constant_irradiance: typing.SupportsFloat, reference_distance: typing.SupportsFloat) -> LuminosityModelSettings:
    """
    ...
    """
def irradiance_based_time_variable_luminosity(irradiance_function: collections.abc.Callable[[typing.SupportsFloat], float], reference_distance: typing.SupportsFloat) -> LuminosityModelSettings:
    """
...
def isotropic_radiation_source(luminosity_model: LuminosityModelSettings) -> RadiationSourceModelSettings:
    """
     ...
     .. code-block:: python
         ...
         body_settings.get("Sun").radiation_source_settings = radiation_source_settings_sun
    """
def knocke_type_surface_property_distribution(constant_contribution: typing.SupportsFloat, constant_degree_one_contribution: typing.SupportsFloat, cosine_periodic_degree_one_contribution: typing.SupportsFloat, sine_periodic_degree_one_contribution: typing.SupportsFloat, constant_degree_two_contribution: typing.SupportsFloat, reference_epoch: typing.SupportsFloat, period: typing.SupportsFloat) -> ...:
    """
     ...
     SurfacePropertyDistributionSettings
         Object defining settings for surface property distribution
    """
def lambertian_body_panel_reflection(reflectivity: typing.SupportsFloat) -> BodyPanelReflectionLawSettings:
    """
    ...
    """
def panelled_extended_radiation_source(panel_radiosity_settings: collections.abc.Sequence[PanelRadiosityModelSettings], number_of_panels_per_ring: collections.abc.Sequence[typing.SupportsInt], original_source_occulting_bodies: collections.abc.Mapping[str, collections.abc.Sequence[str]] = {}) -> RadiationSourceModelSettings:
    """
     ...
     RadiationSourceModelSettings
         Object defining settings for source model irradiance
    """
def panelled_radiation_target(source_to_target_occulting_bodies: collections.abc.Mapping[str, collections.abc.Sequence[str]] = {}, maximum_number_of_pixels_per_source: collections.abc.Mapping[str, typing.SupportsInt] = {}) -> RadiationPressureTargetModelSettings:
    """
...
def predefined_spherical_harmonic_surface_property_distribution(predefined_model: SphericalHarmonicsSurfacePropertyDistributionModel) -> SurfacePropertyDistributionSettings:
    """
     ...
     SurfacePropertyDistributionSettings
         Object defining settings for surface property distribution
    """
def specular_diffuse_body_panel_reflection(specular_reflectivity: typing.SupportsFloat, diffuse_reflectivity: typing.SupportsFloat, with_instantaneous_reradiation: bool) -> BodyPanelReflectionLawSettings:
    """
     ...
     BodyPanelReflectionLawSettings
         Object defining settings for target panel reflection law
    """
def spherical_harmonic_surface_property_distribution(cosine_coefficients: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], sine_coefficients: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]) -> SurfacePropertyDistributionSettings:
    """
     ...
     SurfacePropertyDistributionSettings
         Object defining settings for surface property distribution
    """
def thermal_emission_angle_based_radiosity(minimum_temperature: typing.SupportsFloat, maximum_temperature: typing.SupportsFloat, constant_emissivity: typing.SupportsFloat, original_source_name: str) -> PanelRadiosityModelSettings:
    """
     ...
     PanelRadiosityModelSettings
         Object defining settings for source panel radiosity
    """
def thermal_emission_blackbody_constant_emissivity(constant_emissivity: typing.SupportsFloat, original_source_name: str) -> PanelRadiosityModelSettings:
    """
...
def thermal_emission_blackbody_variable_emissivity(emissivity_distribution_model: SurfacePropertyDistributionSettings, original_source_name: str) -> PanelRadiosityModelSettings:
    """
     ...
     PanelRadiosityModelSettings
         Object defining settings for source panel radiosity
    """
def time_variable_luminosity(luminosity_function: collections.abc.Callable[[typing.SupportsFloat], float]) -> LuminosityModelSettings:
    """
...
def variable_albedo_surface_radiosity(albedo_distribution_settings: SurfacePropertyDistributionSettings, original_source_name: str) -> PanelRadiosityModelSettings:
    """
     ...
     PanelRadiosityModelSettings
         Object defining settings for source panel radiosity
    """
albedo_dlam1: SphericalHarmonicsSurfacePropertyDistributionModel  # value = <SphericalHarmonicsSurfacePropertyDistributionModel.albedo_dlam1: 1>
albedo_knocke: KnockeTypeSurfacePropertyDistributionModel  # value = <KnockeTypeSurfacePropertyDistributionModel.albedo_knocke: 1>
cannonball_radiation_pressure_interface: RadiationPressureType  # value = <RadiationPressureType.cannonball_radiation_pressure_interface: 0>
cannonball_target: RadiationPressureTargetModelType  # value = <RadiationPressureTargetModelType.cannonball_target: 0>
custom: KnockeTypeSurfacePropertyDistributionModel  # value = <KnockeTypeSurfacePropertyDistributionModel.custom: 0>
emissivity_knocke: KnockeTypeSurfacePropertyDistributionModel  # value = <KnockeTypeSurfacePropertyDistributionModel.emissivity_knocke: 2>
multi_type_target: RadiationPressureTargetModelType  # value = <RadiationPressureTargetModelType.multi_type_target: 2>
paneled_target: RadiationPressureTargetModelType  # value = <RadiationPressureTargetModelType.paneled_target: 1>
undefined_target: RadiationPressureTargetModelType  # value = <RadiationPressureTargetModelType.undefined_target: 3>
