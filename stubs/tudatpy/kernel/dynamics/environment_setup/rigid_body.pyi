...
class RigidBodyPropertiesSettings:
    ...
    def body_mass_property_type(self) -> ...:
        ...
        """
def constant_rigid_body_properties(mass: typing.SupportsFloat, center_of_mass: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"] = ..., inertia_tensor: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 3]"] = ...) -> RigidBodyPropertiesSettings:
    """
    ...
    """
def custom_mass_dependent_rigid_body_properties(mass: typing.SupportsFloat, center_of_mass_function: collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]] = None, inertia_tensor_function: collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]] = None) -> RigidBodyPropertiesSettings:
    """
     ...
     RigidBodyPropertiesSettings
         Instance of the :class:`~tudatpy.dynamics.environment_setup.rigid_body.RigidBodyPropertiesSettings` object with the given settings
    """
def custom_time_dependent_rigid_body_properties(mass_function: collections.abc.Callable[[typing.SupportsFloat], float], center_of_mass_function: collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]] = None, inertia_tensor_function: collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]] = None) -> RigidBodyPropertiesSettings:
    """
     Function for creating custom (time-dependent) rigid body properties.
