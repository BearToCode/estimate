...
import numpy.typing
import typing
__all__: list[str] = ['BodyShapeSettings', 'HybridBodyShapeSettings', 'OblateSphericalBodyShapeSettings', 'PolyhedronBodyShapeSettings', 'SphericalBodyShapeSettings', 'hybrid', 'oblate_spherical', 'oblate_spherical_spice', 'polyhedron', 'spherical', 'spherical_spice']
...
class HybridBodyShapeSettings(BodyShapeSettings):
    ...
    def switchover_altitude(self, arg1: typing.SupportsFloat) -> None:
        ...
class OblateSphericalBodyShapeSettings(BodyShapeSettings):
    ...
    def equatorial_radius(self, arg1: typing.SupportsFloat) -> None:
        ...
    @property
    def flattening(self) -> float:
        ...
        """
    @flattening.setter
    def flattening(self, arg1: typing.SupportsFloat) -> None:
        ...
class PolyhedronBodyShapeSettings(BodyShapeSettings):
    ...
    def vertices_coordinates(self, arg1: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]) -> None:
        ...
    @property
    ...
    def vertices_defining_each_facet(self, arg1: typing.Annotated[numpy.typing.ArrayLike, numpy.int32, "[m, n]"]) -> None:
        ...
class SphericalBodyShapeSettings(BodyShapeSettings):
    ...
    def radius(self, arg1: typing.SupportsFloat) -> None:
        ...
def hybrid(low_resolution_body_shape_settings: BodyShapeSettings, high_resolution_body_shape_settings: BodyShapeSettings, switchover_altitude: typing.SupportsFloat) -> BodyShapeSettings:
    """
    ...
    """
def oblate_spherical(equatorial_radius: typing.SupportsFloat, flattening: typing.SupportsFloat) -> BodyShapeSettings:
    """
...
def oblate_spherical_spice() -> BodyShapeSettings:
    ...
    No documentation found.
    """
def polyhedron(vertices_coordinates: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], vertices_defining_each_facet: typing.Annotated[numpy.typing.ArrayLike, numpy.int32, "[m, n]"], compute_altitude_with_sign: bool = True, just_compute_distance_to_vertices: bool = False) -> BodyShapeSettings:
    """
    ...
    """
def spherical(radius: typing.SupportsFloat) -> BodyShapeSettings:
    """
