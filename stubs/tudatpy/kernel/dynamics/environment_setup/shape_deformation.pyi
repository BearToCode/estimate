...
class BodyDeformationSettings:
    ...
    """
def basic_solid_body_tidal(tide_raising_bodies: collections.abc.Sequence[str], displacement_love_numbers: collections.abc.Mapping[typing.SupportsInt, tuple[typing.SupportsFloat, typing.SupportsFloat]], reference_radius: typing.SupportsFloat = ...) -> BasicSolidBodyDeformationSettings:
    """
    ...
    """
def degree_two_basic_solid_body_tidal(tide_raising_bodies: collections.abc.Sequence[str], love_number: typing.SupportsFloat, shida_number: typing.SupportsFloat, reference_radius: typing.SupportsFloat = ...) -> BasicSolidBodyDeformationSettings:
    """
...
def iers_2010_solid_body_tidal() -> BodyDeformationSettings:
    ...
    """
def ocean_tidal(blq_files: collections.abc.Sequence[str]) -> BodyDeformationSettings:
    """
