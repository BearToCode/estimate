...
class EmpiricalAccelerationComponents:
    ...
    """
    __members__: typing.ClassVar[dict[str, EmpiricalAccelerationComponents]]  # value = {'radial_empirical_acceleration_component': <EmpiricalAccelerationComponents.radial_empirical_acceleration_component: 0>, 'along_track_empirical_acceleration_component': <EmpiricalAccelerationComponents.along_track_empirical_acceleration_component: 1>, 'across_track_empirical_acceleration_component': <EmpiricalAccelerationComponents.across_track_empirical_acceleration_component: 2>}
    across_track_empirical_acceleration_component: typing.ClassVar[EmpiricalAccelerationComponents]  # value = <EmpiricalAccelerationComponents.across_track_empirical_acceleration_component: 2>
    along_track_empirical_acceleration_component: typing.ClassVar[EmpiricalAccelerationComponents]  # value = <EmpiricalAccelerationComponents.along_track_empirical_acceleration_component: 1>
    radial_empirical_acceleration_component: typing.ClassVar[EmpiricalAccelerationComponents]  # value = <EmpiricalAccelerationComponents.radial_empirical_acceleration_component: 0>
...
class EmpiricalAccelerationFunctionalShapes:
    ...
    Members:
      ...
      cosine_empirical
    """
    __members__: typing.ClassVar[dict[str, EmpiricalAccelerationFunctionalShapes]]  # value = {'constant_empirical': <EmpiricalAccelerationFunctionalShapes.constant_empirical: 0>, 'sine_empirical': <EmpiricalAccelerationFunctionalShapes.sine_empirical: 1>, 'cosine_empirical': <EmpiricalAccelerationFunctionalShapes.cosine_empirical: 2>}
    constant_empirical: typing.ClassVar[EmpiricalAccelerationFunctionalShapes]  # value = <EmpiricalAccelerationFunctionalShapes.constant_empirical: 0>
    cosine_empirical: typing.ClassVar[EmpiricalAccelerationFunctionalShapes]  # value = <EmpiricalAccelerationFunctionalShapes.cosine_empirical: 2>
    sine_empirical: typing.ClassVar[EmpiricalAccelerationFunctionalShapes]  # value = <EmpiricalAccelerationFunctionalShapes.sine_empirical: 1>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class EstimatableParameterSettings:
    ...
    """
    @property
    def custom_partial_settings(self) -> list[...]:
        ...
    @custom_partial_settings.setter
    def custom_partial_settings(self, arg0: collections.abc.Sequence[...]) -> None:
        ...
    @property
    def parameter_identifier(self) -> tuple[EstimatableParameterTypes, tuple[str, str]]:
        """
        ...
        """
    @parameter_identifier.setter
    def parameter_identifier(self, arg0: tuple[EstimatableParameterTypes, tuple[str, str]]) -> None:
        ...
class EstimatableParameterTypes:
    ...
    """
    __members__: typing.ClassVar[dict[str, EstimatableParameterTypes]]  # value = {'arc_wise_initial_body_state_type': <EstimatableParameterTypes.arc_wise_initial_body_state_type: 0>, 'initial_body_state_type': <EstimatableParameterTypes.initial_body_state_type: 1>, 'initial_rotational_body_state_type': <EstimatableParameterTypes.initial_rotational_body_state_type: 2>, 'gravitational_parameter_type': <EstimatableParameterTypes.gravitational_parameter_type: 4>, 'constant_drag_coefficient_type': <EstimatableParameterTypes.constant_drag_coefficient_type: 5>, 'radiation_pressure_coefficient_type': <EstimatableParameterTypes.radiation_pressure_coefficient_type: 6>, 'arc_wise_radiation_pressure_coefficient_type': <EstimatableParameterTypes.arc_wise_radiation_pressure_coefficient_type: 7>, 'spherical_harmonics_cosine_coefficient_block_type': <EstimatableParameterTypes.spherical_harmonics_cosine_coefficient_block_type: 8>, 'spherical_harmonics_sine_coefficient_block_type': <EstimatableParameterTypes.spherical_harmonics_sine_coefficient_block_type: 9>, 'constant_rotation_rate_type': <EstimatableParameterTypes.constant_rotation_rate_type: 10>, 'rotation_pole_position_type': <EstimatableParameterTypes.rotation_pole_position_type: 11>, 'constant_additive_observation_bias_type': <EstimatableParameterTypes.constant_additive_observation_bias_type: 12>, 'arcwise_constant_additive_observation_bias_type': <EstimatableParameterTypes.arcwise_constant_additive_observation_bias_type: 13>, 'constant_relative_observation_bias_type': <EstimatableParameterTypes.constant_relative_observation_bias_type: 14>, 'arcwise_constant_relative_observation_bias_type': <EstimatableParameterTypes.arcwise_constant_relative_observation_bias_type: 15>, 'ppn_parameter_gamma_type': <EstimatableParameterTypes.ppn_parameter_gamma_type: 16>, 'ppn_parameter_beta_type': <EstimatableParameterTypes.ppn_parameter_beta_type: 17>, 'ground_station_position_type': <EstimatableParameterTypes.ground_station_position_type: 18>, 'equivalence_principle_lpi_violation_parameter_type': <EstimatableParameterTypes.equivalence_principle_lpi_violation_parameter_type: 19>, 'empirical_acceleration_coefficients_type': <EstimatableParameterTypes.empirical_acceleration_coefficients_type: 20>, 'arc_wise_empirical_acceleration_coefficients_type': <EstimatableParameterTypes.arc_wise_empirical_acceleration_coefficients_type: 21>, 'full_degree_tidal_love_number_type': <EstimatableParameterTypes.full_degree_tidal_love_number_type: 22>, 'single_degree_variable_tidal_love_number_type': <EstimatableParameterTypes.single_degree_variable_tidal_love_number_type: 23>, 'direct_dissipation_tidal_time_lag_type': <EstimatableParameterTypes.direct_dissipation_tidal_time_lag_type: 24>, 'mean_moment_of_inertia_type': <EstimatableParameterTypes.mean_moment_of_inertia_type: 25>, 'arc_wise_constant_drag_coefficient_type': <EstimatableParameterTypes.arc_wise_constant_drag_coefficient_type: 26>, 'periodic_spin_variation_type': <EstimatableParameterTypes.periodic_spin_variation_type: 27>, 'polar_motion_amplitude_type': <EstimatableParameterTypes.polar_motion_amplitude_type: 28>, 'core_factor_type': <EstimatableParameterTypes.core_factor_type: 29>, 'free_core_nutation_rate_type': <EstimatableParameterTypes.free_core_nutation_rate_type: 30>, 'desaturation_delta_v_values_type': <EstimatableParameterTypes.desaturation_delta_v_values_type: 31>, 'constant_time_drift_observation_bias_type': <EstimatableParameterTypes.constant_time_drift_observation_bias_type: 35>, 'arc_wise_time_drift_observation_bias_type': <EstimatableParameterTypes.arc_wise_time_drift_observation_bias_type: 36>, 'global_polynomial_clock_corrections_type': <EstimatableParameterTypes.global_polynomial_clock_corrections_type: 39>, 'arc_wise_polynomial_clock_corrections_type': <EstimatableParameterTypes.arc_wise_polynomial_clock_corrections_type: 40>, 'inverse_tidal_quality_factor_type': <EstimatableParameterTypes.inverse_tidal_quality_factor_type: 41>, 'radiation_pressure_target_perpendicular_direction_scaling_factor_type': <EstimatableParameterTypes.radiation_pressure_target_perpendicular_direction_scaling_factor_type: 48>, 'radiation_pressure_target_direction_scaling_factor_type': <EstimatableParameterTypes.radiation_pressure_target_direction_scaling_factor_type: 47>, 'drag_component_scaling_factor_type': <EstimatableParameterTypes.drag_component_scaling_factor_type: 55>, 'side_component_scaling_factor_type': <EstimatableParameterTypes.side_component_scaling_factor_type: 56>, 'lift_component_scaling_factor_type': <EstimatableParameterTypes.lift_component_scaling_factor_type: 57>, 'rtg_force_vector_type': <EstimatableParameterTypes.rtg_force_vector_type: 58>, 'rtg_force_vector_magnitude_type': <EstimatableParameterTypes.rtg_force_vector_magnitude_type: 59>}
    arc_wise_constant_drag_coefficient_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.arc_wise_constant_drag_coefficient_type: 26>
    arc_wise_empirical_acceleration_coefficients_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.arc_wise_empirical_acceleration_coefficients_type: 21>
    arc_wise_initial_body_state_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.arc_wise_initial_body_state_type: 0>
    arc_wise_polynomial_clock_corrections_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.arc_wise_polynomial_clock_corrections_type: 40>
    arc_wise_radiation_pressure_coefficient_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.arc_wise_radiation_pressure_coefficient_type: 7>
    arc_wise_time_drift_observation_bias_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.arc_wise_time_drift_observation_bias_type: 36>
    arcwise_constant_additive_observation_bias_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.arcwise_constant_additive_observation_bias_type: 13>
    arcwise_constant_relative_observation_bias_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.arcwise_constant_relative_observation_bias_type: 15>
    constant_additive_observation_bias_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.constant_additive_observation_bias_type: 12>
    constant_drag_coefficient_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.constant_drag_coefficient_type: 5>
    constant_relative_observation_bias_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.constant_relative_observation_bias_type: 14>
    constant_rotation_rate_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.constant_rotation_rate_type: 10>
    constant_time_drift_observation_bias_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.constant_time_drift_observation_bias_type: 35>
    core_factor_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.core_factor_type: 29>
    desaturation_delta_v_values_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.desaturation_delta_v_values_type: 31>
    direct_dissipation_tidal_time_lag_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.direct_dissipation_tidal_time_lag_type: 24>
    drag_component_scaling_factor_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.drag_component_scaling_factor_type: 55>
    empirical_acceleration_coefficients_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.empirical_acceleration_coefficients_type: 20>
    equivalence_principle_lpi_violation_parameter_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.equivalence_principle_lpi_violation_parameter_type: 19>
    free_core_nutation_rate_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.free_core_nutation_rate_type: 30>
    full_degree_tidal_love_number_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.full_degree_tidal_love_number_type: 22>
    global_polynomial_clock_corrections_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.global_polynomial_clock_corrections_type: 39>
    gravitational_parameter_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.gravitational_parameter_type: 4>
    ground_station_position_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.ground_station_position_type: 18>
    initial_body_state_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.initial_body_state_type: 1>
    initial_rotational_body_state_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.initial_rotational_body_state_type: 2>
    inverse_tidal_quality_factor_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.inverse_tidal_quality_factor_type: 41>
    lift_component_scaling_factor_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.lift_component_scaling_factor_type: 57>
    mean_moment_of_inertia_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.mean_moment_of_inertia_type: 25>
    periodic_spin_variation_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.periodic_spin_variation_type: 27>
    polar_motion_amplitude_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.polar_motion_amplitude_type: 28>
    ppn_parameter_beta_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.ppn_parameter_beta_type: 17>
    ppn_parameter_gamma_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.ppn_parameter_gamma_type: 16>
    radiation_pressure_coefficient_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.radiation_pressure_coefficient_type: 6>
    radiation_pressure_target_direction_scaling_factor_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.radiation_pressure_target_direction_scaling_factor_type: 47>
    radiation_pressure_target_perpendicular_direction_scaling_factor_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.radiation_pressure_target_perpendicular_direction_scaling_factor_type: 48>
    rotation_pole_position_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.rotation_pole_position_type: 11>
    rtg_force_vector_magnitude_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.rtg_force_vector_magnitude_type: 59>
    rtg_force_vector_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.rtg_force_vector_type: 58>
    side_component_scaling_factor_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.side_component_scaling_factor_type: 56>
    single_degree_variable_tidal_love_number_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.single_degree_variable_tidal_love_number_type: 23>
    spherical_harmonics_cosine_coefficient_block_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.spherical_harmonics_cosine_coefficient_block_type: 8>
    spherical_harmonics_sine_coefficient_block_type: typing.ClassVar[EstimatableParameterTypes]  # value = <EstimatableParameterTypes.spherical_harmonics_sine_coefficient_block_type: 9>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
def absolute_observation_bias(link_ends: ..., observable_type: ...) -> EstimatableParameterSettings:
    ...
    """
def arc_wise_polynomial_clock_corrections(associated_body: str, associated_station: str, correction_powers: collections.abc.Sequence[typing.SupportsInt], arc_indices: collections.abc.Sequence[typing.SupportsInt]) -> EstimatableParameterSettings:
    ...
def arcwise_absolute_observation_bias(link_ends: ..., observable_type: ..., arc_start_times: collections.abc.Sequence[typing.SupportsFloat], time_link_end: ...) -> EstimatableParameterSettings:
    """
     ...
     * The observation model (corresponding to the `link_ends` and `observable_type`) to include an arc-wise absolute bias (:func:`~tudatpy.estimation.observable_models_setup.biases.arcwise_absolute_bias`)
     ...
     :class:`~tudatpy.dynamics.parameters_setup.EstimatableParameterSettings`
         ...
         for the specified observation's arc-wise absolute bias.
    """
def arcwise_constant_drag_coefficient(body: str, arc_initial_times: collections.abc.Sequence[typing.SupportsFloat]) -> EstimatableParameterSettings:
    """
    ...
    """
def arcwise_constant_empirical_acceleration_terms(body: str, centralBody: str, arc_start_times: collections.abc.Sequence[typing.SupportsFloat]) -> EstimatableParameterSettings:
    """
    ...
    """
def arcwise_empirical_accelerations(body: str, centralBody: str, acceleration_components: collections.abc.Mapping[EmpiricalAccelerationComponents, collections.abc.Sequence[EmpiricalAccelerationFunctionalShapes]], arc_start_times: collections.abc.Sequence[typing.SupportsFloat]) -> EstimatableParameterSettings:
    """
    ...
    """
def arcwise_radiation_pressure_coefficient(body: str, arc_initial_times: collections.abc.Sequence[typing.SupportsFloat]) -> EstimatableParameterSettings:
    """
    ...
    """
def arcwise_relative_observation_bias(link_ends: ..., observable_type: ..., arc_start_times: collections.abc.Sequence[typing.SupportsFloat], time_link_end: ...) -> EstimatableParameterSettings:
    """
     Function for creating parameter settings for arc-wise absolute observation bias.
    ...
    """
def arcwise_time_bias(link_ends: collections.abc.Mapping[..., ...], observable_type: ..., arc_start_times: collections.abc.Sequence[typing.SupportsFloat], reference_link_end: ...) -> EstimatableParameterSettings:
    ...
def arcwise_time_drift_observation_bias(link_ends: collections.abc.Mapping[..., ...], observable_type: ..., arc_start_times: collections.abc.Sequence[typing.SupportsFloat], ref_epochs: collections.abc.Sequence[typing.SupportsFloat], time_link_end: ...) -> EstimatableParameterSettings:
    ...
def area_to_mass_ratio_scaling_parameter(body_name: str) -> EstimatableParameterSettings:
    """
...
def constant_rotation_rate(body: str) -> EstimatableParameterSettings:
    ...
    """
def constant_time_bias(link_ends: collections.abc.Mapping[..., ...], observable_type: ..., reference_link_end: ...) -> EstimatableParameterSettings:
    ...
def core_factor(body: str) -> EstimatableParameterSettings:
    ...
    """
def create_parameter_set(parameter_settings: collections.abc.Sequence[EstimatableParameterSettings], bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, propagator_settings: tudatpy.kernel.dynamics.propagation_setup.propagator.PropagatorSettings = None, consider_parameters_names: collections.abc.Sequence[EstimatableParameterSettings] = []) -> ...:
    """
    ...
    """
def custom_analytical_partial(analytical_partial_function: collections.abc.Callable[[typing.SupportsFloat, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"]], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]], body_undergoing_acceleration: str, body_exerting_acceleration: str, acceleration_type: tudatpy.kernel.dynamics.propagation_setup.acceleration.AvailableAcceleration) -> CustomAccelerationPartialSettings:
    """
    No documentation found.
    """
def custom_numerical_partial(parameter_perturbation: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], body_undergoing_acceleration: str, body_exerting_acceleration: str, acceleration_type: tudatpy.kernel.dynamics.propagation_setup.acceleration.AvailableAcceleration, environment_updates: collections.abc.Mapping[..., collections.abc.Sequence[str]] = {}) -> CustomAccelerationPartialSettings:
    """
    No documentation found.
    """
def custom_parameter(custom_id: str, parameter_size: typing.SupportsInt, get_parameter_function: collections.abc.Callable[[], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]], set_parameter_function: collections.abc.Callable[[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]], None]) -> EstimatableParameterSettings:
    """
    No documentation found.
    """
@typing.overload
def direct_tidal_dissipation_time_lag(body: str, deforming_body: str) -> EstimatableParameterSettings:
    ...
    """
@typing.overload
def direct_tidal_dissipation_time_lag(body: str, deforming_body: collections.abc.Sequence[str]) -> EstimatableParameterSettings:
    """
    No documentation found.
    """
def drag_component_scaling(body: str) -> EstimatableParameterSettings:
     ...
     * The body specified by the ``body`` parameter to undergo :func:`~tudatpy.dynamics.propagation_setup.acceleration.aerodynamic` acceleration
     ...
     -------
     :class:`~tudatpy.dynamics.parameters_setup.EstimatableParameterSettings`
         Instance of :class:`~tudatpy.dynamics.parameters_setup.EstimatableParameterSettings` class that define the settings. 
    """
def empirical_accelerations(body: str, centralBody: str, acceleration_components: collections.abc.Mapping[EmpiricalAccelerationComponents, collections.abc.Sequence[EmpiricalAccelerationFunctionalShapes]]) -> EstimatableParameterSettings:
    """
...
def free_core_nutation_rate(body: str) -> EstimatableParameterSettings:
    ...
    """
def full_acceleration_scaling_parameter(body_name_undergoing_acceleration: str, body_name_exerting_acceleration: str, acceleration_type: tudatpy.kernel.dynamics.propagation_setup.acceleration.AvailableAcceleration) -> EstimatableParameterSettings:
    """
...
def full_empirical_acceleration_terms(body: str, centralBody: str) -> EstimatableParameterSettings:
    """
     ...
     :class:`~tudatpy.dynamics.parameters_setup.EstimatableParameterSettings`
         ...
         for the specified body's empirical acceleration terms.
    """
def global_polynomial_clock_corrections(associated_body: str, associated_station: str, correction_powers: collections.abc.Sequence[typing.SupportsInt]) -> EstimatableParameterSettings:
    ...
...
def ground_station_position(body: str, ground_station_name: str) -> EstimatableParameterSettings:
    ...
    """
def iau_rotation_model_longitudinal_librations(body: str, libration_angular_frequencies: collections.abc.Sequence[typing.SupportsFloat]) -> EstimatableParameterSettings:
    """
    ...
    """
def iau_rotation_model_pole(body: str) -> EstimatableParameterSettings:
    """
     ...
     * Any dynamical or observational model to depend on the rotation model of the body specified by the ``body`` parameter
     ...
     :class:`~tudatpy.dynamics.parameters_setup.EstimatableParameterSettings`
         ...
         :class:`~tudatpy.dynamics.parameters_setup.EstimatableParameterSettings` object for the specified body's property
    """
def iau_rotation_model_pole_rate(body: str) -> EstimatableParameterSettings:
    """
     ...
     * Any dynamical or observational model to depend on the rotation model of the body specified by the ``body`` parameter
     ...
     :class:`~tudatpy.dynamics.parameters_setup.EstimatableParameterSettings`
         ...
         :class:`~tudatpy.dynamics.parameters_setup.EstimatableParameterSettings` object for the specified body's property
    """
def initial_states(propagator_settings: tudatpy.kernel.dynamics.propagation_setup.propagator.PropagatorSettings, bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, arc_initial_times: collections.abc.Sequence[typing.SupportsFloat] = []) -> list[EstimatableParameterSettings]:
    """
...
def inverse_tidal_quality_factor(body: str, deforming_body: str) -> EstimatableParameterSettings:
    ...
    """
@typing.overload
def inverse_tidal_quality_factor(body: str, deforming_body: collections.abc.Sequence[str]) -> EstimatableParameterSettings:
    """
    No documentation found.
    """
...
def mean_moment_of_inertia(body: str) -> EstimatableParameterSettings:
    ...
    """
def mode_coupled_k_love_numbers(deformed_body: str, love_number_indices: collections.abc.Mapping[tuple[typing.SupportsInt, typing.SupportsInt], collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt]]], deforming_bodies: collections.abc.Sequence[str]) -> EstimatableParameterSettings:
    """
    ...
    * Any dynamical model to depend on the gravity field of the body specified by the ``deformed_body`` parameter
    ...
    """
def monomial_full_block_gravity_field_variation_amplitudes(body_name: str, power: typing.SupportsInt, minimum_degree: typing.SupportsInt, minimum_order: typing.SupportsInt, maximum_degree: typing.SupportsInt, maximum_order: typing.SupportsInt) -> EstimatableParameterSettings:
    """
    ...
    """
def monomial_gravity_field_variation_amplitudes(body_name: str, power: typing.SupportsInt, cosine_indices: collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt]], sine_indices: collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt]]) -> EstimatableParameterSettings:
    """
    Function for creating parameter settings for a body's polynomial gravity field amplitudes at a single power.
    ...
    :class:`~tudatpy.dynamics.parameters_setup.EstimatableParameterSettings`
        Object for the specified body's polynomial gravity field variations
    """
def order_invariant_k_love_number(deformed_body: str, degree: typing.SupportsInt, deforming_bodies: collections.abc.Sequence[str], use_complex_love_number: bool = 0) -> EstimatableParameterSettings:
    """
    ...
    * Any dynamical model to depend on the gravity field of the body specified by the ``deformed_body`` parameter
    ...
    """
def order_varying_k_love_number(deformed_body: str, degree: typing.SupportsInt, orders: collections.abc.Sequence[typing.SupportsInt], deforming_bodies: collections.abc.Sequence[str], use_complex_love_number: bool) -> EstimatableParameterSettings:
    """
    ...
    * Any dynamical model to depend on the gravity field of the body specified by the ``deformed_body`` parameter
    ...
    """
def periodic_gravity_field_variation_amplitudes(body_name: str, cosine_indices_per_period: collections.abc.Mapping[typing.SupportsInt, collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt]]], sine_indices_per_period: collections.abc.Mapping[typing.SupportsInt, collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt]]]) -> EstimatableParameterSettings:
    """
...
def polar_motion_amplitudes(body: str) -> EstimatableParameterSettings:
    ...
    """
def polynomial_gravity_field_variation_amplitudes(body_name: str, cosine_indices_per_power: collections.abc.Mapping[typing.SupportsInt, collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt]]], sine_indices_per_power: collections.abc.Mapping[typing.SupportsInt, collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt]]]) -> EstimatableParameterSettings:
    """
...
def rotation_pole_position(body: str) -> EstimatableParameterSettings:
    ...
    """
def rtg_force_vector(body_name: str) -> EstimatableParameterSettings:
    """
    ...
    """
def rtg_force_vector_magnitude(body_name: str) -> EstimatableParameterSettings:
    """
...
def side_component_scaling(body: str) -> EstimatableParameterSettings:
    """
     ...
     :class:`~tudatpy.dynamics.parameters_setup.EstimatableParameterSettings`
         Instance of :class:`~tudatpy.dynamics.parameters_setup.EstimatableParameterSettings` class that define the settings. 
    """
def spherical_harmonics_c_coefficients(body: str, minimum_degree: typing.SupportsInt, minimum_order: typing.SupportsInt, maximum_degree: typing.SupportsInt, maximum_order: typing.SupportsInt) -> EstimatableParameterSettings:
    """
    ...
    """
def spherical_harmonics_c_coefficients_block(body: str, block_indices: collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt]]) -> EstimatableParameterSettings:
    """
     Function for creating parameter settings for the cosine coefficients of body's spherical harmonics gravitational model.
     ...
     :class:`~tudatpy.dynamics.parameters_setup.EstimatableParameterSettings`
         ...
         for the applicable spherical harmonics c-coefficients of the specified body's gravitational model.
    """
def spherical_harmonics_s_coefficients(body: str, minimum_degree: typing.SupportsInt, minimum_order: typing.SupportsInt, maximum_degree: typing.SupportsInt, maximum_order: typing.SupportsInt) -> EstimatableParameterSettings:
    """
    ...
    """
def spherical_harmonics_s_coefficients_block(body: str, block_indices: collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt]]) -> EstimatableParameterSettings:
    """
     Function for creating parameter settings for the sine coefficients of body's spherical harmonics gravitational model.
     ...
     :class:`~tudatpy.dynamics.parameters_setup.EstimatableParameterSettings`
         ...
         for the applicable spherical harmonics s-coefficients of the specified body's gravitational model.
    """
def time_drift_observation_bias(link_ends: collections.abc.Mapping[..., ...], observable_type: ..., ref_epoch: typing.SupportsFloat, time_link_end: ...) -> EstimatableParameterSettings:
    ...
def yarkovsky_parameter(body_name: str, central_body_name: str = 'Sun') -> EstimatableParameterSettings:
     ...
     * The body specified by the ``body`` parameter to undergo :func:`~tudatpy.dynamics.propagation_setup.acceleration.yarkovsky` acceleration with ``central_body_name`` as body exerting the acceleration
     ...
     :class:`~tudatpy.dynamics.parameters_setup.EstimatableParameterSettings`
         :class:`~tudatpy.dynamics.parameters_setup.EstimatableParameterSettings` object for the specified body's radiation pressure coefficient.
    """
across_track_empirical_acceleration_component: EmpiricalAccelerationComponents  # value = <EmpiricalAccelerationComponents.across_track_empirical_acceleration_component: 2>
along_track_empirical_acceleration_component: EmpiricalAccelerationComponents  # value = <EmpiricalAccelerationComponents.along_track_empirical_acceleration_component: 1>
arc_wise_constant_drag_coefficient_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.arc_wise_constant_drag_coefficient_type: 26>
arc_wise_empirical_acceleration_coefficients_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.arc_wise_empirical_acceleration_coefficients_type: 21>
arc_wise_initial_body_state_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.arc_wise_initial_body_state_type: 0>
arc_wise_polynomial_clock_corrections_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.arc_wise_polynomial_clock_corrections_type: 40>
arc_wise_radiation_pressure_coefficient_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.arc_wise_radiation_pressure_coefficient_type: 7>
arc_wise_time_drift_observation_bias_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.arc_wise_time_drift_observation_bias_type: 36>
arcwise_constant_additive_observation_bias_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.arcwise_constant_additive_observation_bias_type: 13>
arcwise_constant_relative_observation_bias_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.arcwise_constant_relative_observation_bias_type: 15>
constant_additive_observation_bias_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.constant_additive_observation_bias_type: 12>
constant_drag_coefficient_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.constant_drag_coefficient_type: 5>
constant_empirical: EmpiricalAccelerationFunctionalShapes  # value = <EmpiricalAccelerationFunctionalShapes.constant_empirical: 0>
constant_relative_observation_bias_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.constant_relative_observation_bias_type: 14>
constant_rotation_rate_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.constant_rotation_rate_type: 10>
constant_time_drift_observation_bias_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.constant_time_drift_observation_bias_type: 35>
core_factor_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.core_factor_type: 29>
cosine_empirical: EmpiricalAccelerationFunctionalShapes  # value = <EmpiricalAccelerationFunctionalShapes.cosine_empirical: 2>
desaturation_delta_v_values_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.desaturation_delta_v_values_type: 31>
direct_dissipation_tidal_time_lag_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.direct_dissipation_tidal_time_lag_type: 24>
drag_component_scaling_factor_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.drag_component_scaling_factor_type: 55>
empirical_acceleration_coefficients_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.empirical_acceleration_coefficients_type: 20>
equivalence_principle_lpi_violation_parameter_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.equivalence_principle_lpi_violation_parameter_type: 19>
free_core_nutation_rate_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.free_core_nutation_rate_type: 30>
full_degree_tidal_love_number_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.full_degree_tidal_love_number_type: 22>
global_polynomial_clock_corrections_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.global_polynomial_clock_corrections_type: 39>
gravitational_parameter_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.gravitational_parameter_type: 4>
ground_station_position_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.ground_station_position_type: 18>
initial_body_state_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.initial_body_state_type: 1>
initial_rotational_body_state_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.initial_rotational_body_state_type: 2>
inverse_tidal_quality_factor_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.inverse_tidal_quality_factor_type: 41>
lift_component_scaling_factor_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.lift_component_scaling_factor_type: 57>
mean_moment_of_inertia_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.mean_moment_of_inertia_type: 25>
periodic_spin_variation_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.periodic_spin_variation_type: 27>
polar_motion_amplitude_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.polar_motion_amplitude_type: 28>
ppn_parameter_beta_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.ppn_parameter_beta_type: 17>
ppn_parameter_gamma_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.ppn_parameter_gamma_type: 16>
radial_empirical_acceleration_component: EmpiricalAccelerationComponents  # value = <EmpiricalAccelerationComponents.radial_empirical_acceleration_component: 0>
radiation_pressure_coefficient_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.radiation_pressure_coefficient_type: 6>
radiation_pressure_target_direction_scaling_factor_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.radiation_pressure_target_direction_scaling_factor_type: 47>
radiation_pressure_target_perpendicular_direction_scaling_factor_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.radiation_pressure_target_perpendicular_direction_scaling_factor_type: 48>
rotation_pole_position_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.rotation_pole_position_type: 11>
rtg_force_vector_magnitude_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.rtg_force_vector_magnitude_type: 59>
rtg_force_vector_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.rtg_force_vector_type: 58>
side_component_scaling_factor_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.side_component_scaling_factor_type: 56>
sine_empirical: EmpiricalAccelerationFunctionalShapes  # value = <EmpiricalAccelerationFunctionalShapes.sine_empirical: 1>
single_degree_variable_tidal_love_number_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.single_degree_variable_tidal_love_number_type: 23>
spherical_harmonics_cosine_coefficient_block_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.spherical_harmonics_cosine_coefficient_block_type: 8>
spherical_harmonics_sine_coefficient_block_type: EstimatableParameterTypes  # value = <EstimatableParameterTypes.spherical_harmonics_sine_coefficient_block_type: 9>
