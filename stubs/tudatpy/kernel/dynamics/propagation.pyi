...
class PropagationTerminationReason:
    ...
    """
    __members__: typing.ClassVar[dict[str, PropagationTerminationReason]]  # value = {'propagation_never_run': <PropagationTerminationReason.propagation_never_run: 0>, 'unknown_reason': <PropagationTerminationReason.unknown_reason: 1>, 'termination_condition_reached': <PropagationTerminationReason.termination_condition_reached: 2>, 'runtime_error_caught_in_propagation': <PropagationTerminationReason.runtime_error_caught_in_propagation: 3>, 'nan_or_inf_detected_in_state': <PropagationTerminationReason.nan_or_inf_detected_in_state: 4>}
    nan_or_inf_detected_in_state: typing.ClassVar[PropagationTerminationReason]  # value = <PropagationTerminationReason.nan_or_inf_detected_in_state: 4>
    propagation_never_run: typing.ClassVar[PropagationTerminationReason]  # value = <PropagationTerminationReason.propagation_never_run: 0>
    runtime_error_caught_in_propagation: typing.ClassVar[PropagationTerminationReason]  # value = <PropagationTerminationReason.runtime_error_caught_in_propagation: 3>
    termination_condition_reached: typing.ClassVar[PropagationTerminationReason]  # value = <PropagationTerminationReason.termination_condition_reached: 2>
    unknown_reason: typing.ClassVar[PropagationTerminationReason]  # value = <PropagationTerminationReason.unknown_reason: 1>
...
class RotationalProperModeDampingResults:
    ...
    """
    @property
    def damped_initial_state(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
        """
    ...
    def damped_initial_state(self, arg0: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]) -> None:
        ...
    @property
    def forward_backward_dependent_variables(self) -> list[tuple[dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]], dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]]]:
        """
    ...
    def forward_backward_dependent_variables(self, arg0: collections.abc.Sequence[tuple[collections.abc.Mapping[typing.SupportsFloat, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]], collections.abc.Mapping[typing.SupportsFloat, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]]]]) -> None:
        ...
    @property
    def forward_backward_states(self) -> list[tuple[dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]], dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]]]:
        """
    ...
    def forward_backward_states(self, arg0: collections.abc.Sequence[tuple[collections.abc.Mapping[typing.SupportsFloat, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]], collections.abc.Mapping[typing.SupportsFloat, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]]]]) -> None:
        ...
...
class SingleArcSimulationResults(SimulationResults):
    ...
    def cumulative_number_of_function_evaluations_history(self) -> dict[float, int]:
        ...
        """
    @property
    def dependent_variable_history(self) -> dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]:
        """
                 **read-only**
        ...
        """
    @property
    def dependent_variable_history_time_object(self) -> dict[tudatpy.kernel.astro.time_representation.Time, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]:
        """
                 **read-only**
    ...
    def dependent_variable_ids(self) -> dict[tuple[int, int], str]:
        ...
        """
    @property
    def initial_and_final_times(self) -> tuple[tudatpy.kernel.astro.time_representation.Time, tudatpy.kernel.astro.time_representation.Time]:
        """
                 **read-only**
    ...
    def integration_completed_successfully(self) -> bool:
        ...
        """
    @property
    def ordered_dependent_variable_settings(self) -> dict[tuple[int, int], tudatpy.kernel.dynamics.propagation_setup.dependent_variable.SingleDependentVariableSaveSettings]:
        ...
    @property
    ...
    def propagation_is_performed(self) -> bool:
        ...
        """
    @property
    def state_history(self) -> dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]:
        """
                 **read-only**
        ...
        """
    @property
    def state_history_float(self) -> dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]:
        ...
    @property
    def state_history_float_split(self) -> tuple[list[float], list[typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]]:
        """
                 **read-only**
        ...
        """
    @property
    def state_history_time_object(self) -> dict[tudatpy.kernel.astro.time_representation.Time, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]:
        """
                 **read-only**
    ...
    def total_number_of_function_evaluations(self) -> float:
        ...
        """
    @property
    def unordered_dependent_variable_settings(self) -> list[tudatpy.kernel.dynamics.propagation_setup.dependent_variable.SingleDependentVariableSaveSettings]:
        ...
    @property
    def unprocessed_state_history(self) -> dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]:
        """
                 **read-only**
        ...
        """
    @property
    def unprocessed_state_history_time_object(self) -> dict[tudatpy.kernel.astro.time_representation.Time, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]:
        """
                 **read-only**
...
class SingleArcVariationalSimulationResults(SimulationResults):
    ...
    def dynamics_results(self) -> SingleArcSimulationResults:
        ...
        """
    @property
    def sensitivity_matrix_history(self) -> dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]]:
        """
                 **read-only**
        ...
        """
    @property
    def state_transition_matrix_history(self) -> dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]]:
        """
                 **read-only**
...
class TorqueModel:
    pass
def combine_initial_states(propagator_settings_per_type: collections.abc.Mapping[tudatpy.kernel.dynamics.propagation_setup.propagator.StateType, collections.abc.Sequence[tudatpy.kernel.dynamics.propagation_setup.propagator.SingleArcPropagatorSettings]]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
    """
    ...
    """
def get_damped_proper_mode_initial_rotational_state(bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, propagator_settings: tudatpy.kernel.dynamics.propagation_setup.propagator.SingleArcPropagatorSettings, body_mean_rotational_rate: typing.SupportsFloat, dissipation_times: collections.abc.Sequence[typing.SupportsFloat], propagate_undamped: bool = True) -> RotationalProperModeDampingResults:
    """
    ...
    """
def get_generalized_acceleration_size(state_type: tudatpy.kernel.dynamics.propagation_setup.propagator.StateType) -> int:
    ...
def get_initial_rotational_state_of_body(body_to_propagate: str, base_orientation: str, bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, initial_time: tudatpy.kernel.astro.time_representation.Time) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
    ...
def get_initial_state_of_bodies(bodies_to_propagate: collections.abc.Sequence[str], central_bodies: collections.abc.Sequence[str], body_system: tudatpy.kernel.dynamics.environment.SystemOfBodies, initial_time: tudatpy.kernel.astro.time_representation.Time) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
    ...
def get_initial_state_of_body(body_to_propagate: str, central_body: str, bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, initial_time: tudatpy.kernel.astro.time_representation.Time) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
    ...
def get_single_integration_differential_equation_order(state_type: tudatpy.kernel.dynamics.propagation_setup.propagator.StateType) -> int:
    ...
def get_state_of_bodies(bodies_to_propagate: collections.abc.Sequence[str], central_bodies: collections.abc.Sequence[str], body_system: tudatpy.kernel.dynamics.environment.SystemOfBodies, initial_time: tudatpy.kernel.astro.time_representation.Time) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
    """
    ...
    """
nan_or_inf_detected_in_state: PropagationTerminationReason  # value = <PropagationTerminationReason.nan_or_inf_detected_in_state: 4>
propagation_never_run: PropagationTerminationReason  # value = <PropagationTerminationReason.propagation_never_run: 0>
runtime_error_caught_in_propagation: PropagationTerminationReason  # value = <PropagationTerminationReason.runtime_error_caught_in_propagation: 3>
termination_condition_reached: PropagationTerminationReason  # value = <PropagationTerminationReason.termination_condition_reached: 2>
unknown_reason: PropagationTerminationReason  # value = <PropagationTerminationReason.unknown_reason: 1>
