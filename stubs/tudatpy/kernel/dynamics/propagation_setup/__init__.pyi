...
def create_acceleration_models(body_system: tudatpy.kernel.dynamics.environment.SystemOfBodies, selected_acceleration_per_body: collections.abc.Mapping[str, collections.abc.Mapping[str, collections.abc.Sequence[acceleration.AccelerationSettings]]], bodies_to_propagate: collections.abc.Sequence[str], central_bodies: collections.abc.Sequence[str]) -> dict[str, dict[str, list[..., 3, 1, 0, 3, ...]]]:
    """
    ...
    """
def create_mass_rate_models(body_system: tudatpy.kernel.dynamics.environment.SystemOfBodies, selected_mass_rates_per_body: collections.abc.Mapping[str, collections.abc.Sequence[mass_rate.MassRateModelSettings]], acceleration_models: collections.abc.Mapping[str, collections.abc.Mapping[str, collections.abc.Sequence[..., 3, 1, 0, 3, ...]]] = None) -> dict[str, list[...]]:
    """
    ...
    """
def create_torque_models(body_system: tudatpy.kernel.dynamics.environment.SystemOfBodies, selected_torque_per_body: collections.abc.Mapping[str, collections.abc.Mapping[str, collections.abc.Sequence[torque.TorqueSettings]]], bodies_to_propagate: collections.abc.Sequence[str]) -> dict[str, dict[str, list[...]]]:
    """
     Function to create a set of acceleration models from a dictionary of bodies linked to acceleration model types.
