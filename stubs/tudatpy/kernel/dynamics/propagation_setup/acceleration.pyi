...
class AvailableAcceleration:
    ...
    """
    __members__: typing.ClassVar[dict[str, AvailableAcceleration]]  # value = {'undefined_acceleration_type': <AvailableAcceleration.undefined_acceleration_type: 0>, 'point_mass_gravity_type': <AvailableAcceleration.point_mass_gravity_type: 1>, 'aerodynamic_type': <AvailableAcceleration.aerodynamic_type: 2>, 'cannonball_radiation_pressure_type': <AvailableAcceleration.cannonball_radiation_pressure_type: 3>, 'spherical_harmonic_gravity_type': <AvailableAcceleration.spherical_harmonic_gravity_type: 4>, 'mutual_spherical_harmonic_gravity_type': <AvailableAcceleration.mutual_spherical_harmonic_gravity_type: 5>, 'polyhedron_gravity_type': <AvailableAcceleration.polyhedron_gravity_type: 6>, 'ring_gravity_type': <AvailableAcceleration.ring_gravity_type: 7>, 'thrust_acceleration_type': <AvailableAcceleration.thrust_acceleration_type: 13>, 'relativistic_correction_acceleration_type': <AvailableAcceleration.relativistic_correction_acceleration_type: 14>, 'empirical_acceleration_type': <AvailableAcceleration.empirical_acceleration_type: 15>, 'rtg_acceleration_type': <AvailableAcceleration.rtg_acceleration_type: 23>, 'direct_tidal_dissipation_in_central_body_acceleration_type': <AvailableAcceleration.direct_tidal_dissipation_in_central_body_acceleration_type: 16>, 'direct_tidal_dissipation_in_orbiting_body_acceleration_type': <AvailableAcceleration.direct_tidal_dissipation_in_orbiting_body_acceleration_type: 17>, 'quasi_impulsive_shots_acceleration_type': <AvailableAcceleration.quasi_impulsive_shots_acceleration_type: 19>, 'custom_acceleration_type': <AvailableAcceleration.custom_acceleration_type: 20>, 'radiation_pressure_type': <AvailableAcceleration.radiation_pressure_type: 18>, 'einstein_infeld_hoffmann_acceleration_type': <AvailableAcceleration.einstein_infeld_hoffmann_acceleration_type: 21>, 'yarkovsky_acceleration_type': <AvailableAcceleration.yarkovsky_acceleration_type: 22>}
    aerodynamic_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.aerodynamic_type: 2>
    cannonball_radiation_pressure_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.cannonball_radiation_pressure_type: 3>
    custom_acceleration_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.custom_acceleration_type: 20>
    direct_tidal_dissipation_in_central_body_acceleration_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.direct_tidal_dissipation_in_central_body_acceleration_type: 16>
    direct_tidal_dissipation_in_orbiting_body_acceleration_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.direct_tidal_dissipation_in_orbiting_body_acceleration_type: 17>
    einstein_infeld_hoffmann_acceleration_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.einstein_infeld_hoffmann_acceleration_type: 21>
    empirical_acceleration_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.empirical_acceleration_type: 15>
    mutual_spherical_harmonic_gravity_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.mutual_spherical_harmonic_gravity_type: 5>
    point_mass_gravity_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.point_mass_gravity_type: 1>
    polyhedron_gravity_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.polyhedron_gravity_type: 6>
    quasi_impulsive_shots_acceleration_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.quasi_impulsive_shots_acceleration_type: 19>
    radiation_pressure_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.radiation_pressure_type: 18>
    relativistic_correction_acceleration_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.relativistic_correction_acceleration_type: 14>
    ring_gravity_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.ring_gravity_type: 7>
    rtg_acceleration_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.rtg_acceleration_type: 23>
    spherical_harmonic_gravity_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.spherical_harmonic_gravity_type: 4>
    thrust_acceleration_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.thrust_acceleration_type: 13>
    undefined_acceleration_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.undefined_acceleration_type: 0>
    yarkovsky_acceleration_type: typing.ClassVar[AvailableAcceleration]  # value = <AvailableAcceleration.yarkovsky_acceleration_type: 22>
...
class MutualSphericalHarmonicAccelerationSettings(AccelerationSettings):
    ...
    """
class RTGAccelerationSettings(AccelerationSettings):
    """
...
class ThrustAccelerationSettings(AccelerationSettings):
    ...
    """
    @property
    def direction_settings(self) -> tudatpy.kernel.dynamics.propagation_setup.thrust.ThrustDirectionSettings:
        ...
    @property
    def magnitude_settings(self) -> tudatpy.kernel.dynamics.propagation_setup.thrust.ThrustMagnitudeSettings:
        ...
...
def cannonball_radiation_pressure() -> AccelerationSettings:
    ...
def custom(acceleration_function: collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]]) -> AccelerationSettings:
    ...
def custom_acceleration(acceleration_function: collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]]) -> AccelerationSettings:
    """
    ...
    """
@typing.overload
def direct_tidal_dissipation_acceleration(k2_love_number: typing.SupportsFloat, time_lag: typing.SupportsFloat, include_direct_radial_component: bool = True, use_tide_raised_on_planet: bool = True, explicit_libraional_tide_on_satellite: bool = False) -> AccelerationSettings:
    """
    ...
    """
@typing.overload
def direct_tidal_dissipation_acceleration(k2_love_number: typing.SupportsFloat, inverse_tidal_quality_factor: typing.SupportsFloat, tidal_period: typing.SupportsFloat, include_direct_radial_component: bool = True, use_tide_raised_on_planet: bool = True, explicit_libraional_tide_on_satellite: bool = False) -> AccelerationSettings:
    """
    Creates settings for tidal acceleration.
...
def einstein_infeld_hofmann() -> AccelerationSettings:
    ...
    * :math:`c`: speed of light
    ...
    AccelerationSettings
        ...
        Acceleration settings object.
    """
def empirical(constant_acceleration: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"] = ..., sine_acceleration: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"] = ..., cosine_acceleration: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"] = ...) -> AccelerationSettings:
    """
     ...
     .. code-block:: python
        ...
        acceleration_settings_on_vehicle["Sun"] = [propagation_setup.acceleration.empirical(
            ...
            cosine_acceleration)]
    """
def mutual_spherical_harmonic_gravity(maximum_degree_body_exerting: typing.SupportsInt, maximum_order_body_exerting: typing.SupportsInt, maximum_degree_body_undergoing: typing.SupportsInt, maximum_order_body_undergoing: typing.SupportsInt, maximum_degree_central_body: typing.SupportsInt = 0, maximum_order_central_body: typing.SupportsInt = 0) -> AccelerationSettings:
    """
...
def polyhedron_gravity() -> AccelerationSettings:
    ...
    -------
     AccelerationSettings
         Acceleration settings object.
    """
def quasi_impulsive_shots_acceleration(thrust_mid_times: collections.abc.Sequence[typing.SupportsFloat], delta_v_values: collections.abc.Sequence[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"]], total_maneuver_time: typing.SupportsFloat, maneuver_rise_time: typing.SupportsFloat) -> AccelerationSettings:
    """
     ...
     .. code-block:: python
        ...
        acceleration_settings_on_spacecraft["Spacecraft"] = [propagation_setup.acceleration.quasi_impulsive_shots_acceleration(
             ...
             maneuver_duration)]
    """
def radiation_pressure(target_type: tudatpy.kernel.dynamics.environment_setup.radiation_pressure.RadiationPressureTargetModelType = ...) -> AccelerationSettings:
    """
    ...
    AccelerationSettings
        Acceleration settings object.
    """
def relativistic_correction(use_schwarzschild: bool = False, use_lense_thirring: bool = False, use_de_sitter: bool = False, de_sitter_central_body: str = '', lense_thirring_angular_momentum: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"] = ...) -> AccelerationSettings:
    """
...
def ring_gravity() -> AccelerationSettings:
    ...
    AccelerationSettings
        ...
        Acceleration settings object.
    """
def rtg(reference_thrust_vector: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"], decay_scale_factor: typing.SupportsFloat, reference_epoch: typing.SupportsFloat) -> AccelerationSettings:
    """
    ...
    """
def spherical_harmonic_gravity(maximum_degree: typing.SupportsInt, maximum_order: typing.SupportsInt) -> AccelerationSettings:
    """
     ...
     .. code-block:: python
        ...
        accelerations_acting_on_vehicle["Earth"] = [propagation_setup.acceleration.spherical_harmonic_gravity(
             ...
             maximum_order)]
    """
def thrust_and_isp_from_custom_function(thrust_force_function: collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]], constant_specific_impulse: typing.SupportsFloat, thrust_frame: tudatpy.kernel.dynamics.propagation_setup.thrust.ThrustFrames = ..., central_body: str = '') -> AccelerationSettings:
    """
...
def thrust_from_all_engines() -> AccelerationSettings:
    ...
    """
def thrust_from_custom_function(thrust_force_function: collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]], specific_impulse_function: collections.abc.Callable[[typing.SupportsFloat], float], thrust_frame: tudatpy.kernel.dynamics.propagation_setup.thrust.ThrustFrames = ..., central_body: str = '') -> AccelerationSettings:
    ...
def thrust_from_direction_and_magnitude(thrust_direction_settings: tudatpy.kernel.dynamics.propagation_setup.thrust.ThrustDirectionSettings, thrust_magnitude_settings: tudatpy.kernel.dynamics.propagation_setup.thrust.ThrustMagnitudeSettings) -> AccelerationSettings:
    ...
def thrust_from_engine(engine_name: str) -> AccelerationSettings:
    """
     ...
     ThrustAccelerationSettings
         Thrust acceleration settings object.
    """
def thrust_from_engines(engine_names: collections.abc.Sequence[str]) -> AccelerationSettings:
    """
     ...
     ThrustAccelerationSettings
         Thrust acceleration settings object.
    """
def yarkovsky(yarkovsky_parameter: typing.SupportsFloat) -> AccelerationSettings:
    """
     ...
     AccelerationSettings
         Acceleration settings object.
    """
aerodynamic_type: AvailableAcceleration  # value = <AvailableAcceleration.aerodynamic_type: 2>
cannonball_radiation_pressure_type: AvailableAcceleration  # value = <AvailableAcceleration.cannonball_radiation_pressure_type: 3>
custom_acceleration_type: AvailableAcceleration  # value = <AvailableAcceleration.custom_acceleration_type: 20>
direct_tidal_dissipation_in_central_body_acceleration_type: AvailableAcceleration  # value = <AvailableAcceleration.direct_tidal_dissipation_in_central_body_acceleration_type: 16>
direct_tidal_dissipation_in_orbiting_body_acceleration_type: AvailableAcceleration  # value = <AvailableAcceleration.direct_tidal_dissipation_in_orbiting_body_acceleration_type: 17>
einstein_infeld_hoffmann_acceleration_type: AvailableAcceleration  # value = <AvailableAcceleration.einstein_infeld_hoffmann_acceleration_type: 21>
empirical_acceleration_type: AvailableAcceleration  # value = <AvailableAcceleration.empirical_acceleration_type: 15>
mutual_spherical_harmonic_gravity_type: AvailableAcceleration  # value = <AvailableAcceleration.mutual_spherical_harmonic_gravity_type: 5>
point_mass_gravity_type: AvailableAcceleration  # value = <AvailableAcceleration.point_mass_gravity_type: 1>
polyhedron_gravity_type: AvailableAcceleration  # value = <AvailableAcceleration.polyhedron_gravity_type: 6>
quasi_impulsive_shots_acceleration_type: AvailableAcceleration  # value = <AvailableAcceleration.quasi_impulsive_shots_acceleration_type: 19>
radiation_pressure_type: AvailableAcceleration  # value = <AvailableAcceleration.radiation_pressure_type: 18>
relativistic_correction_acceleration_type: AvailableAcceleration  # value = <AvailableAcceleration.relativistic_correction_acceleration_type: 14>
ring_gravity_type: AvailableAcceleration  # value = <AvailableAcceleration.ring_gravity_type: 7>
rtg_acceleration_type: AvailableAcceleration  # value = <AvailableAcceleration.rtg_acceleration_type: 23>
spherical_harmonic_gravity_type: AvailableAcceleration  # value = <AvailableAcceleration.spherical_harmonic_gravity_type: 4>
thrust_acceleration_type: AvailableAcceleration  # value = <AvailableAcceleration.thrust_acceleration_type: 13>
undefined_acceleration_type: AvailableAcceleration  # value = <AvailableAcceleration.undefined_acceleration_type: 0>
yarkovsky_acceleration_type: AvailableAcceleration  # value = <AvailableAcceleration.yarkovsky_acceleration_type: 22>
