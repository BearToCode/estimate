...
class PropagationDependentVariables:
    ...
    """
    __members__: typing.ClassVar[dict[str, PropagationDependentVariables]]  # value = {'mach_number_type': <PropagationDependentVariables.mach_number_type: 0>, 'altitude_type': <PropagationDependentVariables.altitude_type: 1>, 'airspeed_type': <PropagationDependentVariables.airspeed_type: 2>, 'local_density_type': <PropagationDependentVariables.local_density_type: 3>, 'relative_speed_type': <PropagationDependentVariables.relative_speed_type: 4>, 'relative_position_type': <PropagationDependentVariables.relative_position_type: 5>, 'relative_distance_type': <PropagationDependentVariables.relative_distance_type: 6>, 'relative_velocity_type': <PropagationDependentVariables.relative_velocity_type: 7>, 'radiation_pressure_type': <PropagationDependentVariables.radiation_pressure_type: 8>, 'total_acceleration_norm_type': <PropagationDependentVariables.total_acceleration_norm_type: 9>, 'single_acceleration_norm_type': <PropagationDependentVariables.single_acceleration_norm_type: 10>, 'total_acceleration_type': <PropagationDependentVariables.total_acceleration_type: 11>, 'single_acceleration_type': <PropagationDependentVariables.single_acceleration_type: 12>, 'aerodynamic_force_coefficients_type': <PropagationDependentVariables.aerodynamic_force_coefficients_type: 13>, 'aerodynamic_moment_coefficients_type': <PropagationDependentVariables.aerodynamic_moment_coefficients_type: 14>, 'rotation_matrix_to_body_fixed_frame_type': <PropagationDependentVariables.rotation_matrix_to_body_fixed_frame_type: 15>, 'intermediate_aerodynamic_rotation_matrix_type': <PropagationDependentVariables.intermediate_aerodynamic_rotation_matrix_type: 16>, 'relative_body_aerodynamic_orientation_angle_type': <PropagationDependentVariables.relative_body_aerodynamic_orientation_angle_type: 17>, 'body_fixed_airspeed_based_velocity_type': <PropagationDependentVariables.body_fixed_airspeed_based_velocity_type: 18>, 'total_aerodynamic_g_load_type': <PropagationDependentVariables.total_aerodynamic_g_load_type: 19>, 'stagnation_point_heat_flux_type': <PropagationDependentVariables.stagnation_point_heat_flux_type: 20>, 'local_temperature_type': <PropagationDependentVariables.local_temperature_type: 21>, 'geodetic_latitude_type': <PropagationDependentVariables.geodetic_latitude_type: 22>, 'control_surface_deflection_type': <PropagationDependentVariables.control_surface_deflection_type: 23>, 'total_mass_rate_type': <PropagationDependentVariables.total_mass_rate_type: 24>, 'tnw_to_inertial_frame_rotation_type': <PropagationDependentVariables.tnw_to_inertial_frame_rotation_type: 25>, 'rsw_to_inertial_frame_rotation_type': <PropagationDependentVariables.rsw_to_inertial_frame_rotation_type: 47>, 'periapsis_altitude_type': <PropagationDependentVariables.periapsis_altitude_type: 26>, 'apoapsis_altitude_type': <PropagationDependentVariables.apoapsis_altitude_type: 51>, 'total_torque_norm_type': <PropagationDependentVariables.total_torque_norm_type: 27>, 'single_torque_norm_type': <PropagationDependentVariables.single_torque_norm_type: 28>, 'total_torque_type': <PropagationDependentVariables.total_torque_type: 29>, 'single_torque_type': <PropagationDependentVariables.single_torque_type: 30>, 'body_fixed_groundspeed_based_velocity_type': <PropagationDependentVariables.body_fixed_groundspeed_based_velocity_type: 31>, 'keplerian_state_type': <PropagationDependentVariables.keplerian_state_type: 32>, 'modified_equinoctial_state_type': <PropagationDependentVariables.modified_equinoctial_state_type: 33>, 'spherical_harmonic_acceleration_terms_type': <PropagationDependentVariables.spherical_harmonic_acceleration_terms_type: 34>, 'spherical_harmonic_acceleration_norm_terms_type': <PropagationDependentVariables.spherical_harmonic_acceleration_norm_terms_type: 35>, 'body_fixed_relative_cartesian_position_type': <PropagationDependentVariables.body_fixed_relative_cartesian_position_type: 36>, 'body_fixed_relative_spherical_position_type': <PropagationDependentVariables.body_fixed_relative_spherical_position_type: 37>, 'total_gravity_field_variation_acceleration_type': <PropagationDependentVariables.total_gravity_field_variation_acceleration_type: 38>, 'single_gravity_field_variation_acceleration_type': <PropagationDependentVariables.single_gravity_field_variation_acceleration_type: 39>, 'single_gravity_field_variation_acceleration_terms_type': <PropagationDependentVariables.single_gravity_field_variation_acceleration_terms_type: 40>, 'acceleration_partial_wrt_body_translational_state_type': <PropagationDependentVariables.acceleration_partial_wrt_body_translational_state_type: 41>, 'local_dynamic_pressure_type': <PropagationDependentVariables.local_dynamic_pressure_type: 42>, 'euler_angles_to_body_fixed_type': <PropagationDependentVariables.euler_angles_to_body_fixed_type: 44>, 'current_body_mass_type': <PropagationDependentVariables.current_body_mass_type: 45>, 'radiation_pressure_coefficient_type': <PropagationDependentVariables.radiation_pressure_coefficient_type: 46>, 'custom_type': <PropagationDependentVariables.custom_type: 48>, 'gravity_field_potential_type': <PropagationDependentVariables.gravity_field_potential_type: 52>, 'gravity_field_laplacian_of_potential_type': <PropagationDependentVariables.gravity_field_laplacian_of_potential_type: 53>}
    acceleration_partial_wrt_body_translational_state_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.acceleration_partial_wrt_body_translational_state_type: 41>
    aerodynamic_force_coefficients_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.aerodynamic_force_coefficients_type: 13>
    aerodynamic_moment_coefficients_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.aerodynamic_moment_coefficients_type: 14>
    airspeed_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.airspeed_type: 2>
    altitude_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.altitude_type: 1>
    apoapsis_altitude_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.apoapsis_altitude_type: 51>
    body_fixed_airspeed_based_velocity_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.body_fixed_airspeed_based_velocity_type: 18>
    body_fixed_groundspeed_based_velocity_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.body_fixed_groundspeed_based_velocity_type: 31>
    body_fixed_relative_cartesian_position_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.body_fixed_relative_cartesian_position_type: 36>
    body_fixed_relative_spherical_position_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.body_fixed_relative_spherical_position_type: 37>
    control_surface_deflection_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.control_surface_deflection_type: 23>
    current_body_mass_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.current_body_mass_type: 45>
    custom_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.custom_type: 48>
    euler_angles_to_body_fixed_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.euler_angles_to_body_fixed_type: 44>
    geodetic_latitude_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.geodetic_latitude_type: 22>
    gravity_field_laplacian_of_potential_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.gravity_field_laplacian_of_potential_type: 53>
    gravity_field_potential_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.gravity_field_potential_type: 52>
    intermediate_aerodynamic_rotation_matrix_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.intermediate_aerodynamic_rotation_matrix_type: 16>
    keplerian_state_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.keplerian_state_type: 32>
    local_density_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.local_density_type: 3>
    local_dynamic_pressure_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.local_dynamic_pressure_type: 42>
    local_temperature_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.local_temperature_type: 21>
    mach_number_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.mach_number_type: 0>
    modified_equinoctial_state_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.modified_equinoctial_state_type: 33>
    periapsis_altitude_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.periapsis_altitude_type: 26>
    radiation_pressure_coefficient_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.radiation_pressure_coefficient_type: 46>
    radiation_pressure_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.radiation_pressure_type: 8>
    relative_body_aerodynamic_orientation_angle_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.relative_body_aerodynamic_orientation_angle_type: 17>
    relative_distance_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.relative_distance_type: 6>
    relative_position_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.relative_position_type: 5>
    relative_speed_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.relative_speed_type: 4>
    relative_velocity_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.relative_velocity_type: 7>
    rotation_matrix_to_body_fixed_frame_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.rotation_matrix_to_body_fixed_frame_type: 15>
    rsw_to_inertial_frame_rotation_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.rsw_to_inertial_frame_rotation_type: 47>
    single_acceleration_norm_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.single_acceleration_norm_type: 10>
    single_acceleration_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.single_acceleration_type: 12>
    single_gravity_field_variation_acceleration_terms_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.single_gravity_field_variation_acceleration_terms_type: 40>
    single_gravity_field_variation_acceleration_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.single_gravity_field_variation_acceleration_type: 39>
    single_torque_norm_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.single_torque_norm_type: 28>
    single_torque_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.single_torque_type: 30>
    spherical_harmonic_acceleration_norm_terms_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.spherical_harmonic_acceleration_norm_terms_type: 35>
    spherical_harmonic_acceleration_terms_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.spherical_harmonic_acceleration_terms_type: 34>
    stagnation_point_heat_flux_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.stagnation_point_heat_flux_type: 20>
    tnw_to_inertial_frame_rotation_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.tnw_to_inertial_frame_rotation_type: 25>
    total_acceleration_norm_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.total_acceleration_norm_type: 9>
    total_acceleration_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.total_acceleration_type: 11>
    total_aerodynamic_g_load_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.total_aerodynamic_g_load_type: 19>
    total_gravity_field_variation_acceleration_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.total_gravity_field_variation_acceleration_type: 38>
    total_mass_rate_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.total_mass_rate_type: 24>
    total_torque_norm_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.total_torque_norm_type: 27>
    total_torque_type: typing.ClassVar[PropagationDependentVariables]  # value = <PropagationDependentVariables.total_torque_type: 29>
...
class SingleAccelerationDependentVariableSaveSettings(SingleDependentVariableSaveSettings):
    ...
    """
    @property
    def acceleration_model_type(self) -> tudatpy.kernel.dynamics.propagation_setup.acceleration.AvailableAcceleration:
        """
...
def cross_section_change(target_name: str, source_name: str, acceleration_type: str = 'radiation_pressure') -> SingleDependentVariableSaveSettings:
    ...
    No documentation found.
    """
def custom(custom_function: collections.abc.Callable[[], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]], variable_size: typing.SupportsInt) -> SingleDependentVariableSaveSettings:
    ...
def custom_dependent_variable(custom_function: collections.abc.Callable[[], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]], variable_size: typing.SupportsInt) -> SingleDependentVariableSaveSettings:
    """
...
def get_dependent_variable_id(dependent_variable_settings: SingleDependentVariableSaveSettings) -> str:
    ...
    """
def get_dependent_variable_shape(dependent_variable_settings: SingleDependentVariableSaveSettings, bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies) -> tuple[int, int]:
    """
     ...
     .. code-block:: python
         ...
         # prints (3, 1)
    """
def get_dependent_variable_size(dependent_variable_settings: SingleDependentVariableSaveSettings, bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies) -> int:
    """
...
def inertial_to_body_fixed_rotation_frame(body: str) -> SingleDependentVariableSaveSettings:
    """
     ...
     9
    """
def intermediate_aerodynamic_rotation_matrix_variable(body: str, base_frame: tudatpy.kernel.dynamics.environment_setup.aerodynamic_coefficients.AerodynamicsReferenceFrames, target_frame: tudatpy.kernel.dynamics.environment_setup.aerodynamic_coefficients.AerodynamicsReferenceFrames, central_body: str = '') -> SingleDependentVariableSaveSettings:
    """
...
def mach_number(body: str, central_body: str) -> SingleDependentVariableSaveSettings:
    ...
    """
def minimum_body_distance(body_name: str, bodies_to_check: collections.abc.Sequence[str]) -> SingleDependentVariableSaveSettings:
    """
     ...
     2
    """
def minimum_visible_station_body_distances(body_name: str, station_name: str, bodies_to_check: collections.abc.Sequence[str], minimum_elevation_angle: typing.SupportsFloat) -> SingleDependentVariableSaveSettings:
    """
...
def sideslip_angle(body: str, central_body: str) -> SingleDependentVariableSaveSettings:
    """
     ...
     1
    """
def single_acceleration(acceleration_type: tudatpy.kernel.dynamics.propagation_setup.acceleration.AvailableAcceleration, body_undergoing_acceleration: str, body_exerting_acceleration: str) -> SingleAccelerationDependentVariableSaveSettings:
    """
    ...
    """
def single_acceleration_norm(acceleration_type: tudatpy.kernel.dynamics.propagation_setup.acceleration.AvailableAcceleration, body_undergoing_acceleration: str, body_exerting_acceleration: str) -> SingleAccelerationDependentVariableSaveSettings:
    """
     ...
     .. code-block:: python
        ...
        propagation_setup.dependent_variable.single_acceleration_norm(
                propagation_setup.acceleration.point_mass_gravity_type, 'Spacecraft', 'Earth' )
    """
def single_gravity_field_variation_acceleration(body_undergoing_acceleration: str, body_exerting_acceleration: str, deformation_type: tudatpy.kernel.dynamics.environment_setup.gravity_field_variation.BodyDeformationTypes, identifier: str = '') -> SingleDependentVariableSaveSettings:
    """
     ...
     3
    """
def single_per_term_gravity_field_variation_acceleration(body_undergoing_acceleration: str, body_exerting_acceleration: str, component_indices: collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt]], deformation_type: tudatpy.kernel.dynamics.environment_setup.gravity_field_variation.BodyDeformationTypes, identifier: str = '') -> SingleDependentVariableSaveSettings:
    """
    ...
    """
def single_torque(torque_type: tudatpy.kernel.dynamics.propagation_setup.torque.AvailableTorque, body_undergoing_torque: str, body_exerting_torque: str) -> SingleDependentVariableSaveSettings:
    """
     ...
     3
    """
def single_torque_norm(torque_type: tudatpy.kernel.dynamics.propagation_setup.torque.AvailableTorque, body_undergoing_torque: str, body_exerting_torque: str) -> SingleDependentVariableSaveSettings:
    """
     ...
     1
    """
def spherical_harmonic_terms_acceleration(body_undergoing_acceleration: str, body_exerting_acceleration: str, component_indices: collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt]]) -> SingleDependentVariableSaveSettings:
    """
    ...
    """
def spherical_harmonic_terms_acceleration_norm(body_undergoing_acceleration: str, body_exerting_acceleration: str, component_indices: collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt]]) -> SingleDependentVariableSaveSettings:
    """
...
def total_mass_rate(body: str) -> SingleDependentVariableSaveSettings:
    """
     ...
     1
    """
def total_spherical_harmonic_cosine_coefficient_variations(body: str, minimum_degree: typing.SupportsInt, maximum_degree: typing.SupportsInt, minimum_order: typing.SupportsInt, maximum_order: typing.SupportsInt) -> SingleDependentVariableSaveSettings:
    """
    No documentation found.
    """
def total_spherical_harmonic_cosine_coefficient_variations_from_indices(body: str, component_indices: collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt]]) -> SingleDependentVariableSaveSettings:
    """
    No documentation found.
    """
def total_spherical_harmonic_sine_coefficient_variations(body: str, minimum_degree: typing.SupportsInt, maximum_degree: typing.SupportsInt, minimum_order: typing.SupportsInt, maximum_order: typing.SupportsInt) -> SingleDependentVariableSaveSettings:
    """
    No documentation found.
    """
def total_spherical_harmonic_sine_coefficient_variations_from_indices(body: str, component_indices: collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt]]) -> SingleDependentVariableSaveSettings:
    """
    No documentation found.
    """
...
def visible_radiation_source_area(target_body: str, source_body: str) -> SingleDependentVariableSaveSettings:
    """
     ...
     1
    """
acceleration_partial_wrt_body_translational_state_type: PropagationDependentVariables  # value = <PropagationDependentVariables.acceleration_partial_wrt_body_translational_state_type: 41>
aerodynamic_force_coefficients_type: PropagationDependentVariables  # value = <PropagationDependentVariables.aerodynamic_force_coefficients_type: 13>
aerodynamic_moment_coefficients_type: PropagationDependentVariables  # value = <PropagationDependentVariables.aerodynamic_moment_coefficients_type: 14>
airspeed_type: PropagationDependentVariables  # value = <PropagationDependentVariables.airspeed_type: 2>
altitude_type: PropagationDependentVariables  # value = <PropagationDependentVariables.altitude_type: 1>
apoapsis_altitude_type: PropagationDependentVariables  # value = <PropagationDependentVariables.apoapsis_altitude_type: 51>
body_fixed_airspeed_based_velocity_type: PropagationDependentVariables  # value = <PropagationDependentVariables.body_fixed_airspeed_based_velocity_type: 18>
body_fixed_groundspeed_based_velocity_type: PropagationDependentVariables  # value = <PropagationDependentVariables.body_fixed_groundspeed_based_velocity_type: 31>
body_fixed_relative_cartesian_position_type: PropagationDependentVariables  # value = <PropagationDependentVariables.body_fixed_relative_cartesian_position_type: 36>
body_fixed_relative_spherical_position_type: PropagationDependentVariables  # value = <PropagationDependentVariables.body_fixed_relative_spherical_position_type: 37>
control_surface_deflection_type: PropagationDependentVariables  # value = <PropagationDependentVariables.control_surface_deflection_type: 23>
current_body_mass_type: PropagationDependentVariables  # value = <PropagationDependentVariables.current_body_mass_type: 45>
custom_type: PropagationDependentVariables  # value = <PropagationDependentVariables.custom_type: 48>
euler_angles_to_body_fixed_type: PropagationDependentVariables  # value = <PropagationDependentVariables.euler_angles_to_body_fixed_type: 44>
geodetic_latitude_type: PropagationDependentVariables  # value = <PropagationDependentVariables.geodetic_latitude_type: 22>
gravity_field_laplacian_of_potential_type: PropagationDependentVariables  # value = <PropagationDependentVariables.gravity_field_laplacian_of_potential_type: 53>
gravity_field_potential_type: PropagationDependentVariables  # value = <PropagationDependentVariables.gravity_field_potential_type: 52>
intermediate_aerodynamic_rotation_matrix_type: PropagationDependentVariables  # value = <PropagationDependentVariables.intermediate_aerodynamic_rotation_matrix_type: 16>
keplerian_state_type: PropagationDependentVariables  # value = <PropagationDependentVariables.keplerian_state_type: 32>
local_density_type: PropagationDependentVariables  # value = <PropagationDependentVariables.local_density_type: 3>
local_dynamic_pressure_type: PropagationDependentVariables  # value = <PropagationDependentVariables.local_dynamic_pressure_type: 42>
local_temperature_type: PropagationDependentVariables  # value = <PropagationDependentVariables.local_temperature_type: 21>
mach_number_type: PropagationDependentVariables  # value = <PropagationDependentVariables.mach_number_type: 0>
modified_equinoctial_state_type: PropagationDependentVariables  # value = <PropagationDependentVariables.modified_equinoctial_state_type: 33>
periapsis_altitude_type: PropagationDependentVariables  # value = <PropagationDependentVariables.periapsis_altitude_type: 26>
radiation_pressure_coefficient_type: PropagationDependentVariables  # value = <PropagationDependentVariables.radiation_pressure_coefficient_type: 46>
radiation_pressure_type: PropagationDependentVariables  # value = <PropagationDependentVariables.radiation_pressure_type: 8>
relative_body_aerodynamic_orientation_angle_type: PropagationDependentVariables  # value = <PropagationDependentVariables.relative_body_aerodynamic_orientation_angle_type: 17>
relative_distance_type: PropagationDependentVariables  # value = <PropagationDependentVariables.relative_distance_type: 6>
relative_position_type: PropagationDependentVariables  # value = <PropagationDependentVariables.relative_position_type: 5>
relative_speed_type: PropagationDependentVariables  # value = <PropagationDependentVariables.relative_speed_type: 4>
relative_velocity_type: PropagationDependentVariables  # value = <PropagationDependentVariables.relative_velocity_type: 7>
rotation_matrix_to_body_fixed_frame_type: PropagationDependentVariables  # value = <PropagationDependentVariables.rotation_matrix_to_body_fixed_frame_type: 15>
rsw_to_inertial_frame_rotation_type: PropagationDependentVariables  # value = <PropagationDependentVariables.rsw_to_inertial_frame_rotation_type: 47>
single_acceleration_norm_type: PropagationDependentVariables  # value = <PropagationDependentVariables.single_acceleration_norm_type: 10>
single_acceleration_type: PropagationDependentVariables  # value = <PropagationDependentVariables.single_acceleration_type: 12>
single_gravity_field_variation_acceleration_terms_type: PropagationDependentVariables  # value = <PropagationDependentVariables.single_gravity_field_variation_acceleration_terms_type: 40>
single_gravity_field_variation_acceleration_type: PropagationDependentVariables  # value = <PropagationDependentVariables.single_gravity_field_variation_acceleration_type: 39>
single_torque_norm_type: PropagationDependentVariables  # value = <PropagationDependentVariables.single_torque_norm_type: 28>
single_torque_type: PropagationDependentVariables  # value = <PropagationDependentVariables.single_torque_type: 30>
spherical_harmonic_acceleration_norm_terms_type: PropagationDependentVariables  # value = <PropagationDependentVariables.spherical_harmonic_acceleration_norm_terms_type: 35>
spherical_harmonic_acceleration_terms_type: PropagationDependentVariables  # value = <PropagationDependentVariables.spherical_harmonic_acceleration_terms_type: 34>
stagnation_point_heat_flux_type: PropagationDependentVariables  # value = <PropagationDependentVariables.stagnation_point_heat_flux_type: 20>
tnw_to_inertial_frame_rotation_type: PropagationDependentVariables  # value = <PropagationDependentVariables.tnw_to_inertial_frame_rotation_type: 25>
total_acceleration_norm_type: PropagationDependentVariables  # value = <PropagationDependentVariables.total_acceleration_norm_type: 9>
total_acceleration_type: PropagationDependentVariables  # value = <PropagationDependentVariables.total_acceleration_type: 11>
total_aerodynamic_g_load_type: PropagationDependentVariables  # value = <PropagationDependentVariables.total_aerodynamic_g_load_type: 19>
total_gravity_field_variation_acceleration_type: PropagationDependentVariables  # value = <PropagationDependentVariables.total_gravity_field_variation_acceleration_type: 38>
total_mass_rate_type: PropagationDependentVariables  # value = <PropagationDependentVariables.total_mass_rate_type: 24>
total_torque_norm_type: PropagationDependentVariables  # value = <PropagationDependentVariables.total_torque_norm_type: 27>
total_torque_type: PropagationDependentVariables  # value = <PropagationDependentVariables.total_torque_type: 29>
