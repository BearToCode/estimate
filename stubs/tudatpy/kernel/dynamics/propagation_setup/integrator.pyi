...
class AvailableIntegrators:
    ...
    """
    __members__: typing.ClassVar[dict[str, AvailableIntegrators]]  # value = {'runge_kutta_fixed_step_size_type': <AvailableIntegrators.runge_kutta_fixed_step_size_type: 2>, 'runge_kutta_variable_step_size_type': <AvailableIntegrators.runge_kutta_variable_step_size_type: 3>, 'bulirsch_stoer_type': <AvailableIntegrators.bulirsch_stoer_type: 4>, 'adams_bashforth_moulton_type': <AvailableIntegrators.adams_bashforth_moulton_type: 5>}
    adams_bashforth_moulton_type: typing.ClassVar[AvailableIntegrators]  # value = <AvailableIntegrators.adams_bashforth_moulton_type: 5>
    bulirsch_stoer_type: typing.ClassVar[AvailableIntegrators]  # value = <AvailableIntegrators.bulirsch_stoer_type: 4>
    runge_kutta_fixed_step_size_type: typing.ClassVar[AvailableIntegrators]  # value = <AvailableIntegrators.runge_kutta_fixed_step_size_type: 2>
    runge_kutta_variable_step_size_type: typing.ClassVar[AvailableIntegrators]  # value = <AvailableIntegrators.runge_kutta_variable_step_size_type: 3>
...
class CoefficientSets:
    ...
    """
    SSPRK3: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.SSPRK3: 7>
    __members__: typing.ClassVar[dict[str, CoefficientSets]]  # value = {'euler_forward': <CoefficientSets.euler_forward: 0>, 'rk_4': <CoefficientSets.rk_4: 1>, 'explicit_mid_point': <CoefficientSets.explicit_mid_point: 2>, 'explicit_trapezoid_rule': <CoefficientSets.explicit_trapezoid_rule: 3>, 'ralston': <CoefficientSets.ralston: 4>, 'rk_3': <CoefficientSets.rk_3: 5>, 'ralston_3': <CoefficientSets.ralston_3: 6>, 'SSPRK3': <CoefficientSets.SSPRK3: 7>, 'ralston_4': <CoefficientSets.ralston_4: 8>, 'three_eight_rule_rk_4': <CoefficientSets.three_eight_rule_rk_4: 9>, 'heun_euler': <CoefficientSets.heun_euler: 10>, 'rkf_12': <CoefficientSets.rkf_12: 11>, 'rkf_45': <CoefficientSets.rkf_45: 12>, 'rkf_56': <CoefficientSets.rkf_56: 13>, 'rkf_78': <CoefficientSets.rkf_78: 14>, 'rkdp_87': <CoefficientSets.rkdp_87: 15>, 'rkf_89': <CoefficientSets.rkf_89: 16>, 'rkv_89': <CoefficientSets.rkv_89: 17>, 'rkf_108': <CoefficientSets.rkf_108: 18>, 'rkf_1210': <CoefficientSets.rkf_1210: 19>, 'rkf_1412': <CoefficientSets.rkf_1412: 20>}
    euler_forward: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.euler_forward: 0>
    explicit_mid_point: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.explicit_mid_point: 2>
    explicit_trapezoid_rule: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.explicit_trapezoid_rule: 3>
    heun_euler: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.heun_euler: 10>
    ralston: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.ralston: 4>
    ralston_3: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.ralston_3: 6>
    ralston_4: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.ralston_4: 8>
    rk_3: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.rk_3: 5>
    rk_4: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.rk_4: 1>
    rkdp_87: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.rkdp_87: 15>
    rkf_108: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.rkf_108: 18>
    rkf_12: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.rkf_12: 11>
    rkf_1210: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.rkf_1210: 19>
    rkf_1412: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.rkf_1412: 20>
    rkf_45: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.rkf_45: 12>
    rkf_56: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.rkf_56: 13>
    rkf_78: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.rkf_78: 14>
    rkf_89: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.rkf_89: 16>
    rkv_89: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.rkv_89: 17>
    three_eight_rule_rk_4: typing.ClassVar[CoefficientSets]  # value = <CoefficientSets.three_eight_rule_rk_4: 9>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class ExtrapolationMethodStepSequences:
    ...
    """
    __members__: typing.ClassVar[dict[str, ExtrapolationMethodStepSequences]]  # value = {'bulirsch_stoer_sequence': <ExtrapolationMethodStepSequences.bulirsch_stoer_sequence: 0>, 'deufelhard_sequence': <ExtrapolationMethodStepSequences.deufelhard_sequence: 1>}
    bulirsch_stoer_sequence: typing.ClassVar[ExtrapolationMethodStepSequences]  # value = <ExtrapolationMethodStepSequences.bulirsch_stoer_sequence: 0>
    deufelhard_sequence: typing.ClassVar[ExtrapolationMethodStepSequences]  # value = <ExtrapolationMethodStepSequences.deufelhard_sequence: 1>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class IntegratorSettings:
    ...
    """
    initial_time: tudatpy.kernel.astro.time_representation.Time
class IntegratorStepSizeControlSettings:
    ...
    """
    @property
    def maximum_step_decrease(self) -> float:
        ...
    @maximum_step_decrease.setter
    def maximum_step_decrease(self, arg0: typing.SupportsFloat) -> None:
        ...
    @property
    def minimum_step_decrease(self) -> float:
        ...
    @minimum_step_decrease.setter
    def minimum_step_decrease(self, arg0: typing.SupportsFloat) -> None:
        ...
    @property
    def safety_factor(self) -> float:
        ...
    @safety_factor.setter
    def safety_factor(self, arg0: typing.SupportsFloat) -> None:
        ...
class IntegratorStepSizeValidationSettings:
    ...
    def maximum_step(self) -> float:
        ...
    @maximum_step.setter
    def maximum_step(self, arg0: typing.SupportsFloat) -> None:
        ...
    @property
    def minimum_step(self) -> float:
        ...
    @minimum_step.setter
    def minimum_step(self, arg0: typing.SupportsFloat) -> None:
        ...
class MinimumIntegrationTimeStepHandling:
    ...
    """
    __members__: typing.ClassVar[dict[str, MinimumIntegrationTimeStepHandling]]  # value = {'throw_exception_below_minimum': <MinimumIntegrationTimeStepHandling.throw_exception_below_minimum: 0>, 'set_to_minimum_step_silently': <MinimumIntegrationTimeStepHandling.set_to_minimum_step_silently: 1>, 'set_to_minimum_step_single_warning': <MinimumIntegrationTimeStepHandling.set_to_minimum_step_single_warning: 2>, 'set_to_minimum_step_every_time_warning': <MinimumIntegrationTimeStepHandling.set_to_minimum_step_every_time_warning: 3>}
    set_to_minimum_step_every_time_warning: typing.ClassVar[MinimumIntegrationTimeStepHandling]  # value = <MinimumIntegrationTimeStepHandling.set_to_minimum_step_every_time_warning: 3>
    set_to_minimum_step_silently: typing.ClassVar[MinimumIntegrationTimeStepHandling]  # value = <MinimumIntegrationTimeStepHandling.set_to_minimum_step_silently: 1>
    set_to_minimum_step_single_warning: typing.ClassVar[MinimumIntegrationTimeStepHandling]  # value = <MinimumIntegrationTimeStepHandling.set_to_minimum_step_single_warning: 2>
    throw_exception_below_minimum: typing.ClassVar[MinimumIntegrationTimeStepHandling]  # value = <MinimumIntegrationTimeStepHandling.throw_exception_below_minimum: 0>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class OrderToIntegrate:
    ...
    """
    __members__: typing.ClassVar[dict[str, OrderToIntegrate]]  # value = {'lower': <OrderToIntegrate.lower: 0>, 'higher': <OrderToIntegrate.higher: 1>}
    higher: typing.ClassVar[OrderToIntegrate]  # value = <OrderToIntegrate.higher: 1>
    lower: typing.ClassVar[OrderToIntegrate]  # value = <OrderToIntegrate.lower: 0>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class RungeKuttaVariableStepSizeSettingsVectorTolerances(RungeKuttaVariableStepSizeBaseSettings):
    ...
    """
@typing.overload
def adams_bashforth_moulton(initial_time_step: tudatpy.kernel.astro.time_representation.Time, minimum_step_size: tudatpy.kernel.astro.time_representation.Time, maximum_step_size: tudatpy.kernel.astro.time_representation.Time, relative_error_tolerance: typing.SupportsFloat = 1e-12, absolute_error_tolerance: typing.SupportsFloat = 1e-12, minimum_order: typing.SupportsInt = 6, maximum_order: typing.SupportsInt = 11, assess_termination_on_minor_steps: bool = False, bandwidth: tudatpy.kernel.astro.time_representation.Time = 200.0) -> IntegratorSettings:
    """
    ...
    """
@typing.overload
def adams_bashforth_moulton(initial_time: tudatpy.kernel.astro.time_representation.Time, initial_time_step: tudatpy.kernel.astro.time_representation.Time, minimum_step_size: tudatpy.kernel.astro.time_representation.Time, maximum_step_size: tudatpy.kernel.astro.time_representation.Time, relative_error_tolerance: typing.SupportsFloat = 1e-12, absolute_error_tolerance: typing.SupportsFloat = 1e-12, minimum_order: typing.SupportsInt = 6, maximum_order: typing.SupportsInt = 11, assess_termination_on_minor_steps: bool = False, bandwidth: tudatpy.kernel.astro.time_representation.Time = 200.0) -> IntegratorSettings:
    ...
def adams_bashforth_moulton_fixed_order(initial_time_step: tudatpy.kernel.astro.time_representation.Time, minimum_step_size: tudatpy.kernel.astro.time_representation.Time, maximum_step_size: tudatpy.kernel.astro.time_representation.Time, relative_error_tolerance: typing.SupportsFloat = 1e-12, absolute_error_tolerance: typing.SupportsFloat = 1e-12, order: typing.SupportsInt = 6, assess_termination_on_minor_steps: bool = False, bandwidth: tudatpy.kernel.astro.time_representation.Time = 200.0) -> IntegratorSettings:
    """
    ...
    IntegratorSettings
        Object containing settings for the integrator.
    """
def adams_bashforth_moulton_fixed_step(time_step: tudatpy.kernel.astro.time_representation.Time, relative_error_tolerance: typing.SupportsFloat = 1e-12, absolute_error_tolerance: typing.SupportsFloat = 1e-12, minimum_order: typing.SupportsInt = 6, maximum_order: typing.SupportsInt = 11, assess_termination_on_minor_steps: bool = False, bandwidth: tudatpy.kernel.astro.time_representation.Time = 200.0) -> IntegratorSettings:
    """
     ...
     IntegratorSettings
         Object containing settings for the integrator.
    """
def adams_bashforth_moulton_fixed_step_fixed_order(time_step: tudatpy.kernel.astro.time_representation.Time, order: typing.SupportsInt = 6, assess_termination_on_minor_steps: bool = False) -> IntegratorSettings:
    """
    ...
    """
@typing.overload
def bulirsch_stoer(initial_time: tudatpy.kernel.astro.time_representation.Time, initial_time_step: tudatpy.kernel.astro.time_representation.Time, extrapolation_sequence: ExtrapolationMethodStepSequences, maximum_number_of_steps: typing.SupportsInt, minimum_step_size: tudatpy.kernel.astro.time_representation.Time, maximum_step_size: tudatpy.kernel.astro.time_representation.Time, relative_error_tolerance: typing.SupportsFloat = 1e-12, absolute_error_tolerance: typing.SupportsFloat = 1e-12, assess_termination_on_minor_steps: bool = False, safety_factor: tudatpy.kernel.astro.time_representation.Time = 0.7, maximum_factor_increase: tudatpy.kernel.astro.time_representation.Time = 10.0, minimum_factor_increase: tudatpy.kernel.astro.time_representation.Time = 0.1) -> IntegratorSettings:
    ...
@typing.overload
def bulirsch_stoer(initial_time_step: tudatpy.kernel.astro.time_representation.Time, extrapolation_sequence: ExtrapolationMethodStepSequences, maximum_number_of_steps: typing.SupportsInt, minimum_step_size: tudatpy.kernel.astro.time_representation.Time, maximum_step_size: tudatpy.kernel.astro.time_representation.Time, relative_error_tolerance: typing.SupportsFloat = 1e-12, absolute_error_tolerance: typing.SupportsFloat = 1e-12, assess_termination_on_minor_steps: bool = False, safety_factor: tudatpy.kernel.astro.time_representation.Time = 0.7, maximum_factor_increase: tudatpy.kernel.astro.time_representation.Time = 10.0, minimum_factor_increase: tudatpy.kernel.astro.time_representation.Time = 0.1) -> IntegratorSettings:
    """
    ...
    """
def bulirsch_stoer_fixed_step(time_step: tudatpy.kernel.astro.time_representation.Time, extrapolation_sequence: ExtrapolationMethodStepSequences, maximum_number_of_steps: typing.SupportsInt, assess_termination_on_minor_steps: bool = False) -> IntegratorSettings:
    """
    ...
    """
def bulirsch_stoer_variable_step(initial_time_step: tudatpy.kernel.astro.time_representation.Time, extrapolation_sequence: ExtrapolationMethodStepSequences, maximum_number_of_steps: typing.SupportsInt, step_size_control_settings: IntegratorStepSizeControlSettings, step_size_validation_settings: IntegratorStepSizeValidationSettings, assess_termination_on_minor_steps: bool = False) -> IntegratorSettings:
    """
    ...
    """
@typing.overload
def euler(initial_time: tudatpy.kernel.astro.time_representation.Time, initial_time_step: tudatpy.kernel.astro.time_representation.Time, assess_termination_on_minor_steps: bool = False) -> IntegratorSettings:
    ...
@typing.overload
def euler(initial_time_step: tudatpy.kernel.astro.time_representation.Time, assess_termination_on_minor_steps: bool = False) -> IntegratorSettings:
    ...
def print_butcher_tableau(coefficient_set: CoefficientSets) -> None:
    ...
    """
@typing.overload
def runge_kutta_4(initial_time: tudatpy.kernel.astro.time_representation.Time, initial_time_step: tudatpy.kernel.astro.time_representation.Time, assess_termination_on_minor_steps: bool = False) -> IntegratorSettings:
    ...
@typing.overload
def runge_kutta_4(initial_time_step: tudatpy.kernel.astro.time_representation.Time, assess_termination_on_minor_steps: bool = False) -> IntegratorSettings:
    ...
def runge_kutta_fixed_step(time_step: tudatpy.kernel.astro.time_representation.Time, coefficient_set: CoefficientSets, order_to_use: OrderToIntegrate = ..., assess_termination_on_minor_steps: bool = False) -> IntegratorSettings:
    """
    ...
    """
@typing.overload
def runge_kutta_fixed_step_size(initial_time: tudatpy.kernel.astro.time_representation.Time, initial_time_step: tudatpy.kernel.astro.time_representation.Time, coefficient_set: CoefficientSets, order_to_use: OrderToIntegrate = ..., assess_termination_on_minor_steps: bool = False) -> IntegratorSettings:
    ...
@typing.overload
def runge_kutta_fixed_step_size(initial_time_step: tudatpy.kernel.astro.time_representation.Time, coefficient_set: CoefficientSets, order_to_use: OrderToIntegrate = ..., assess_termination_on_minor_steps: bool = False) -> IntegratorSettings:
    ...
def runge_kutta_variable_step(initial_time_step: tudatpy.kernel.astro.time_representation.Time, coefficient_set: CoefficientSets, step_size_control_settings: IntegratorStepSizeControlSettings, step_size_validation_settings: IntegratorStepSizeValidationSettings, assess_termination_on_minor_steps: bool = False) -> IntegratorSettings:
    """
    ...
    """
@typing.overload
def runge_kutta_variable_step_size(initial_time_step: tudatpy.kernel.astro.time_representation.Time, coefficient_set: CoefficientSets, minimum_step_size: tudatpy.kernel.astro.time_representation.Time, maximum_step_size: tudatpy.kernel.astro.time_representation.Time, relative_error_tolerance: typing.SupportsFloat, absolute_error_tolerance: typing.SupportsFloat, assess_termination_on_minor_steps: bool = False, safety_factor: tudatpy.kernel.astro.time_representation.Time = 0.8, maximum_factor_increase: tudatpy.kernel.astro.time_representation.Time = 4.0, minimum_factor_increase: tudatpy.kernel.astro.time_representation.Time = 0.1, throw_exception_if_minimum_step_exceeded: bool = True) -> IntegratorSettings:
    """
    ...
    """
@typing.overload
def runge_kutta_variable_step_size(initial_time: tudatpy.kernel.astro.time_representation.Time, initial_time_step: tudatpy.kernel.astro.time_representation.Time, coefficient_set: CoefficientSets, minimum_step_size: tudatpy.kernel.astro.time_representation.Time, maximum_step_size: tudatpy.kernel.astro.time_representation.Time, relative_error_tolerance: typing.SupportsFloat, absolute_error_tolerance: typing.SupportsFloat, assess_termination_on_minor_steps: bool = False, safety_factor: tudatpy.kernel.astro.time_representation.Time = 0.8, maximum_factor_increase: tudatpy.kernel.astro.time_representation.Time = 4.0, minimum_factor_increase: tudatpy.kernel.astro.time_representation.Time = 0.1, throw_exception_if_minimum_step_exceeded: bool = True) -> IntegratorSettings:
    ...
@typing.overload
def runge_kutta_variable_step_size_vector_tolerances(initial_time_step: tudatpy.kernel.astro.time_representation.Time, coefficient_set: CoefficientSets, minimum_step_size: tudatpy.kernel.astro.time_representation.Time, maximum_step_size: tudatpy.kernel.astro.time_representation.Time, relative_error_tolerance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], absolute_error_tolerance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], assess_termination_on_minor_steps: bool = False, safety_factor: tudatpy.kernel.astro.time_representation.Time = 0.8, maximum_factor_increase: tudatpy.kernel.astro.time_representation.Time = 4.0, minimum_factor_increase: tudatpy.kernel.astro.time_representation.Time = 0.1, throw_exception_if_minimum_step_exceeded: bool = True) -> IntegratorSettings:
    """
    ...
    """
@typing.overload
def runge_kutta_variable_step_size_vector_tolerances(initial_time: tudatpy.kernel.astro.time_representation.Time, initial_time_step: tudatpy.kernel.astro.time_representation.Time, coefficient_set: CoefficientSets, minimum_step_size: tudatpy.kernel.astro.time_representation.Time, maximum_step_size: tudatpy.kernel.astro.time_representation.Time, relative_error_tolerance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], absolute_error_tolerance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], assess_termination_on_minor_steps: bool = False, safety_factor: tudatpy.kernel.astro.time_representation.Time = 0.8, maximum_factor_increase: tudatpy.kernel.astro.time_representation.Time = 4.0, minimum_factor_increase: tudatpy.kernel.astro.time_representation.Time = 0.1, throw_exception_if_minimum_step_exceeded: bool = True) -> IntegratorSettings:
    ...
def standard_cartesian_state_element_blocks(number_of_rows: typing.SupportsInt, number_of_columns: typing.SupportsInt) -> list[tuple[int, int, int, int]]:
    """
    ...
    """
def standard_rotational_state_element_blocks(number_of_rows: typing.SupportsInt, number_of_columns: typing.SupportsInt) -> list[tuple[int, int, int, int]]:
    ...
def step_size_control_blockwise_matrix_tolerance(block_indices: collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt, typing.SupportsInt, typing.SupportsInt]], relative_error_tolerance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], absolute_error_tolerance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], safety_factor: typing.SupportsFloat = 0.8, minimum_factor_increase: typing.SupportsFloat = 0.1, maximum_factor_increase: typing.SupportsFloat = 4.0) -> IntegratorStepSizeControlSettings:
    """
     ...
     .. code-block:: python
         ...
         ...
    """
def step_size_control_blockwise_scalar_tolerance(block_indices: collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt, typing.SupportsInt, typing.SupportsInt]], relative_error_tolerance: typing.SupportsFloat, absolute_error_tolerance: typing.SupportsFloat, safety_factor: typing.SupportsFloat = 0.8, minimum_factor_increase: typing.SupportsFloat = 0.1, maximum_factor_increase: typing.SupportsFloat = 4.0) -> IntegratorStepSizeControlSettings:
    """
     Creates settings for integrator step-size control, using block-wise analysis for the propagated states.
     ...
     .. code-block:: python
         ...
         ...
    """
def step_size_control_custom_blockwise_matrix_tolerance(block_indices_function: collections.abc.Callable[[typing.SupportsInt, typing.SupportsInt], list[tuple[int, int, int, int]]], relative_error_tolerance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], absolute_error_tolerance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], safety_factor: typing.SupportsFloat = 0.8, minimum_factor_increase: typing.SupportsFloat = 0.1, maximum_factor_increase: typing.SupportsFloat = 4.0) -> IntegratorStepSizeControlSettings:
    """
     Creates settings for integrator step-size control, using block-wise analysis for the propagated states.
     ...
     IntegratorStepSizeControlSettings
         Object containing settings for per-element step-size control.
    """
def step_size_control_custom_blockwise_scalar_tolerance(block_indices_function: collections.abc.Callable[[typing.SupportsInt, typing.SupportsInt], list[tuple[int, int, int, int]]], relative_error_tolerance: typing.SupportsFloat, absolute_error_tolerance: typing.SupportsFloat, safety_factor: typing.SupportsFloat = 0.8, minimum_factor_increase: typing.SupportsFloat = 0.1, maximum_factor_increase: typing.SupportsFloat = 4.0) -> IntegratorStepSizeControlSettings:
    """
     Creates settings for integrator step-size control, using block-wise analysis for the propagated states.
...
def step_size_control_elementwise_matrix_tolerance(relative_error_tolerance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], absolute_error_tolerance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], safety_factor: typing.SupportsFloat = 0.8, minimum_factor_increase: typing.SupportsFloat = 0.1, maximum_factor_increase: typing.SupportsFloat = 4.0) -> IntegratorStepSizeControlSettings:
    """
     ...
     IntegratorStepSizeControlSettings
         Object containing settings for per-element step-size control.
    """
def step_size_control_elementwise_scalar_tolerance(relative_error_tolerance: typing.SupportsFloat, absolute_error_tolerance: typing.SupportsFloat, safety_factor: typing.SupportsFloat = 0.8, minimum_factor_increase: typing.SupportsFloat = 0.1, maximum_factor_increase: typing.SupportsFloat = 4.0) -> IntegratorStepSizeControlSettings:
    """
     Creates settings for integrator step-size control, using element-wise analysis for the propagated states.
     ...
     IntegratorStepSizeControlSettings
         Object containing settings for per-element step-size control.
    """
def step_size_validation(minimum_step: typing.SupportsFloat, maximum_step: typing.SupportsFloat, minimum_step_size_handling: MinimumIntegrationTimeStepHandling = ..., accept_infinity_step: bool = False, accept_nan_step: bool = False) -> IntegratorStepSizeValidationSettings:
    """
    ...
    """
SSPRK3: CoefficientSets  # value = <CoefficientSets.SSPRK3: 7>
adams_bashforth_moulton_type: AvailableIntegrators  # value = <AvailableIntegrators.adams_bashforth_moulton_type: 5>
bulirsch_stoer_sequence: ExtrapolationMethodStepSequences  # value = <ExtrapolationMethodStepSequences.bulirsch_stoer_sequence: 0>
bulirsch_stoer_type: AvailableIntegrators  # value = <AvailableIntegrators.bulirsch_stoer_type: 4>
deufelhard_sequence: ExtrapolationMethodStepSequences  # value = <ExtrapolationMethodStepSequences.deufelhard_sequence: 1>
euler_forward: CoefficientSets  # value = <CoefficientSets.euler_forward: 0>
explicit_mid_point: CoefficientSets  # value = <CoefficientSets.explicit_mid_point: 2>
explicit_trapezoid_rule: CoefficientSets  # value = <CoefficientSets.explicit_trapezoid_rule: 3>
heun_euler: CoefficientSets  # value = <CoefficientSets.heun_euler: 10>
higher: OrderToIntegrate  # value = <OrderToIntegrate.higher: 1>
lower: OrderToIntegrate  # value = <OrderToIntegrate.lower: 0>
ralston: CoefficientSets  # value = <CoefficientSets.ralston: 4>
ralston_3: CoefficientSets  # value = <CoefficientSets.ralston_3: 6>
ralston_4: CoefficientSets  # value = <CoefficientSets.ralston_4: 8>
rk_3: CoefficientSets  # value = <CoefficientSets.rk_3: 5>
rk_4: CoefficientSets  # value = <CoefficientSets.rk_4: 1>
rkdp_87: CoefficientSets  # value = <CoefficientSets.rkdp_87: 15>
rkf_108: CoefficientSets  # value = <CoefficientSets.rkf_108: 18>
rkf_12: CoefficientSets  # value = <CoefficientSets.rkf_12: 11>
rkf_1210: CoefficientSets  # value = <CoefficientSets.rkf_1210: 19>
rkf_1412: CoefficientSets  # value = <CoefficientSets.rkf_1412: 20>
rkf_45: CoefficientSets  # value = <CoefficientSets.rkf_45: 12>
rkf_56: CoefficientSets  # value = <CoefficientSets.rkf_56: 13>
rkf_78: CoefficientSets  # value = <CoefficientSets.rkf_78: 14>
rkf_89: CoefficientSets  # value = <CoefficientSets.rkf_89: 16>
rkv_89: CoefficientSets  # value = <CoefficientSets.rkv_89: 17>
runge_kutta_fixed_step_size_type: AvailableIntegrators  # value = <AvailableIntegrators.runge_kutta_fixed_step_size_type: 2>
runge_kutta_variable_step_size_type: AvailableIntegrators  # value = <AvailableIntegrators.runge_kutta_variable_step_size_type: 3>
set_to_minimum_step_every_time_warning: MinimumIntegrationTimeStepHandling  # value = <MinimumIntegrationTimeStepHandling.set_to_minimum_step_every_time_warning: 3>
set_to_minimum_step_silently: MinimumIntegrationTimeStepHandling  # value = <MinimumIntegrationTimeStepHandling.set_to_minimum_step_silently: 1>
set_to_minimum_step_single_warning: MinimumIntegrationTimeStepHandling  # value = <MinimumIntegrationTimeStepHandling.set_to_minimum_step_single_warning: 2>
three_eight_rule_rk_4: CoefficientSets  # value = <CoefficientSets.three_eight_rule_rk_4: 9>
throw_exception_below_minimum: MinimumIntegrationTimeStepHandling  # value = <MinimumIntegrationTimeStepHandling.throw_exception_below_minimum: 0>
