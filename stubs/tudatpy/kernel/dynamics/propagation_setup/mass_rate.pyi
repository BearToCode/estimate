...
class AvailableMassRateModels:
    ...
    """
    __members__: typing.ClassVar[dict[str, AvailableMassRateModels]]  # value = {'undefined_mass_rate_type': <AvailableMassRateModels.undefined_mass_rate_type: 0>, 'custom_mass_rate_type': <AvailableMassRateModels.custom_mass_rate_type: 1>, 'from_thrust_mass_rate_type': <AvailableMassRateModels.from_thrust_mass_rate_type: 2>}
    custom_mass_rate_type: typing.ClassVar[AvailableMassRateModels]  # value = <AvailableMassRateModels.custom_mass_rate_type: 1>
    from_thrust_mass_rate_type: typing.ClassVar[AvailableMassRateModels]  # value = <AvailableMassRateModels.from_thrust_mass_rate_type: 2>
    undefined_mass_rate_type: typing.ClassVar[AvailableMassRateModels]  # value = <AvailableMassRateModels.undefined_mass_rate_type: 0>
...
class MassRateModelSettings:
    ...
    """
def custom(mass_rate_function: collections.abc.Callable[[typing.SupportsFloat], float]) -> MassRateModelSettings:
    ...
def custom_mass_rate(mass_rate_function: collections.abc.Callable[[typing.SupportsFloat], float]) -> MassRateModelSettings:
    """
...
def from_thrust(use_all_thrust_models: bool = 1, associated_thrust_source: str = '') -> MassRateModelSettings:
    ...
    """
custom_mass_rate_type: AvailableMassRateModels  # value = <AvailableMassRateModels.custom_mass_rate_type: 1>
from_thrust_mass_rate_type: AvailableMassRateModels  # value = <AvailableMassRateModels.from_thrust_mass_rate_type: 2>
undefined_mass_rate_type: AvailableMassRateModels  # value = <AvailableMassRateModels.undefined_mass_rate_type: 0>
