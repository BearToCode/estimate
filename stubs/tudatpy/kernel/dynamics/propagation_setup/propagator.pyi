...
class MultiArcPropagatorSettings(PropagatorSettings):
    ...
    """
    @property
    def initial_state_list(self) -> list[typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]:
        """
                    **read-only**
    ...
    def processing_settings(self) -> MultiArcPropagatorProcessingSettings:
        ...
        """
    @property
    def single_arc_settings(self) -> list[typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]:
        """
                    **read-only**
...
class MultiTypePropagatorSettings(SingleArcPropagatorSettings):
    ...
    """
    def recreate_state_derivative_models(self, bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies) -> None:
        ...
    def reset_initial_states(self, initial_states: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]) -> None:
        ...
...
class PropagationPrintSettings:
    ...
    def enable_all_boolean_printing(self) -> None:
        ...
        """
    def enable_all_printing(self, results_print_frequency_in_seconds: typing.SupportsFloat, results_print_frequency_in_steps: typing.SupportsInt) -> None:
        """
    ...
    def results_print_frequency_in_seconds(self, arg1: typing.SupportsFloat) -> None:
        ...
    @property
    ...
    def results_print_frequency_in_steps(self, arg1: typing.SupportsFloat) -> None:
        ...
...
class PropagationTerminationTypes:
    ...
    """
    __members__: typing.ClassVar[dict[str, PropagationTerminationTypes]]  # value = {'time_stopping_condition_type': <PropagationTerminationTypes.time_stopping_condition_type: 0>, 'cpu_time_stopping_condition_type': <PropagationTerminationTypes.cpu_time_stopping_condition_type: 1>, 'dependent_variable_stopping_condition_type': <PropagationTerminationTypes.dependent_variable_stopping_condition_type: 2>, 'hybrid_stopping_condition_type': <PropagationTerminationTypes.hybrid_stopping_condition_type: 3>, 'custom_stopping_condition_type': <PropagationTerminationTypes.custom_stopping_condition_type: 4>}
    cpu_time_stopping_condition_type: typing.ClassVar[PropagationTerminationTypes]  # value = <PropagationTerminationTypes.cpu_time_stopping_condition_type: 1>
    custom_stopping_condition_type: typing.ClassVar[PropagationTerminationTypes]  # value = <PropagationTerminationTypes.custom_stopping_condition_type: 4>
    dependent_variable_stopping_condition_type: typing.ClassVar[PropagationTerminationTypes]  # value = <PropagationTerminationTypes.dependent_variable_stopping_condition_type: 2>
    hybrid_stopping_condition_type: typing.ClassVar[PropagationTerminationTypes]  # value = <PropagationTerminationTypes.hybrid_stopping_condition_type: 3>
    time_stopping_condition_type: typing.ClassVar[PropagationTerminationTypes]  # value = <PropagationTerminationTypes.time_stopping_condition_type: 0>
...
class PropagatorSettings:
    ...
    """
    @property
    def initial_states(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
        """
    ...
    def initial_states(self, arg1: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]) -> None:
        ...
class RotationalPropagatorType:
    ...
    """
    __members__: typing.ClassVar[dict[str, RotationalPropagatorType]]  # value = {'undefined_rotational_propagator': <RotationalPropagatorType.undefined_rotational_propagator: -1>, 'quaternions': <RotationalPropagatorType.quaternions: 0>, 'modified_rodrigues_parameters': <RotationalPropagatorType.modified_rodrigues_parameters: 1>, 'exponential_map': <RotationalPropagatorType.exponential_map: 2>}
    exponential_map: typing.ClassVar[RotationalPropagatorType]  # value = <RotationalPropagatorType.exponential_map: 2>
    modified_rodrigues_parameters: typing.ClassVar[RotationalPropagatorType]  # value = <RotationalPropagatorType.modified_rodrigues_parameters: 1>
    quaternions: typing.ClassVar[RotationalPropagatorType]  # value = <RotationalPropagatorType.quaternions: 0>
    undefined_rotational_propagator: typing.ClassVar[RotationalPropagatorType]  # value = <RotationalPropagatorType.undefined_rotational_propagator: -1>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class SingleArcPropagatorProcessingSettings(PropagatorProcessingSettings):
    ...
    def results_save_frequency_in_seconds(self, arg1: typing.SupportsFloat) -> None:
        ...
    @property
    ...
    def results_save_frequency_in_steps(self, arg1: typing.SupportsInt) -> None:
        ...
class SingleArcPropagatorSettings(PropagatorSettings):
    ...
    """
    @property
    def integrator_settings(self) -> tudatpy.kernel.dynamics.propagation_setup.integrator.IntegratorSettings:
        """
    ...
    def integrator_settings(self, arg1: tudatpy.kernel.dynamics.propagation_setup.integrator.IntegratorSettings) -> None:
        ...
    @property
    def print_settings(self) -> PropagationPrintSettings:
        """
...
class StateType:
    ...
    """
    __members__: typing.ClassVar[dict[str, StateType]]  # value = {'hybrid_type': <StateType.hybrid_type: 0>, 'translational_type': <StateType.translational_type: 1>, 'rotational_type': <StateType.rotational_type: 2>, 'mass_type': <StateType.mass_type: 3>, 'custom_type': <StateType.custom_type: 4>}
    custom_type: typing.ClassVar[StateType]  # value = <StateType.custom_type: 4>
    hybrid_type: typing.ClassVar[StateType]  # value = <StateType.hybrid_type: 0>
    mass_type: typing.ClassVar[StateType]  # value = <StateType.mass_type: 3>
    rotational_type: typing.ClassVar[StateType]  # value = <StateType.rotational_type: 2>
    translational_type: typing.ClassVar[StateType]  # value = <StateType.translational_type: 1>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class TranslationalPropagatorType:
    ...
    """
    __members__: typing.ClassVar[dict[str, TranslationalPropagatorType]]  # value = {'undefined_translational_propagator': <TranslationalPropagatorType.undefined_translational_propagator: -1>, 'cowell': <TranslationalPropagatorType.cowell: 0>, 'encke': <TranslationalPropagatorType.encke: 1>, 'gauss_keplerian': <TranslationalPropagatorType.gauss_keplerian: 2>, 'gauss_modified_equinoctial': <TranslationalPropagatorType.gauss_modified_equinoctial: 3>, 'unified_state_model_quaternions': <TranslationalPropagatorType.unified_state_model_quaternions: 4>, 'unified_state_model_modified_rodrigues_parameters': <TranslationalPropagatorType.unified_state_model_modified_rodrigues_parameters: 5>, 'unified_state_model_exponential_map': <TranslationalPropagatorType.unified_state_model_exponential_map: 6>}
    cowell: typing.ClassVar[TranslationalPropagatorType]  # value = <TranslationalPropagatorType.cowell: 0>
    encke: typing.ClassVar[TranslationalPropagatorType]  # value = <TranslationalPropagatorType.encke: 1>
    gauss_keplerian: typing.ClassVar[TranslationalPropagatorType]  # value = <TranslationalPropagatorType.gauss_keplerian: 2>
    gauss_modified_equinoctial: typing.ClassVar[TranslationalPropagatorType]  # value = <TranslationalPropagatorType.gauss_modified_equinoctial: 3>
    undefined_translational_propagator: typing.ClassVar[TranslationalPropagatorType]  # value = <TranslationalPropagatorType.undefined_translational_propagator: -1>
    unified_state_model_exponential_map: typing.ClassVar[TranslationalPropagatorType]  # value = <TranslationalPropagatorType.unified_state_model_exponential_map: 6>
    unified_state_model_modified_rodrigues_parameters: typing.ClassVar[TranslationalPropagatorType]  # value = <TranslationalPropagatorType.unified_state_model_modified_rodrigues_parameters: 5>
    unified_state_model_quaternions: typing.ClassVar[TranslationalPropagatorType]  # value = <TranslationalPropagatorType.unified_state_model_quaternions: 4>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class TranslationalStatePropagatorSettings(SingleArcPropagatorSettings):
    ...
    def get_propagated_state_size(self) -> int:
        ...
    def reset_and_recreate_acceleration_models(self, new_acceleration_settings: collections.abc.Mapping[str, collections.abc.Mapping[str, collections.abc.Sequence[tudatpy.kernel.dynamics.propagation_setup.acceleration.AccelerationSettings]]], bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies) -> None:
        ...
def add_dependent_variable_settings(*args, **kwargs) -> None:
    """
     ...
     None
         None
    """
def cpu_time_termination(cpu_termination_time: typing.SupportsFloat) -> PropagationTerminationSettings:
    """
    ...
    """
def custom_state(state_derivative_function: collections.abc.Callable[[tudatpy.kernel.astro.time_representation.Time, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]], initial_state: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], initial_time: tudatpy.kernel.astro.time_representation.Time, integrator_settings: tudatpy.kernel.dynamics.propagation_setup.integrator.IntegratorSettings, termination_settings: PropagationTerminationSettings, output_variables: collections.abc.Sequence[tudatpy.kernel.dynamics.propagation_setup.dependent_variable.SingleDependentVariableSaveSettings] = [], processing_settings: SingleArcPropagatorProcessingSettings = None) -> CustomStatePropagatorSettings:
    """
    ...
    """
def custom_termination(custom_condition: collections.abc.Callable[[typing.SupportsFloat], bool]) -> PropagationTerminationSettings:
    """
    ...
    """
def custom_termination_with_state_input(custom_condition: collections.abc.Callable[[typing.SupportsFloat, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]], bool]) -> PropagationTerminationSettings:
    """
    No propagator documentation found.
    """
def dependent_variable_termination(dependent_variable_settings: tudatpy.kernel.dynamics.propagation_setup.dependent_variable.SingleDependentVariableSaveSettings, limit_value: typing.SupportsFloat, use_as_lower_limit: bool, terminate_exactly_on_final_condition: bool = False, termination_root_finder_settings: tudatpy.kernel.math.root_finders.RootFinderSettings = None) -> PropagationTerminationSettings:
    """
...
def hybrid_arc(single_arc_settings: SingleArcPropagatorSettings, multi_arc_settings: MultiArcPropagatorSettings, processing_settings: HybridArcPropagatorProcessingSettings = None) -> HybridArcPropagatorSettings:
    ...
    """
def hybrid_termination(termination_settings: collections.abc.Sequence[PropagationTerminationSettings], fulfill_single_condition: bool) -> PropagationTerminationSettings:
    """
    ...
    """
@typing.overload
def mass(bodies_with_mass_to_propagate: collections.abc.Sequence[str], mass_rate_models: collections.abc.Mapping[str, collections.abc.Sequence[...]], initial_body_masses: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], termination_settings: PropagationTerminationSettings, output_variables: collections.abc.Sequence[tudatpy.kernel.dynamics.propagation_setup.dependent_variable.SingleDependentVariableSaveSettings] = [], print_interval: typing.SupportsFloat = ...) -> MassPropagatorSettings:
    ...
@typing.overload
def mass(bodies_with_mass_to_propagate: collections.abc.Sequence[str], mass_rate_models: collections.abc.Mapping[str, collections.abc.Sequence[...]], initial_body_masses: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], initial_time: tudatpy.kernel.astro.time_representation.Time, integrator_settings: tudatpy.kernel.dynamics.propagation_setup.integrator.IntegratorSettings, termination_settings: PropagationTerminationSettings, output_variables: collections.abc.Sequence[tudatpy.kernel.dynamics.propagation_setup.dependent_variable.SingleDependentVariableSaveSettings] = [], processing_settings: SingleArcPropagatorProcessingSettings = None) -> MassPropagatorSettings:
    ...
    """
def multi_arc(single_arc_settings: collections.abc.Sequence[SingleArcPropagatorSettings], transfer_state_to_next_arc: bool = False, processing_settings: MultiArcPropagatorProcessingSettings = None) -> MultiArcPropagatorSettings:
    """
...
def multi_arc_processing_settings() -> MultiArcPropagatorProcessingSettings:
    ...
@typing.overload
def multitype(propagator_settings_list: collections.abc.Sequence[SingleArcPropagatorSettings], termination_settings: PropagationTerminationSettings, output_variables: collections.abc.Sequence[tudatpy.kernel.dynamics.propagation_setup.dependent_variable.SingleDependentVariableSaveSettings] = [], print_interval: typing.SupportsFloat = ...) -> MultiTypePropagatorSettings:
    ...
@typing.overload
def multitype(propagator_settings_list: collections.abc.Sequence[SingleArcPropagatorSettings], integrator_settings: tudatpy.kernel.dynamics.propagation_setup.integrator.IntegratorSettings, initial_time: tudatpy.kernel.astro.time_representation.Time, termination_settings: PropagationTerminationSettings, output_variables: collections.abc.Sequence[tudatpy.kernel.dynamics.propagation_setup.dependent_variable.SingleDependentVariableSaveSettings] = [], processing_settings: SingleArcPropagatorProcessingSettings = None) -> MultiTypePropagatorSettings:
    """
...
def non_sequential_termination(forward_termination_settings: PropagationTerminationSettings, backward_termination_settings: PropagationTerminationSettings) -> PropagationTerminationSettings:
    ...
    """
@typing.overload
def rotational(torque_models: collections.abc.Mapping[str, collections.abc.Mapping[str, collections.abc.Sequence[...]]], bodies_to_integrate: collections.abc.Sequence[str], initial_states: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], termination_settings: PropagationTerminationSettings, propagator: RotationalPropagatorType = ..., output_variables: collections.abc.Sequence[tudatpy.kernel.dynamics.propagation_setup.dependent_variable.SingleDependentVariableSaveSettings] = [], print_interval: typing.SupportsFloat = ...) -> RotationalStatePropagatorSettings:
    ...
@typing.overload
def rotational(torque_models: collections.abc.Mapping[str, collections.abc.Mapping[str, collections.abc.Sequence[...]]], bodies_to_integrate: collections.abc.Sequence[str], initial_states: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], initial_time: tudatpy.kernel.astro.time_representation.Time, integrator_settings: tudatpy.kernel.dynamics.propagation_setup.integrator.IntegratorSettings, termination_settings: PropagationTerminationSettings, propagator: RotationalPropagatorType = ..., output_variables: collections.abc.Sequence[tudatpy.kernel.dynamics.propagation_setup.dependent_variable.SingleDependentVariableSaveSettings] = [], processing_settings: SingleArcPropagatorProcessingSettings = None) -> RotationalStatePropagatorSettings:
    ...
    """
def time_termination(termination_time: typing.SupportsFloat, terminate_exactly_on_final_condition: bool = False) -> PropagationTerminationSettings:
    """
    ...
    """
@typing.overload
def translational(central_bodies: collections.abc.Sequence[str], acceleration_models: collections.abc.Mapping[str, collections.abc.Mapping[str, collections.abc.Sequence[..., 3, 1, 0, 3, ...]]], bodies_to_integrate: collections.abc.Sequence[str], initial_states: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], termination_settings: PropagationTerminationSettings, propagator: TranslationalPropagatorType = ..., output_variables: collections.abc.Sequence[tudatpy.kernel.dynamics.propagation_setup.dependent_variable.SingleDependentVariableSaveSettings] = [], print_interval: typing.SupportsFloat = ...) -> TranslationalStatePropagatorSettings:
    ...
@typing.overload
def translational(central_bodies: collections.abc.Sequence[str], acceleration_models: collections.abc.Mapping[str, collections.abc.Mapping[str, collections.abc.Sequence[..., 3, 1, 0, 3, ...]]], bodies_to_integrate: collections.abc.Sequence[str], initial_states: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], initial_time: tudatpy.kernel.astro.time_representation.Time, integrator_settings: tudatpy.kernel.dynamics.propagation_setup.integrator.IntegratorSettings, termination_settings: PropagationTerminationSettings, propagator: TranslationalPropagatorType = ..., output_variables: collections.abc.Sequence[tudatpy.kernel.dynamics.propagation_setup.dependent_variable.SingleDependentVariableSaveSettings] = [], processing_settings: SingleArcPropagatorProcessingSettings = None) -> TranslationalStatePropagatorSettings:
    ...
    """
cowell: TranslationalPropagatorType  # value = <TranslationalPropagatorType.cowell: 0>
cpu_time_stopping_condition_type: PropagationTerminationTypes  # value = <PropagationTerminationTypes.cpu_time_stopping_condition_type: 1>
custom_stopping_condition_type: PropagationTerminationTypes  # value = <PropagationTerminationTypes.custom_stopping_condition_type: 4>
custom_type: StateType  # value = <StateType.custom_type: 4>
dependent_variable_stopping_condition_type: PropagationTerminationTypes  # value = <PropagationTerminationTypes.dependent_variable_stopping_condition_type: 2>
encke: TranslationalPropagatorType  # value = <TranslationalPropagatorType.encke: 1>
exponential_map: RotationalPropagatorType  # value = <RotationalPropagatorType.exponential_map: 2>
gauss_keplerian: TranslationalPropagatorType  # value = <TranslationalPropagatorType.gauss_keplerian: 2>
gauss_modified_equinoctial: TranslationalPropagatorType  # value = <TranslationalPropagatorType.gauss_modified_equinoctial: 3>
hybrid_stopping_condition_type: PropagationTerminationTypes  # value = <PropagationTerminationTypes.hybrid_stopping_condition_type: 3>
hybrid_type: StateType  # value = <StateType.hybrid_type: 0>
mass_type: StateType  # value = <StateType.mass_type: 3>
modified_rodrigues_parameters: RotationalPropagatorType  # value = <RotationalPropagatorType.modified_rodrigues_parameters: 1>
quaternions: RotationalPropagatorType  # value = <RotationalPropagatorType.quaternions: 0>
rotational_type: StateType  # value = <StateType.rotational_type: 2>
time_stopping_condition_type: PropagationTerminationTypes  # value = <PropagationTerminationTypes.time_stopping_condition_type: 0>
translational_type: StateType  # value = <StateType.translational_type: 1>
undefined_rotational_propagator: RotationalPropagatorType  # value = <RotationalPropagatorType.undefined_rotational_propagator: -1>
undefined_translational_propagator: TranslationalPropagatorType  # value = <TranslationalPropagatorType.undefined_translational_propagator: -1>
unified_state_model_exponential_map: TranslationalPropagatorType  # value = <TranslationalPropagatorType.unified_state_model_exponential_map: 6>
unified_state_model_modified_rodrigues_parameters: TranslationalPropagatorType  # value = <TranslationalPropagatorType.unified_state_model_modified_rodrigues_parameters: 5>
unified_state_model_quaternions: TranslationalPropagatorType  # value = <TranslationalPropagatorType.unified_state_model_quaternions: 4>
