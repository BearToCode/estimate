...
class CombinedStateTransitionAndSensitivityMatrixInterface:
    ...
    """
    def full_state_transition_sensitivity_at_epoch(self, time: typing.SupportsFloat, add_central_body_dependency: bool = True, arc_defining_bodies: collections.abc.Sequence[str] = []) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                 Parameters
                 ----------
        ...
        """
    def state_transition_sensitivity_at_epoch(self, time: typing.SupportsFloat, add_central_body_dependency: bool = True, arc_defining_bodies: collections.abc.Sequence[str] = []) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
...
class HybridArcSimulator(DynamicsSimulator):
    ...
    """
    def integrate_equations_of_motion(self, initial_state: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]) -> None:
        """
    ...
    def multi_arc_simulator(self) -> MultiArcSimulator:
        ...
        """
    @property
    def propagation_results(self) -> tudatpy.kernel.dynamics.propagation.HybridArcSimulationResults:
        """
                 **read-only**
...
class MultiArcSimulator(DynamicsSimulator):
    ...
    def integrate_equations_of_motion(self, initial_state: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]) -> None:
        ...
        """
    @property
    def propagation_results(self) -> tudatpy.kernel.dynamics.propagation.MultiArcSimulationResults:
        """
                 **read-only**
...
class SingleArcSimulator(DynamicsSimulator):
    ...
    def integrate_equations_of_motion(self, initial_state: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]) -> None:
        ...
        """
    @property
    def bodies(self) -> tudatpy.kernel.dynamics.environment.SystemOfBodies:
        """
                 **read-only**
    ...
    def integration_completed_successfully(self) -> bool:
        ...
        """
    @property
    def propagation_results(self) -> tudatpy.kernel.dynamics.propagation.SimulationResults:
        """
                 **read-only**
        ...
        """
    @property
    def propagation_termination_details(self) -> tudatpy.kernel.dynamics.propagation.PropagationTerminationDetails:
        """
                 **read-only**
        ...
        """
    @property
    def propagator_settings(self) -> tudatpy.kernel.dynamics.propagation_setup.propagator.SingleArcPropagatorSettings:
        """
                 **read-only**
        ...
        """
    @property
    def state_derivative_function(self) -> collections.abc.Callable[[tudatpy.kernel.astro.time_representation.Time, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]]:
        """
                 **read-only**
    ...
    def unprocessed_state_history_time_object(self) -> dict[tudatpy.kernel.astro.time_representation.Time, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]:
        """
                 **read-only**
                 ...
                 :type: dict[astro.time_representation.Time, numpy.ndarray]
        """
class SingleArcVariationalSimulator(VariationalSimulator):
    """
    ...
    def __init__(self, bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, integrator_settings: tudatpy.kernel.dynamics.propagation_setup.integrator.IntegratorSettings, propagator_settings: tudatpy.kernel.dynamics.propagation_setup.propagator.PropagatorSettings, estimated_parameters: ..., integrate_equations_concurrently: bool = True, variational_only_integrator_settings: ... = None, clear_numerical_solutions: bool = False, integrate_on_creation: bool = True, set_integrated_result: bool = False, print_dependent_variable_data: bool = True) -> None:
        """
                 ...
                 set_integrated_result : bool, default = True
                     ...
                     propagated bodies.
        """
    def integrate_equations_of_motion_only(self, initial_states: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]) -> None:
        """
        ...
        """
    def integrate_full_equations(self, initial_states: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], integrate_equations_concurrently: bool = True) -> None:
        """
    ...
    def parameter_vector(self, arg1: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], arg2: bool) -> None:
        ...
    @property
    ...
    def state_transition_matrix_history(self) -> dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]]:
        ...
        """
    @property
    def variational_equations_history(self) -> list[dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]]]:
        """
                 **read-only**
...
class VariationalSimulator:
    ...
    def state_transition_interface(self) -> ...:
        ...
        """
def create_dynamics_simulator(bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, propagator_settings: tudatpy.kernel.dynamics.propagation_setup.propagator.PropagatorSettings, simulate_dynamics_on_creation: bool = True) -> DynamicsSimulator:
    """
    ...
    """
def create_variational_equations_solver(bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, propagator_settings: tudatpy.kernel.dynamics.propagation_setup.propagator.PropagatorSettings, parameters_to_estimate: ..., simulate_dynamics_on_creation: bool = True) -> VariationalSimulator:
    """
