...
import tudatpy.kernel.dynamics.parameters
...
import tudatpy.kernel.dynamics.simulator
...
import typing
__all__: list[str] = ['CovarianceAnalysisInput', 'CovarianceAnalysisOutput', 'EstimationConvergenceChecker', 'EstimationInput', 'EstimationOutput', 'Estimator', 'PodInput', 'PodOutput', 'create_best_fit_to_ephemeris', 'estimation_convergence_checker', 'propagate_covariance', 'propagate_covariance_rsw_split_output', 'propagate_covariance_split_output', 'propagate_formal_errors', 'propagate_formal_errors_rsw_split_output', 'propagate_formal_errors_split_output']
class CovarianceAnalysisInput:
    ...
    """
    def __init__(self, observations_and_times: tudatpy.kernel.estimation.observations.ObservationCollection, inverse_apriori_covariance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"] = ..., consider_covariance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"] = ...) -> None:
        """
                 Class constructor.
        ...
        """
    def define_covariance_settings(self, reintegrate_equations_on_first_iteration: bool = True, reintegrate_variational_equations: bool = True, save_design_matrix: bool = True, print_output_to_terminal: bool = True, limit_condition_number_for_warning: typing.SupportsFloat = 100000000.0) -> None:
        """
        ...
        """
    def set_constant_single_observable_and_link_end_vector_weight(self, observable_type: tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType, link_ends: collections.abc.Mapping[tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType, tudatpy.kernel.estimation.observable_models_setup.links.LinkEndId], weight: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]) -> None:
        """
        No documentation found.
        """
    def set_constant_single_observable_and_link_end_weight(self, observable_type: tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType, link_ends: collections.abc.Mapping[tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType, tudatpy.kernel.estimation.observable_models_setup.links.LinkEndId], weight: typing.SupportsFloat) -> None:
        """
        No documentation found.
        """
    def set_constant_single_observable_vector_weight(self, observable_type: tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType, weight: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]) -> None:
        """
        No documentation found.
        """
    def set_constant_single_observable_weight(self, observable_type: tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType, weight: typing.SupportsFloat) -> None:
        """
        No documentation found.
        """
    def set_constant_vector_weight_per_observable(self, weight_per_observable: collections.abc.Mapping[tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]]) -> None:
        """
        No documentation found.
        """
    def set_constant_weight(self, weight: typing.SupportsFloat) -> None:
        """
                 ...
                 None
                     Function modifies the object in-place.
        """
    def set_constant_weight_per_observable(self, weight_per_observable: collections.abc.Mapping[tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType, typing.SupportsFloat]) -> None:
        """
                 ...
                 None
                     Function modifies the object in-place.
        """
    def set_total_single_observable_and_link_end_vector_weight(self, observable_type: tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType, link_ends: collections.abc.Mapping[tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType, tudatpy.kernel.estimation.observable_models_setup.links.LinkEndId], weight_vector: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]) -> None:
        """
        No documentation found.
        """
    def set_weights_from_observation_collection(self) -> None:
        ...
        """
    @property
    def weight_matrix_diagonal(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
        """
                 **read-only**
    ...
    def weight_matrix_diagonal(self, arg1: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]) -> None:
        ...
class CovarianceAnalysisOutput:
    ...
    """
    @property
    def consider_covariance_contribution(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                 **read-only**
        ...
        """
    @property
    def consider_normalization_factors(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
        """
                 **read-only**
        ...
        """
    @property
    def correlations(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                 **read-only**
    ...
    def covariance(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        ...
        """
    @property
    def design_matrix(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                 **read-only**
        ...
        """
    @property
    def formal_errors(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
        """
                 **read-only**
        ...
        """
    @property
    def inverse_covariance(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                 **read-only**
        ...
        """
    @property
    def inverse_normalized_covariance(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                 **read-only**
        ...
        """
    @property
    def normalization_terms(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
        """
                 **read-only**
        ...
        """
    @property
    def normalized_covariance(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                 **read-only**
        ...
        """
    @property
    def normalized_covariance_with_consider_parameters(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                 **read-only**
        ...
        """
    @property
    def normalized_design_matrix(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                 **read-only**
        ...
        """
    @property
    def normalized_design_matrix_consider_parameters(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                 **read-only**
        ...
        """
    @property
    def unnormalized_covariance_with_consider_parameters(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                 **read-only**
        ...
        """
    @property
    def unnormalized_design_matrix_consider_parameters(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                 **read-only**
        ...
        """
    @property
    def weighted_design_matrix(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                 **read-only**
        ...
        """
    @property
    def weighted_normalized_design_matrix(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                 **read-only**
...
class EstimationInput(CovarianceAnalysisInput):
    ...
    """
    def __init__(self, observations_and_times: tudatpy.kernel.estimation.observations.ObservationCollection, inverse_apriori_covariance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"] = ..., convergence_checker: EstimationConvergenceChecker = ..., consider_covariance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"] = ..., consider_parameters_deviations: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"] = ..., apply_final_parameter_correction: bool = True) -> None:
        """
                 Class constructor.
...
class EstimationOutput(CovarianceAnalysisOutput):
    ...
    def best_iteration(self) -> int:
        ...
        """
    @property
    def final_parameters(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
        """
        No documentation found.
        """
    @property
    def final_residuals(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
        """
                 **read-only**
        ...
        """
    @property
    def parameter_history(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                 **read-only**
        ...
        """
    @property
    def residual_history(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                 **read-only**
        ...
        """
    @property
    def simulation_results_per_iteration(self) -> list[tudatpy.kernel.dynamics.propagation.SimulationResults]:
        """
                 **read-only**
...
class Estimator:
    ...
    def perform_estimation(self, estimation_input: ..., tudat: ...) -> ...:
        ...
        """
    @property
    def observation_managers(self) -> dict[tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType, ..., ...]:
        """
                 **read-only**
        ...
        """
    @property
    def observation_simulators(self) -> list[tudatpy.kernel.estimation.observable_models.observables_simulation.ObservationSimulator]:
        """
                 **read-only**
        ...
        """
    @property
    def state_transition_interface(self) -> tudatpy.kernel.dynamics.simulator.CombinedStateTransitionAndSensitivityMatrixInterface:
        """
                 **read-only**
        ...
        """
    @property
    def variational_solver(self) -> tudatpy.kernel.dynamics.simulator.VariationalSimulator:
        """
                 **read-only**
...
def estimation_convergence_checker(maximum_iterations: typing.SupportsInt = 5, minimum_residual_change: typing.SupportsFloat = 0.0, minimum_residual: typing.SupportsFloat = 0.0, number_of_iterations_without_improvement: typing.SupportsInt = 2) -> EstimationConvergenceChecker:
    ...
    """
def propagate_covariance(initial_covariance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], state_transition_interface: tudatpy.kernel.dynamics.simulator.CombinedStateTransitionAndSensitivityMatrixInterface, output_times: collections.abc.Sequence[typing.SupportsFloat]) -> dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]]:
    """
    ...
    """
def propagate_covariance_rsw_split_output(initial_covariance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], estimator: Estimator, output_times: collections.abc.Sequence[typing.SupportsFloat]) -> tuple[list[float], list[typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]]]:
    """
...
def propagate_formal_errors(initial_covariance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], state_transition_interface: tudatpy.kernel.dynamics.simulator.CombinedStateTransitionAndSensitivityMatrixInterface, output_times: collections.abc.Sequence[typing.SupportsFloat]) -> dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]:
    ...
    """
def propagate_formal_errors_rsw_split_output(initial_covariance: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], estimator: Estimator, output_times: collections.abc.Sequence[typing.SupportsFloat]) -> tuple[list[float], list[typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]]:
    """
