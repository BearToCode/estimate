...
class ObservationBiasSettings:
    ...
    """
def absolute_bias(bias_value: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]) -> ObservationBiasSettings:
    """
     ...
     .. code-block:: python
         ...
         print(absolute_bias_settings)
    """
def arc_wise_time_drift_bias(bias_value: collections.abc.Sequence[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]], arc_start_times: collections.abc.Sequence[typing.SupportsFloat], time_link_end: ..., ref_epochs: collections.abc.Sequence[typing.SupportsFloat]) -> ObservationBiasSettings:
    """
    ...
    """
def arc_wise_time_drift_bias_per_time(bias_value_per_start_time: collections.abc.Mapping[typing.SupportsFloat, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]], time_link_end: ..., ref_epochs: collections.abc.Sequence[typing.SupportsFloat]) -> ObservationBiasSettings:
    """
     Function for creating settings for arc-wise time-drift biases.
     ...
     .. code-block:: python
         ...
         print(arcwise_time_drift_bias_settings)
    """
def arcwise_absolute_bias(arc_start_times: collections.abc.Sequence[typing.SupportsFloat], bias_values: collections.abc.Sequence[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]], reference_link_end_type: ...) -> ObservationBiasSettings:
    """
    ...
    """
def arcwise_absolute_bias_per_time(bias_values_per_start_time: collections.abc.Mapping[typing.SupportsFloat, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]], reference_link_end_type: ...) -> ObservationBiasSettings:
    """
     Function for creating settings for arc-wise absolute observation biases.
    ...
    """
def arcwise_relative_bias(arc_start_times: collections.abc.Sequence[typing.SupportsFloat], bias_values: collections.abc.Sequence[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]], reference_link_end_type: ...) -> ObservationBiasSettings:
    """
    ...
    """
def arcwise_relative_bias_per_time(bias_values_per_start_time: collections.abc.Mapping[typing.SupportsFloat, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]], reference_link_end_type: ...) -> ObservationBiasSettings:
    """
     Function for creating settings for arc-wise relative observation biases.
    ...
    """
def arcwise_time_bias(time_bias_per_arc_start_time: collections.abc.Mapping[typing.SupportsFloat, typing.SupportsFloat], associated_link_end: ...) -> ObservationBiasSettings:
    """
...
def clock_induced_bias(body_name: str, station_name: str) -> ObservationBiasSettings:
    ...
    """
def combined_bias(bias_list: collections.abc.Sequence[ObservationBiasSettings]) -> ObservationBiasSettings:
    """
     ...
     .. code-block:: python
         ...
         print(combined_bias)
    """
def relative_bias(bias_value: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]) -> ObservationBiasSettings:
    """
    ...
    """
def time_bias(time_bias: typing.SupportsFloat, associated_link_end: ...) -> ObservationBiasSettings:
    """
    ...
    """
def time_drift_bias(bias_value: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], time_link_end: ..., ref_epoch: typing.SupportsFloat) -> ObservationBiasSettings:
    """
