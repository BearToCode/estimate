...
import typing
__all__: list[str] = ['GlobalIonosphereModelVtecCalculator', 'JakowskiVtecCalculator', 'LightTimeConvergenceCriteria', 'LightTimeCorrectionSettings', 'LightTimeFailureHandling', 'TroposphericMappingModel', 'VtecCalculator', 'WaterVaporPartialPressureModel', 'accept_without_warning', 'approximated_second_order_relativistic_light_time_correction', 'dsn_tabulated_ionospheric_light_time_correction', 'dsn_tabulated_tropospheric_light_time_correction', 'first_order_relativistic_light_time_correction', 'inverse_power_series_solar_corona_light_time_correction', 'ionex_ionospheric_light_time_correction', 'jakowski_ionospheric_light_time_correction', 'light_time_convergence_settings', 'print_warning_and_accept', 'saastamoinen_tropospheric_light_time_correction', 'set_ionosphere_model_from_ionex', 'set_vmf_troposphere_data', 'throw_exception', 'vmf3_tropospheric_light_time_correction']
class GlobalIonosphereModelVtecCalculator(VtecCalculator):
    def __init__(self, ionosphere_model: tudatpy.kernel.dynamics.environment.IonosphereModel) -> None:
        ...
    def calculate_vtec(self, time: typing.SupportsFloat, sub_ionospheric_point: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"]) -> float:
        ...
class JakowskiVtecCalculator(VtecCalculator):
    def __init__(self, sun_declination_function: collections.abc.Callable[[typing.SupportsFloat], float], f10p7_function: collections.abc.Callable[[typing.SupportsFloat], float], use_utc_time_for_local_time: bool = False) -> None:
        ...
    def calculate_vtec(self, time: typing.SupportsFloat, sub_ionospheric_point: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 1]"]) -> float:
        ...
...
class LightTimeFailureHandling:
    ...
    Members:
      ...
      throw_exception
    """
    __members__: typing.ClassVar[dict[str, LightTimeFailureHandling]]  # value = {'accept_without_warning': <LightTimeFailureHandling.accept_without_warning: 0>, 'print_warning_and_accept': <LightTimeFailureHandling.print_warning_and_accept: 1>, 'throw_exception': <LightTimeFailureHandling.throw_exception: 2>}
    accept_without_warning: typing.ClassVar[LightTimeFailureHandling]  # value = <LightTimeFailureHandling.accept_without_warning: 0>
    print_warning_and_accept: typing.ClassVar[LightTimeFailureHandling]  # value = <LightTimeFailureHandling.print_warning_and_accept: 1>
    throw_exception: typing.ClassVar[LightTimeFailureHandling]  # value = <LightTimeFailureHandling.throw_exception: 2>
...
class TroposphericMappingModel:
    ...
    Members:
      ...
      vmf3
    """
    __members__: typing.ClassVar[dict[str, TroposphericMappingModel]]  # value = {'simplified_chao': <TroposphericMappingModel.simplified_chao: 0>, 'niell': <TroposphericMappingModel.niell: 1>, 'vmf3': <TroposphericMappingModel.vmf3: 2>}
    niell: typing.ClassVar[TroposphericMappingModel]  # value = <TroposphericMappingModel.niell: 1>
    simplified_chao: typing.ClassVar[TroposphericMappingModel]  # value = <TroposphericMappingModel.simplified_chao: 0>
    vmf3: typing.ClassVar[TroposphericMappingModel]  # value = <TroposphericMappingModel.vmf3: 2>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class WaterVaporPartialPressureModel:
    ...
    Members:
      ...
      bean_and_dutton
    """
    __members__: typing.ClassVar[dict[str, WaterVaporPartialPressureModel]]  # value = {'tabulated': <WaterVaporPartialPressureModel.tabulated: 0>, 'bean_and_dutton': <WaterVaporPartialPressureModel.bean_and_dutton: 1>}
    bean_and_dutton: typing.ClassVar[WaterVaporPartialPressureModel]  # value = <WaterVaporPartialPressureModel.bean_and_dutton: 1>
    tabulated: typing.ClassVar[WaterVaporPartialPressureModel]  # value = <WaterVaporPartialPressureModel.tabulated: 0>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
    ...
    def value(self) -> int:
        ...
def approximated_second_order_relativistic_light_time_correction(perturbing_bodies: collections.abc.Sequence[str]) -> LightTimeCorrectionSettings:
    """
    ...
    * 2. **Perturbing Body Not as a Link End:** If the perturbing body is not part of the observation link ends, its state is evaluated at the **midpoint time** between the transmission and reception events.
    ...
    .. code-block:: python
        ...
        print(doppler_observation_settings)
    """
def dsn_tabulated_ionospheric_light_time_correction(file_names: collections.abc.Sequence[str], spacecraft_name_per_id: collections.abc.Mapping[typing.SupportsInt, str] = {}, quasar_name_per_id: collections.abc.Mapping[typing.SupportsInt, str] = {}, reference_frequency: typing.SupportsFloat = 2295000000.0, body_with_atmosphere_name: str = 'Earth') -> LightTimeCorrectionSettings:
    """
    No documentation found.
    """
def dsn_tabulated_tropospheric_light_time_correction(file_names: collections.abc.Sequence[str], body_with_atmosphere_name: str = 'Earth', mapping_model: TroposphericMappingModel = ...) -> LightTimeCorrectionSettings:
    """
    No documentation found.
    """
def first_order_relativistic_light_time_correction(perturbing_bodies: collections.abc.Sequence[str]) -> LightTimeCorrectionSettings:
    """
    ...
    * 2. **Perturbing Body Not as a Link End:** If the perturbing body is not part of the observation link ends, its state is evaluated at the **midpoint time** between the transmission and reception events.
    ...
    .. code-block:: python
        ...
        print(doppler_observation_settings)
    """
def inverse_power_series_solar_corona_light_time_correction(coefficients: collections.abc.Sequence[typing.SupportsFloat] = [130000000000000.0, 500000000000.0], positive_exponents: collections.abc.Sequence[typing.SupportsFloat] = [6.0, 2.0], delay_coefficient: typing.SupportsFloat = 40.3, sun_body_name: str = 'Sun') -> LightTimeCorrectionSettings:
    """
    No documentation found.
    """
def ionex_ionospheric_light_time_correction(body_with_ionosphere_name: str, ionosphere_height: typing.SupportsFloat, first_order_delay_coefficient: typing.SupportsFloat = 40.3) -> LightTimeCorrectionSettings:
    """
    Create IONEX-based ionospheric light time correction settings.
    """
def jakowski_ionospheric_light_time_correction(ionosphere_height: typing.SupportsFloat = 400000.0, first_order_delay_coefficient: typing.SupportsFloat = 40.3, solar_activity_data_path: str = 'C:\\Users\\david/.tudat/resource/space_weather/sw19571001.txt', geomagnetic_pole_latitude: typing.SupportsFloat = 1.4119713648634127, geomagnetic_pole_longitude: typing.SupportsFloat = -1.2671090369478832, use_utc_for_local_time_computation: bool = False, body_with_atmosphere_name: str = 'Earth') -> LightTimeCorrectionSettings:
    """
    No documentation found.
    """
def light_time_convergence_settings(iterate_corrections: bool = False, maximum_number_of_iterations: typing.SupportsInt = 50, absolute_tolerance: typing.SupportsFloat = ..., failure_handling: LightTimeFailureHandling = ...) -> LightTimeConvergenceCriteria:
    """
...
def saastamoinen_tropospheric_light_time_correction(body_with_atmosphere_name: str = 'Earth', mapping_model: TroposphericMappingModel = ..., water_vapor_partial_pressure_model: WaterVaporPartialPressureModel = ...) -> LightTimeCorrectionSettings:
    ...
    No documentation found.
    """
def set_ionosphere_model_from_ionex(data_files: collections.abc.Sequence[str], bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, interpolator_settings: tudatpy.kernel.math.interpolators.InterpolatorSettings = None) -> None:
    ...
def set_vmf_troposphere_data(data_files: collections.abc.Sequence[str], file_has_meteo: bool, file_has_gradient: bool, bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, set_troposphere_data: bool = True, set_meteo_data: bool = True, interpolator_settings: tudatpy.kernel.math.interpolators.InterpolatorSettings = ...) -> None:
    ...
def vmf3_tropospheric_light_time_correction(body_with_atmosphere_name: str = 'Earth', use_gradient_correction: bool = True, tropospheric_mapping_model: TroposphericMappingModel = ...) -> LightTimeCorrectionSettings:
    ...
    """
accept_without_warning: LightTimeFailureHandling  # value = <LightTimeFailureHandling.accept_without_warning: 0>
print_warning_and_accept: LightTimeFailureHandling  # value = <LightTimeFailureHandling.print_warning_and_accept: 1>
throw_exception: LightTimeFailureHandling  # value = <LightTimeFailureHandling.throw_exception: 2>
