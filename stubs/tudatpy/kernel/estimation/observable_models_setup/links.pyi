...
class LinkDefinition:
    ...
    """
    def __init__(self, link_ends: collections.abc.Mapping[LinkEndType, LinkEndId]) -> None:
        ...
...
class LinkEndType:
    ...
    Members:
      ...
      observed_body
    """
    __members__: typing.ClassVar[dict[str, LinkEndType]]  # value = {'unidentified_link_end': <LinkEndType.unidentified_link_end: -1>, 'transmitter': <LinkEndType.transmitter: 0>, 'reflector1': <LinkEndType.reflector1: 1>, 'retransmitter': <LinkEndType.reflector1: 1>, 'reflector2': <LinkEndType.reflector2: 2>, 'reflector3': <LinkEndType.reflector3: 3>, 'reflector4': <LinkEndType.reflector4: 4>, 'receiver': <LinkEndType.receiver: 5>, 'transmitter2': <LinkEndType.transmitter2: 7>, 'observer': <LinkEndType.observer: 8>, 'observed_body': <LinkEndType.observed_body: 6>}
    observed_body: typing.ClassVar[LinkEndType]  # value = <LinkEndType.observed_body: 6>
    observer: typing.ClassVar[LinkEndType]  # value = <LinkEndType.observer: 8>
    receiver: typing.ClassVar[LinkEndType]  # value = <LinkEndType.receiver: 5>
    reflector1: typing.ClassVar[LinkEndType]  # value = <LinkEndType.reflector1: 1>
    reflector2: typing.ClassVar[LinkEndType]  # value = <LinkEndType.reflector2: 2>
    reflector3: typing.ClassVar[LinkEndType]  # value = <LinkEndType.reflector3: 3>
    reflector4: typing.ClassVar[LinkEndType]  # value = <LinkEndType.reflector4: 4>
    retransmitter: typing.ClassVar[LinkEndType]  # value = <LinkEndType.reflector1: 1>
    transmitter: typing.ClassVar[LinkEndType]  # value = <LinkEndType.transmitter: 0>
    transmitter2: typing.ClassVar[LinkEndType]  # value = <LinkEndType.transmitter2: 7>
    unidentified_link_end: typing.ClassVar[LinkEndType]  # value = <LinkEndType.unidentified_link_end: -1>
...
def get_default_reference_link_end(observabl_type: ...) -> LinkEndType:
    ...
    """
def link_definition(link_ends: collections.abc.Mapping[LinkEndType, LinkEndId]) -> LinkDefinition:
    """
    ...
    """
def one_way_downlink_link_ends(transmitter: ..., receivers: collections.abc.Sequence[...]) -> list[dict[LinkEndType, ...]]:
    """
    ...
    """
def one_way_uplink_link_ends(transmitters: collections.abc.Sequence[...], receiver: ...) -> list[dict[LinkEndType, ...]]:
    """
     ...
     .. code-block:: python
         ...
         print(link_definition)
    """
observed_body: LinkEndType  # value = <LinkEndType.observed_body: 6>
observer: LinkEndType  # value = <LinkEndType.observer: 8>
receiver: LinkEndType  # value = <LinkEndType.receiver: 5>
reflector1: LinkEndType  # value = <LinkEndType.reflector1: 1>
reflector2: LinkEndType  # value = <LinkEndType.reflector2: 2>
reflector3: LinkEndType  # value = <LinkEndType.reflector3: 3>
reflector4: LinkEndType  # value = <LinkEndType.reflector4: 4>
retransmitter: LinkEndType  # value = <LinkEndType.reflector1: 1>
transmitter: LinkEndType  # value = <LinkEndType.transmitter: 0>
transmitter2: LinkEndType  # value = <LinkEndType.transmitter2: 7>
unidentified_link_end: LinkEndType  # value = <LinkEndType.unidentified_link_end: -1>
