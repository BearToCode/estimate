...
import tudatpy.kernel.estimation.observable_models_setup.biases
import tudatpy.kernel.estimation.observable_models_setup.light_time_corrections
import tudatpy.kernel.estimation.observable_models_setup.links
import typing
__all__: list[str] = ['DopplerProperTimeRateSettings', 'NWayRangeObservationModelSettings', 'ObservableType', 'ObservationModelSettings', 'OneWayDopplerObservationModelSettings', 'angular_position', 'angular_position_type', 'cartesian_position', 'cartesian_velocity', 'doppler_measured_frequency', 'doppler_measured_frequency_type', 'dsn_n_way_averaged_doppler_type', 'dsn_n_way_doppler_averaged', 'dsn_n_way_doppler_averaged_from_one_way_links', 'dsn_n_way_range', 'dsn_n_way_range_type', 'dsn_one_way_averaged_doppler_type', 'euler_angle_313_observable_type', 'euler_angles_313', 'n_way_averaged_doppler_type', 'n_way_doppler_averaged', 'n_way_doppler_averaged_from_one_way_links', 'n_way_range', 'n_way_range_from_one_way_links', 'n_way_range_type', 'one_way_averaged_doppler_type', 'one_way_closed_loop_doppler', 'one_way_doppler_averaged', 'one_way_doppler_instantaneous', 'one_way_instantaneous_doppler_type', 'one_way_open_loop_doppler', 'one_way_range', 'one_way_range_type', 'position_observable_type', 'relative_angular_position', 'relative_angular_position_type', 'relative_cartesian_position', 'relative_position_observable_type', 'two_doppler_instantaneous', 'two_way_doppler_averaged', 'two_way_doppler_averaged_from_one_way_links', 'two_way_doppler_instantaneous', 'two_way_doppler_instantaneous_from_one_way_links', 'two_way_instantaneous_doppler_type', 'two_way_open_loop_doppler', 'two_way_open_loop_doppler_from_one_way_links', 'two_way_range', 'two_way_range_from_one_way_links', 'velocity_observable_type']
class DopplerProperTimeRateSettings:
    ...
    """
class NWayRangeObservationModelSettings(ObservationModelSettings):
    """
...
class ObservableType:
    ...
    """
    __members__: typing.ClassVar[dict[str, ObservableType]]  # value = {'one_way_range_type': <ObservableType.one_way_range_type: 0>, 'n_way_range_type': <ObservableType.n_way_range_type: 5>, 'angular_position_type': <ObservableType.angular_position_type: 1>, 'relative_angular_position_type': <ObservableType.angular_position_type: 1>, 'position_observable_type': <ObservableType.position_observable_type: 2>, 'velocity_observable_type': <ObservableType.velocity_observable_type: 8>, 'relative_position_observable_type': <ObservableType.relative_position_observable_type: 11>, 'one_way_instantaneous_doppler_type': <ObservableType.one_way_instantaneous_doppler_type: 3>, 'one_way_averaged_doppler_type': <ObservableType.one_way_averaged_doppler_type: 4>, 'two_way_instantaneous_doppler_type': <ObservableType.two_way_instantaneous_doppler_type: 6>, 'n_way_averaged_doppler_type': <ObservableType.n_way_averaged_doppler_type: 10>, 'euler_angle_313_observable_type': <ObservableType.euler_angle_313_observable_type: 7>, 'dsn_one_way_averaged_doppler_type': <ObservableType.dsn_one_way_averaged_doppler_type: 12>, 'dsn_n_way_averaged_doppler_type': <ObservableType.dsn_n_way_averaged_doppler_type: 13>, 'doppler_measured_frequency_type': <ObservableType.doppler_measured_frequency_type: 14>, 'dsn_n_way_range_type': <ObservableType.dsn_n_way_range_type: 15>}
    angular_position_type: typing.ClassVar[ObservableType]  # value = <ObservableType.angular_position_type: 1>
    doppler_measured_frequency_type: typing.ClassVar[ObservableType]  # value = <ObservableType.doppler_measured_frequency_type: 14>
    dsn_n_way_averaged_doppler_type: typing.ClassVar[ObservableType]  # value = <ObservableType.dsn_n_way_averaged_doppler_type: 13>
    dsn_n_way_range_type: typing.ClassVar[ObservableType]  # value = <ObservableType.dsn_n_way_range_type: 15>
    dsn_one_way_averaged_doppler_type: typing.ClassVar[ObservableType]  # value = <ObservableType.dsn_one_way_averaged_doppler_type: 12>
    euler_angle_313_observable_type: typing.ClassVar[ObservableType]  # value = <ObservableType.euler_angle_313_observable_type: 7>
    n_way_averaged_doppler_type: typing.ClassVar[ObservableType]  # value = <ObservableType.n_way_averaged_doppler_type: 10>
    n_way_range_type: typing.ClassVar[ObservableType]  # value = <ObservableType.n_way_range_type: 5>
    one_way_averaged_doppler_type: typing.ClassVar[ObservableType]  # value = <ObservableType.one_way_averaged_doppler_type: 4>
    one_way_instantaneous_doppler_type: typing.ClassVar[ObservableType]  # value = <ObservableType.one_way_instantaneous_doppler_type: 3>
    one_way_range_type: typing.ClassVar[ObservableType]  # value = <ObservableType.one_way_range_type: 0>
    position_observable_type: typing.ClassVar[ObservableType]  # value = <ObservableType.position_observable_type: 2>
    relative_angular_position_type: typing.ClassVar[ObservableType]  # value = <ObservableType.angular_position_type: 1>
    relative_position_observable_type: typing.ClassVar[ObservableType]  # value = <ObservableType.relative_position_observable_type: 11>
    two_way_instantaneous_doppler_type: typing.ClassVar[ObservableType]  # value = <ObservableType.two_way_instantaneous_doppler_type: 6>
    velocity_observable_type: typing.ClassVar[ObservableType]  # value = <ObservableType.velocity_observable_type: 8>
...
class ObservationModelSettings:
    ...
    """
class OneWayDopplerObservationModelSettings(ObservationModelSettings):
    """
...
def angular_position(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ...) -> ObservationModelSettings:
    ...
    """
def cartesian_position(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None) -> ObservationModelSettings:
    """
    ...
    """
def cartesian_velocity(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None) -> ObservationModelSettings:
    """
    ...
    """
def doppler_measured_frequency(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ...) -> ObservationModelSettings:
    """
    No documentation found.
    """
def dsn_n_way_doppler_averaged(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ..., subtract_doppler_signature: bool = True) -> ObservationModelSettings:
    """
    No documentation found.
    """
def dsn_n_way_doppler_averaged_from_one_way_links(one_way_range_settings: collections.abc.Sequence[ObservationModelSettings], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ..., subtract_doppler_signature: bool = True) -> ObservationModelSettings:
    """
    No documentation found.
    """
def dsn_n_way_range(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ...) -> ObservationModelSettings:
    """
    No documentation found.
    """
def euler_angles_313(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None) -> ObservationModelSettings:
    """
    No documentation found.
    """
def n_way_doppler_averaged(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ...) -> ObservationModelSettings:
    """
    ...
    """
def n_way_doppler_averaged_from_one_way_links(one_way_range_settings: collections.abc.Sequence[ObservationModelSettings], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ...) -> ObservationModelSettings:
    """
     Function for creating settings for an n-way averaged Doppler observable.
     ...
     :class:`~tudatpy.estimation.observable_models_setup.model_settings.ObservationModelSettings`
         Instance of the :class:`~tudatpy.estimation.observable_models_setup.model_settings.ObservationModelSettings` derived `~tudatpy.estimation.observable_models_setup.model_settings.NWayDifferencedRangeRateObservationSettings` class defining the settings for the one-way closed-loop doppler observable.
    """
def n_way_range(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ...) -> ObservationModelSettings:
    """
     ...
     .. code-block:: python
         ...
         print(observation_settings)
    """
def n_way_range_from_one_way_links(one_way_range_settings: collections.abc.Sequence[ObservationModelSettings], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None) -> ObservationModelSettings:
    """
     Function for creating settings for a n-way range observable.
    ...
    """
@typing.overload
def one_way_closed_loop_doppler(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ...) -> ObservationModelSettings:
    ...
@typing.overload
def one_way_closed_loop_doppler(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ...) -> ObservationModelSettings:
    ...
def one_way_doppler_averaged(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ...) -> ObservationModelSettings:
    """
    ...
    """
def one_way_doppler_instantaneous(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, transmitter_proper_time_rate_settings: DopplerProperTimeRateSettings = None, receiver_proper_time_rate_settings: DopplerProperTimeRateSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ..., normalized_with_speed_of_light: bool = False) -> ObservationModelSettings:
    """
...
def one_way_open_loop_doppler(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, transmitter_proper_time_rate_settings: DopplerProperTimeRateSettings = None, receiver_proper_time_rate_settings: DopplerProperTimeRateSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ..., normalized_with_speed_of_light: bool = False) -> ObservationModelSettings:
    ...
def one_way_range(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ...) -> ObservationModelSettings:
    """
     ...
     .. code-block:: python
         ...
         print(observation_settings)
    """
def relative_angular_position(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ...) -> ObservationModelSettings:
    """
    ...
    """
def relative_cartesian_position(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None) -> ObservationModelSettings:
    """
...
def two_doppler_instantaneous(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ..., normalized_with_speed_of_light: bool = False) -> ObservationModelSettings:
    ...
    No documentation found.
    """
def two_way_doppler_averaged(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ...) -> ObservationModelSettings:
    """
     Function for creating settings for an n-way averaged Doppler observable.
     ...
     :class:`~tudatpy.estimation.observable_models_setup.model_settings.ObservationModelSettings`
         Instance of the :class:`~tudatpy.estimation.observable_models_setup.model_settings.ObservationModelSettings` derived `~tudatpy.estimation.observable_models_setup.model_settings.NWayDifferencedRangeRateObservationSettings` class defining the settings for the one-way closed-loop doppler observable.
    """
def two_way_doppler_averaged_from_one_way_links(one_way_range_settings: collections.abc.Sequence[ObservationModelSettings], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None) -> ObservationModelSettings:
    """
     Function for creating settings for an n-way averaged Doppler observable.
     ...
     :class:`~tudatpy.estimation.observable_models_setup.model_settings.ObservationModelSettings`
         Instance of the :class:`~tudatpy.estimation.observable_models_setup.model_settings.ObservationModelSettings` derived `~tudatpy.estimation.observable_models_setup.model_settings.NWayDifferencedRangeRateObservationSettings` class defining the settings for the one-way closed-loop doppler observable.
    """
def two_way_doppler_instantaneous(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ..., normalized_with_speed_of_light: bool = False) -> ObservationModelSettings:
    """
    No documentation found.
    """
def two_way_doppler_instantaneous_from_one_way_links(uplink_doppler_settings: OneWayDopplerObservationModelSettings, downlink_doppler_settings: OneWayDopplerObservationModelSettings, bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None) -> ObservationModelSettings:
    """
    ...
    """
def two_way_open_loop_doppler(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ..., normalized_with_speed_of_light: bool = False) -> ObservationModelSettings:
    ...
def two_way_open_loop_doppler_from_one_way_links(uplink_doppler_settings: OneWayDopplerObservationModelSettings, downlink_doppler_settings: OneWayDopplerObservationModelSettings, bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None) -> ObservationModelSettings:
    ...
def two_way_range(link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, light_time_correction_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeCorrectionSettings] = [], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None, light_time_convergence_settings: tudatpy.kernel.estimation.observable_models_setup.light_time_corrections.LightTimeConvergenceCriteria = ...) -> ObservationModelSettings:
    """
     ...
     .. code-block:: python
         ...
         print(observation_settings)
    """
def two_way_range_from_one_way_links(one_way_range_settings: collections.abc.Sequence[ObservationModelSettings], bias_settings: tudatpy.kernel.estimation.observable_models_setup.biases.ObservationBiasSettings = None) -> ObservationModelSettings:
    """
     Function for creating settings for a two-way range observable.
    ...
    """
angular_position_type: ObservableType  # value = <ObservableType.angular_position_type: 1>
doppler_measured_frequency_type: ObservableType  # value = <ObservableType.doppler_measured_frequency_type: 14>
dsn_n_way_averaged_doppler_type: ObservableType  # value = <ObservableType.dsn_n_way_averaged_doppler_type: 13>
dsn_n_way_range_type: ObservableType  # value = <ObservableType.dsn_n_way_range_type: 15>
dsn_one_way_averaged_doppler_type: ObservableType  # value = <ObservableType.dsn_one_way_averaged_doppler_type: 12>
euler_angle_313_observable_type: ObservableType  # value = <ObservableType.euler_angle_313_observable_type: 7>
n_way_averaged_doppler_type: ObservableType  # value = <ObservableType.n_way_averaged_doppler_type: 10>
n_way_range_type: ObservableType  # value = <ObservableType.n_way_range_type: 5>
one_way_averaged_doppler_type: ObservableType  # value = <ObservableType.one_way_averaged_doppler_type: 4>
one_way_instantaneous_doppler_type: ObservableType  # value = <ObservableType.one_way_instantaneous_doppler_type: 3>
one_way_range_type: ObservableType  # value = <ObservableType.one_way_range_type: 0>
position_observable_type: ObservableType  # value = <ObservableType.position_observable_type: 2>
relative_angular_position_type: ObservableType  # value = <ObservableType.angular_position_type: 1>
relative_position_observable_type: ObservableType  # value = <ObservableType.relative_position_observable_type: 11>
two_way_instantaneous_doppler_type: ObservableType  # value = <ObservableType.two_way_instantaneous_doppler_type: 6>
velocity_observable_type: ObservableType  # value = <ObservableType.velocity_observable_type: 8>
