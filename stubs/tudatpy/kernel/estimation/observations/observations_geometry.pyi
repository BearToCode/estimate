...
import typing
__all__: list[str] = ['compute_target_angles_and_range', 'compute_target_angles_and_range_vectors']
def compute_target_angles_and_range(bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, station_id: tuple[str, str], target_body: str, observation_times: collections.abc.Sequence[typing.SupportsFloat], is_station_transmitting: bool) -> dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]:
    """
    ...
    """
def compute_target_angles_and_range_vectors(bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, station_id: tuple[str, str], target_body: str, observation_times: collections.abc.Sequence[typing.SupportsFloat], is_station_transmitting: bool) -> tuple[list[float], list[typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]]:
    """
     Function to compute the azimuth angle, elevation angle and range at a ground station.
