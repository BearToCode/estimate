...
class FrequencyBands:
    ...
    Members:
      ...
      ku_band
    """
    __members__: typing.ClassVar[dict[str, FrequencyBands]]  # value = {'s_band': <FrequencyBands.s_band: 0>, 'x_band': <FrequencyBands.x_band: 1>, 'ka_band': <FrequencyBands.ka_band: 2>, 'ku_band': <FrequencyBands.ku_band: 3>}
    ka_band: typing.ClassVar[FrequencyBands]  # value = <FrequencyBands.ka_band: 2>
    ku_band: typing.ClassVar[FrequencyBands]  # value = <FrequencyBands.ku_band: 3>
    s_band: typing.ClassVar[FrequencyBands]  # value = <FrequencyBands.s_band: 0>
    x_band: typing.ClassVar[FrequencyBands]  # value = <FrequencyBands.x_band: 1>
...
class ObservationAncilliarySimulationSettings:
    ...
    def get_float_settings(self, setting_type: ObservationAncilliarySimulationVariable, throw_exception: bool = True) -> float:
        ...
        """
    def set_intermediate_double_data(self, variable: ..., value: typing.SupportsFloat) -> None:
        ...
class ObservationAncilliarySimulationVariable:
    ...
    """
    __members__: typing.ClassVar[dict[str, ObservationAncilliarySimulationVariable]]  # value = {'link_ends_delays': <ObservationAncilliarySimulationVariable.link_ends_delays: 0>, 'doppler_integration_time': <ObservationAncilliarySimulationVariable.doppler_integration_time: 3>, 'doppler_reference_frequency': <ObservationAncilliarySimulationVariable.doppler_reference_frequency: 4>, 'frequency_bands': <ObservationAncilliarySimulationVariable.frequency_bands: 1>, 'reception_reference_frequency_band': <ObservationAncilliarySimulationVariable.reception_reference_frequency_band: 2>, 'sequential_range_lowest_ranging_component': <ObservationAncilliarySimulationVariable.sequential_range_lowest_ranging_component: 5>, 'range_conversion_factor': <ObservationAncilliarySimulationVariable.range_conversion_factor: 6>}
    doppler_integration_time: typing.ClassVar[ObservationAncilliarySimulationVariable]  # value = <ObservationAncilliarySimulationVariable.doppler_integration_time: 3>
    doppler_reference_frequency: typing.ClassVar[ObservationAncilliarySimulationVariable]  # value = <ObservationAncilliarySimulationVariable.doppler_reference_frequency: 4>
    frequency_bands: typing.ClassVar[ObservationAncilliarySimulationVariable]  # value = <ObservationAncilliarySimulationVariable.frequency_bands: 1>
    link_ends_delays: typing.ClassVar[ObservationAncilliarySimulationVariable]  # value = <ObservationAncilliarySimulationVariable.link_ends_delays: 0>
    range_conversion_factor: typing.ClassVar[ObservationAncilliarySimulationVariable]  # value = <ObservationAncilliarySimulationVariable.range_conversion_factor: 6>
    reception_reference_frequency_band: typing.ClassVar[ObservationAncilliarySimulationVariable]  # value = <ObservationAncilliarySimulationVariable.reception_reference_frequency_band: 2>
    sequential_range_lowest_ranging_component: typing.ClassVar[ObservationAncilliarySimulationVariable]  # value = <ObservationAncilliarySimulationVariable.sequential_range_lowest_ranging_component: 5>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class ObservationIntermediateSimulationVariable:
    ...
    """
    __members__: typing.ClassVar[dict[str, ObservationIntermediateSimulationVariable]]  # value = {'transmitter_frequency_intermediate': <ObservationIntermediateSimulationVariable.transmitter_frequency_intermediate: 0>, 'received_frequency_intermediate': <ObservationIntermediateSimulationVariable.received_frequency_intermediate: 1>}
    received_frequency_intermediate: typing.ClassVar[ObservationIntermediateSimulationVariable]  # value = <ObservationIntermediateSimulationVariable.received_frequency_intermediate: 1>
    transmitter_frequency_intermediate: typing.ClassVar[ObservationIntermediateSimulationVariable]  # value = <ObservationIntermediateSimulationVariable.transmitter_frequency_intermediate: 0>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
    ...
    def value(self) -> int:
        ...
def add_ancilliary_settings_to_observable(observation_simulation_settings_list: collections.abc.Sequence[...], ancilliary_settings: ObservationAncilliarySimulationSettings, observable_type: tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType) -> None:
    """
    No documentation found.
    """
def add_ancilliary_settings_to_observable_for_link_ends(observation_simulation_settings_list: collections.abc.Sequence[...], ancilliary_settings: ObservationAncilliarySimulationSettings, observable_type: tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType, link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition) -> None:
    """
    No documentation found.
    """
def cassini_turnaround_ratios(uplink_band: FrequencyBands, downlink_band: FrequencyBands) -> float:
    ...
    No documentation found.
    """
def doppler_ancilliary_settings(integration_time: typing.SupportsFloat = 60.0) -> ObservationAncilliarySimulationSettings:
    """
    ...
    """
def doppler_measured_frequency_ancillary_settings(frequency_bands: collections.abc.Sequence[...]) -> ObservationAncilliarySimulationSettings:
    """
    No documentation found.
    """
def dsn_default_turnaround_ratios(uplink_band: FrequencyBands, downlink_band: FrequencyBands) -> float:
    ...
    No documentation found.
    """
def dsn_n_way_doppler_ancilliary_settings(frequency_bands: collections.abc.Sequence[...], reference_frequency_band: ..., reference_frequency: typing.SupportsFloat, integration_time: typing.SupportsFloat = 60.0, link_end_delays: collections.abc.Sequence[typing.SupportsFloat] = []) -> ObservationAncilliarySimulationSettings:
    """
    No documentation found.
    """
def dsn_n_way_range_ancilliary_settings(frequency_bands: collections.abc.Sequence[...], lowest_ranging_component: typing.SupportsFloat, link_end_delays: collections.abc.Sequence[typing.SupportsFloat] = []) -> ObservationAncilliarySimulationSettings:
    """
    No documentation found.
    """
def n_way_doppler_ancilliary_settings(integration_time: typing.SupportsFloat = 60.0, link_end_delays: collections.abc.Sequence[typing.SupportsFloat] = [], frequency_bands: collections.abc.Sequence[...] = []) -> ObservationAncilliarySimulationSettings:
    """
     ...
     :class:`ObservationAncilliarySimulationSettings`
         Instance of the :class:`~tudatpy.estimation.observations_setup.ancillary_settings.ObservationAncilliarySimulationSettings` with the required settings.
    """
def n_way_range_ancilliary_settings(link_end_delays: collections.abc.Sequence[typing.SupportsFloat] = [], frequency_bands: collections.abc.Sequence[...] = []) -> ObservationAncilliarySimulationSettings:
    """
     ...
     :class:`ObservationAncilliarySimulationSettings`
         Instance of the :class:`~tudatpy.estimation.observations_setup.ancillary_settings.ObservationAncilliarySimulationSettings` with the required settings.
    """
def two_way_doppler_ancilliary_settings(integration_time: typing.SupportsFloat = 60.0, retransmission_delay: typing.SupportsFloat = 0.0) -> ObservationAncilliarySimulationSettings:
    """
     ...
     :class:`ObservationAncilliarySimulationSettings`
         Instance of the :class:`~tudatpy.estimation.observations_setup.ancillary_settings.ObservationAncilliarySimulationSettings` with the required settings.
    """
def two_way_range_ancilliary_settings(retransmission_delay: typing.SupportsFloat = 0.0) -> ObservationAncilliarySimulationSettings:
    """
     ...
     :class:`ObservationAncilliarySimulationSettings`
         Instance of the :class:`~tudatpy.estimation.observations_setup.ancillary_settings.ObservationAncilliarySimulationSettings` with the required settings.
    """
doppler_integration_time: ObservationAncilliarySimulationVariable  # value = <ObservationAncilliarySimulationVariable.doppler_integration_time: 3>
doppler_reference_frequency: ObservationAncilliarySimulationVariable  # value = <ObservationAncilliarySimulationVariable.doppler_reference_frequency: 4>
frequency_bands: ObservationAncilliarySimulationVariable  # value = <ObservationAncilliarySimulationVariable.frequency_bands: 1>
link_ends_delays: ObservationAncilliarySimulationVariable  # value = <ObservationAncilliarySimulationVariable.link_ends_delays: 0>
range_conversion_factor: ObservationAncilliarySimulationVariable  # value = <ObservationAncilliarySimulationVariable.range_conversion_factor: 6>
received_frequency_intermediate: ObservationIntermediateSimulationVariable  # value = <ObservationIntermediateSimulationVariable.received_frequency_intermediate: 1>
reception_reference_frequency_band: ObservationAncilliarySimulationVariable  # value = <ObservationAncilliarySimulationVariable.reception_reference_frequency_band: 2>
sequential_range_lowest_ranging_component: ObservationAncilliarySimulationVariable  # value = <ObservationAncilliarySimulationVariable.sequential_range_lowest_ranging_component: 5>
transmitter_frequency_intermediate: ObservationIntermediateSimulationVariable  # value = <ObservationIntermediateSimulationVariable.transmitter_frequency_intermediate: 0>
