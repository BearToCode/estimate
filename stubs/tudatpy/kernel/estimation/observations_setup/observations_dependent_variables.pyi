...
class IntegratedObservationPropertyHandling:
    ...
    Members:
      ...
      interval_undefined
    """
    __members__: typing.ClassVar[dict[str, IntegratedObservationPropertyHandling]]  # value = {'interval_start': <IntegratedObservationPropertyHandling.interval_start: 0>, 'interval_end': <IntegratedObservationPropertyHandling.interval_end: 1>, 'interval_undefined': <IntegratedObservationPropertyHandling.interval_undefined: 2>}
    interval_end: typing.ClassVar[IntegratedObservationPropertyHandling]  # value = <IntegratedObservationPropertyHandling.interval_end: 1>
    interval_start: typing.ClassVar[IntegratedObservationPropertyHandling]  # value = <IntegratedObservationPropertyHandling.interval_start: 0>
    interval_undefined: typing.ClassVar[IntegratedObservationPropertyHandling]  # value = <IntegratedObservationPropertyHandling.interval_undefined: 2>
...
class ObservationDependentVariableSettings:
    ...
    """
def add_dependent_variables_to_all(observation_simulation_settings: collections.abc.Sequence[...], dependent_variable_settings: collections.abc.Sequence[ObservationDependentVariableSettings], bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies) -> None:
    """
...
def add_dependent_variables_to_observable(observation_simulation_settings: collections.abc.Sequence[...], dependent_variable_settings: collections.abc.Sequence[ObservationDependentVariableSettings], bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, observable_type: tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType) -> None:
    ...
    """
def add_dependent_variables_to_observable_for_link_ends(observation_simulation_settings: collections.abc.Sequence[...], dependent_variable_settings: collections.abc.Sequence[ObservationDependentVariableSettings], bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies, observable_type: tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType, link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition) -> None:
    """
    No documentation found.
    """
def angle_wrt_orbital_plane_dependent_variable(body_name: str, start_link_end_type: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType = ..., end_link_end_type: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType = ..., start_link_end_id: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndId = ..., end_link_end_id: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndId = ..., integrated_observation_handling: IntegratedObservationPropertyHandling = ...) -> ObservationDependentVariableSettings:
    """
    No documentation found.
    """
def avoidance_angle_dependent_variable(body_name: str, start_link_end_type: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType = ..., end_link_end_type: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType = ..., start_link_end_id: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndId = ..., end_link_end_id: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndId = ..., integrated_observation_handling: IntegratedObservationPropertyHandling = ...) -> ObservationDependentVariableSettings:
    """
    No documentation found.
    """
def azimuth_angle_dependent_variable(link_end_type: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType = ..., link_end_id: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndId = ..., originating_link_end_type: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType = ..., originating_link_end_id: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndId = ..., integrated_observation_handling: IntegratedObservationPropertyHandling = ...) -> ObservationDependentVariableSettings:
    """
    No documentation found.
    """
...
def body_limb_distance_dependent_variable(body_name: str, start_link_end_type: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType = ..., end_link_end_type: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType = ..., start_link_end_id: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndId = ..., end_link_end_id: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndId = ..., integrated_observation_handling: IntegratedObservationPropertyHandling = ...) -> ObservationDependentVariableSettings:
    ...
    No documentation found.
    """
def elevation_angle_dependent_variable(link_end_type: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType = ..., link_end_id: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndId = ..., originating_link_end_type: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType = ..., originating_link_end_id: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndId = ..., integrated_observation_handling: IntegratedObservationPropertyHandling = ...) -> ObservationDependentVariableSettings:
    """
    No documentation found.
    """
def integration_time_dependent_variable(observable_type: tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType = ...) -> ObservationDependentVariableSettings:
    """
    No documentation found.
    """
def retransmission_delays_dependent_variable(observable_type: tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType = ...) -> ObservationDependentVariableSettings:
    """
    No documentation found.
    """
def target_range_between_link_ends_dependent_variable(start_link_end_type: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType = ..., end_link_end_type: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType = ..., start_link_end_id: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndId = ..., end_link_end_id: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndId = ..., integrated_observation_handling: IntegratedObservationPropertyHandling = ...) -> ObservationDependentVariableSettings:
    """
    No documentation found.
    """
interval_end: IntegratedObservationPropertyHandling  # value = <IntegratedObservationPropertyHandling.interval_end: 1>
interval_start: IntegratedObservationPropertyHandling  # value = <IntegratedObservationPropertyHandling.interval_start: 0>
interval_undefined: IntegratedObservationPropertyHandling  # value = <IntegratedObservationPropertyHandling.interval_undefined: 2>
