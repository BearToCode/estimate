...
class ObservationSimulationSettings:
    ...
    """
    @property
    def noise_function(self) -> collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]:
        """
    ...
    def noise_function(self, arg1: collections.abc.Callable[[typing.SupportsFloat], float]) -> None:
        ...
    @property
    ...
    def viability_settings_list(self, arg1: collections.abc.Sequence[...]) -> None:
        ...
class TabulatedObservationSimulationSettings(ObservationSimulationSettings):
    ...
    """
def change_simulation_settings_observable_types(observation_simulation_settings: collections.abc.Sequence[ObservationSimulationSettings], replacement_observable_types: collections.abc.Mapping[tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType, tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType] = ...) -> None:
    """
    No documentation found.
    """
def continuous_arc_simulation_settings(observable_type: tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType, link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, start_time: tudatpy.kernel.astro.time_representation.Time, end_time: tudatpy.kernel.astro.time_representation.Time, interval_between_observations: tudatpy.kernel.astro.time_representation.Time, arc_limiting_constraints: ..., minimum_arc_duration: tudatpy.kernel.astro.time_representation.Time, maximum_arc_duration: tudatpy.kernel.astro.time_representation.Time, minimum_time_between_arcs: tudatpy.kernel.astro.time_representation.Time, reference_link_end_type: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType = ..., additional_viability_settings: collections.abc.Sequence[...] = [], noise_function: collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]] = None) -> ObservationSimulationSettings:
    """
    ...
    """
def continuous_arc_simulation_settings_list(link_ends_per_observable: collections.abc.Mapping[tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType, collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition]], start_time: tudatpy.kernel.astro.time_representation.Time, end_time: tudatpy.kernel.astro.time_representation.Time, interval_between_observations: tudatpy.kernel.astro.time_representation.Time, arc_limiting_constraints: ..., minimum_arc_duration: tudatpy.kernel.astro.time_representation.Time, maximum_arc_duration: tudatpy.kernel.astro.time_representation.Time, minimum_time_between_arcs: tudatpy.kernel.astro.time_representation.Time, reference_link_end_type: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType = ..., additional_viability_settings: collections.abc.Sequence[...] = []) -> list[ObservationSimulationSettings]:
    """
    ...
    """
def create_observation_simulators(observation_settings: collections.abc.Sequence[tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservationModelSettings], bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies) -> list[tudatpy.kernel.estimation.observable_models.observables_simulation.ObservationSimulator]:
    """
    ...
    """
def observation_settings_from_collection(observation_collection: tudatpy.kernel.estimation.observations.ObservationCollection, bodies: tudatpy.kernel.dynamics.environment.SystemOfBodies) -> list[ObservationSimulationSettings]:
    """
    No documentation found.
    """
def tabulated_simulation_settings(observable_type: tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType, link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition, simulation_times: collections.abc.Sequence[tudatpy.kernel.astro.time_representation.Time], reference_link_end_type: tudatpy.kernel.estimation.observable_models_setup.links.LinkEndType = ..., viability_settings: collections.abc.Sequence[...] = [], noise_function: collections.abc.Callable[[typing.SupportsFloat], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]] = None, ancilliary_settings: tudatpy.kernel.estimation.observations_setup.ancillary_settings.ObservationAncilliarySimulationSettings = None) -> ObservationSimulationSettings:
    """
