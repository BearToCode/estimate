...
import typing
__all__: list[str] = ['ObservationViabilitySettings', 'ObservationViabilityType', 'add_viability_check_to_all', 'add_viability_check_to_observable', 'add_viability_check_to_observable_for_link_ends', 'body_avoidance_angle', 'body_avoidance_viability', 'body_avoidance_viability_list', 'body_occultation', 'body_occultation_viability', 'body_occultation_viability_list', 'elevation_angle_viability', 'elevation_angle_viability_list', 'minimum_elevation_angle']
...
class ObservationViabilityType:
    ...
    Members:
      ...
      body_occultation
    """
    __members__: typing.ClassVar[dict[str, ObservationViabilityType]]  # value = {'minimum_elevation_angle': <ObservationViabilityType.minimum_elevation_angle: 0>, 'body_avoidance_angle': <ObservationViabilityType.body_avoidance_angle: 1>, 'body_occultation': <ObservationViabilityType.body_occultation: 2>}
    body_avoidance_angle: typing.ClassVar[ObservationViabilityType]  # value = <ObservationViabilityType.body_avoidance_angle: 1>
    body_occultation: typing.ClassVar[ObservationViabilityType]  # value = <ObservationViabilityType.body_occultation: 2>
    minimum_elevation_angle: typing.ClassVar[ObservationViabilityType]  # value = <ObservationViabilityType.minimum_elevation_angle: 0>
    ...
    def value(self) -> int:
        ...
def add_viability_check_to_all(observation_simulation_settings_list: collections.abc.Sequence[tudatpy.kernel.estimation.observations_setup.observations_simulation_settings.ObservationSimulationSettings], viability_settings: collections.abc.Sequence[ObservationViabilitySettings]) -> None:
    """
    ...
    """
def add_viability_check_to_observable(observation_simulation_settings_list: collections.abc.Sequence[tudatpy.kernel.estimation.observations_setup.observations_simulation_settings.ObservationSimulationSettings], viability_settings: collections.abc.Sequence[ObservationViabilitySettings], observable_type: tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType) -> None:
    """
     Function for including viability checks into existing observation simulation settings.
     ...
     None
         The :class:`~tudatpy.estimation.observations_setup.viability.ObservationSimulationSettings` object(s) are changed in-place.
    """
def add_viability_check_to_observable_for_link_ends(observation_simulation_settings_list: collections.abc.Sequence[tudatpy.kernel.estimation.observations_setup.observations_simulation_settings.ObservationSimulationSettings], viability_settings: collections.abc.Sequence[ObservationViabilitySettings], observable_type: tudatpy.kernel.estimation.observable_models_setup.model_settings.ObservableType, link_ends: tudatpy.kernel.estimation.observable_models_setup.links.LinkDefinition) -> None:
    """
     Function for including viability checks into existing observation simulation settings.
     ...
     None
    """
def body_avoidance_viability(link_end_id: tuple[str, str], body_to_avoid: str, avoidance_angle: typing.SupportsFloat) -> ObservationViabilitySettings:
    """
    ...
    """
def body_avoidance_viability_list(link_end_ids: collections.abc.Sequence[tuple[str, str]], body_to_avoid: str, avoidance_angle: typing.SupportsFloat) -> list[ObservationViabilitySettings]:
    """
...
def body_occultation_viability(link_end_id: tuple[str, str], occulting_body: str) -> ObservationViabilitySettings:
    """
     ...
     :class:`ObservationViabilitySettings`
         Instance of the :class:`~tudatpy.estimation.observations_setup.viability.ObservationViabilitySettings`, defining the settings for observation viability.
    """
def body_occultation_viability_list(link_end_ids: collections.abc.Sequence[tuple[str, str]], occulting_body: str) -> list[ObservationViabilitySettings]:
    """
     Function for defining body occultation viability settings.
     ...
     :class:`ObservationViabilitySettings`
         List of :class:`~tudatpy.estimation.observations_setup.viability.ObservationViabilitySettings` objects, each defining the settings for observation viability of one link end.
    """
def elevation_angle_viability(link_end_id: tuple[str, str], elevation_angle: typing.SupportsFloat) -> ObservationViabilitySettings:
    """
    ...
    """
def elevation_angle_viability_list(link_end_ids: collections.abc.Sequence[tuple[str, str]], elevation_angle: typing.SupportsFloat) -> list[ObservationViabilitySettings]:
    """
     ...
     :class:`ObservationViabilitySettings`
         List of :class:`~tudatpy.estimation.observations_setup.viability.ObservationViabilitySettings` objects, each defining the settings for observation viability of one link end.
    """
body_avoidance_angle: ObservationViabilityType  # value = <ObservationViabilityType.body_avoidance_angle: 1>
body_occultation: ObservationViabilityType  # value = <ObservationViabilityType.body_occultation: 2>
minimum_elevation_angle: ObservationViabilityType  # value = <ObservationViabilityType.minimum_elevation_angle: 0>
