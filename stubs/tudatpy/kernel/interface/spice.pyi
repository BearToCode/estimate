...
def clear_kernels() -> None:
    """
     ...
     None
         None
    """
def compute_rotation_matrix_between_frames(original_frame: str, new_frame: str, ephemeris_time: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
    """
    ...
    """
def compute_rotation_matrix_derivative_between_frames(original_frame: str, new_frame: str, ephemeris_time: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]:
    """
    ...
    """
def compute_rotation_quaternion_and_rotation_matrix_derivative_between_frames(original_frame: str, new_frame: str, ephemeris_time: typing.SupportsFloat) -> tuple[..., ..., typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 3]"]]:
    """
...
def convert_date_string_to_ephemeris_time(date_string: str) -> float:
    ...
    """
def convert_ephemeris_time_to_julian_date(ephemeris_time: typing.SupportsFloat) -> float:
    """
    ...
    """
def convert_julian_date_to_ephemeris_time(julian_date: typing.SupportsFloat) -> float:
    """
    ...
    """
def convert_naif_id_to_body_name(naif_id: typing.SupportsInt) -> str:
    """
    ...
    """
def get_angular_velocity_vector_of_frame_in_original_frame(original_frame: str, new_frame: str, ephemeris_time: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
    """
    ...
    """
def get_approximate_utc_from_tdb(ephemeris_time: typing.SupportsFloat) -> float:
    """
...
def get_average_radius(body_name: str) -> float:
    ...
    """
def get_body_cartesian_position_at_epoch(target_body_name: str, observer_body_name: str, reference_frame_name: str, aberration_corrections: str, ephemeris_time: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]:
    """
    ...
    """
def get_body_cartesian_state_at_epoch(target_body_name: str, observer_body_name: str, reference_frame_name: str, aberration_corrections: str, ephemeris_time: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
...
def get_body_gravitational_parameter(body_name: str) -> float:
    ...
    """
def get_body_properties(body_name: str, property: str, max_n_val: typing.SupportsInt) -> list[float]:
    """
    ...
    """
def get_cartesian_state_from_tle_at_epoch(epoch: typing.SupportsFloat, tle: ...) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
    """
...
def load_kernel(kernel_file: str) -> None:
    ...
    """
def load_standard_deprecated_kernels(alternative_kernels: collections.abc.Sequence[str] = []) -> None:
    """
    ...
    """
def load_standard_kernels(alternative_kernels: collections.abc.Sequence[str] = []) -> None:
    """
     Loads the default spice kernels shopped with tudat.
