...
class AvailableLookupScheme:
    ...
    """
    __members__: typing.ClassVar[dict[str, AvailableLookupScheme]]  # value = {'hunting_algorithm': <AvailableLookupScheme.hunting_algorithm: 1>, 'binary_search': <AvailableLookupScheme.binary_search: 2>}
    binary_search: typing.ClassVar[AvailableLookupScheme]  # value = <AvailableLookupScheme.binary_search: 2>
    hunting_algorithm: typing.ClassVar[AvailableLookupScheme]  # value = <AvailableLookupScheme.hunting_algorithm: 1>
...
class BoundaryInterpolationType:
    ...
    """
    __members__: typing.ClassVar[dict[str, BoundaryInterpolationType]]  # value = {'throw_exception_at_boundary': <BoundaryInterpolationType.throw_exception_at_boundary: 0>, 'use_boundary_value': <BoundaryInterpolationType.use_boundary_value: 1>, 'use_boundary_value_with_warning': <BoundaryInterpolationType.use_boundary_value_with_warning: 2>, 'extrapolate_at_boundary': <BoundaryInterpolationType.extrapolate_at_boundary: 3>, 'extrapolate_at_boundary_with_warning': <BoundaryInterpolationType.extrapolate_at_boundary_with_warning: 4>}
    extrapolate_at_boundary: typing.ClassVar[BoundaryInterpolationType]  # value = <BoundaryInterpolationType.extrapolate_at_boundary: 3>
    extrapolate_at_boundary_with_warning: typing.ClassVar[BoundaryInterpolationType]  # value = <BoundaryInterpolationType.extrapolate_at_boundary_with_warning: 4>
    throw_exception_at_boundary: typing.ClassVar[BoundaryInterpolationType]  # value = <BoundaryInterpolationType.throw_exception_at_boundary: 0>
    use_boundary_value: typing.ClassVar[BoundaryInterpolationType]  # value = <BoundaryInterpolationType.use_boundary_value: 1>
    use_boundary_value_with_warning: typing.ClassVar[BoundaryInterpolationType]  # value = <BoundaryInterpolationType.use_boundary_value_with_warning: 2>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class InterpolatorGenerationSettings:
    ...
    """
    def __init__(self, interpolator_settings: InterpolatorSettings, initial_time: typing.SupportsFloat, final_time: typing.SupportsFloat, time_step: typing.SupportsFloat) -> None:
        ...
...
class LagrangeInterpolatorBoundaryHandling:
    ...
    """
    __members__: typing.ClassVar[dict[str, LagrangeInterpolatorBoundaryHandling]]  # value = {'lagrange_cubic_spline_boundary_interpolation': <LagrangeInterpolatorBoundaryHandling.lagrange_cubic_spline_boundary_interpolation: 0>, 'lagrange_no_boundary_interpolation': <LagrangeInterpolatorBoundaryHandling.lagrange_no_boundary_interpolation: 4>}
    lagrange_cubic_spline_boundary_interpolation: typing.ClassVar[LagrangeInterpolatorBoundaryHandling]  # value = <LagrangeInterpolatorBoundaryHandling.lagrange_cubic_spline_boundary_interpolation: 0>
    lagrange_no_boundary_interpolation: typing.ClassVar[LagrangeInterpolatorBoundaryHandling]  # value = <LagrangeInterpolatorBoundaryHandling.lagrange_no_boundary_interpolation: 4>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class LagrangeInterpolatorSettings(InterpolatorSettings):
    ...
    """
    def __init__(self, interpolate_order: typing.SupportsInt, use_long_double_time_step: bool = 0, selected_lookup_scheme: AvailableLookupScheme = ..., lagrange_boundary_handling: LagrangeInterpolatorBoundaryHandling = ..., boundary_handling: BoundaryInterpolationType = ...) -> None:
        ...
class OneDimensionalInterpolatorMatrix:
    ...
    """
    def interpolate(self, independent_variable_value: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
        ...
        """
    @property
    def dependent_values(self) -> list[typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]]:
        """
...
class OneDimensionalInterpolatorMatrixTimeObject:
    ...
    """
    def interpolate(self, independent_variable_value: ...) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        """
                This function performs the interpolation at the requested independent variable value.
...
class OneDimensionalInterpolatorScalar:
    ...
    """
    def interpolate(self, independent_variable_value: typing.SupportsFloat) -> float:
        """
                 This function performs the interpolation at the requested independent variable value.
...
class OneDimensionalInterpolatorVector:
    ...
    """
    def interpolate(self, independent_variable_value: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
        """
                 This function performs the interpolation at the requested independent variable value.
        ...
        """
    @property
    def dependent_values(self) -> list[typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]]:
        """
                 Returns the dependent variable values used by the interpolator.
...
class OneDimensionalInterpolatorVectorTimeObject:
    ...
    """
    def interpolate(self, independent_variable_value: ...) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
        """
                This function performs the interpolation at the requested independent variable value.
                ...
                np.array
                    Interpolated dependent variable value, using implemented algorithm at requested independent variable value
        """
def create_one_dimensional_matrix_interpolator(data_to_interpolate: collections.abc.Mapping[typing.SupportsFloat, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]], interpolator_settings: InterpolatorSettings, data_first_derivatives: collections.abc.Sequence[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]] = []) -> OneDimensionalInterpolatorMatrix:
    """
     ...
     OneDimensionalInterpolatorMatrix
         Interpolator object
    """
def create_one_dimensional_matrix_interpolator_time_object(data_to_interpolate: collections.abc.Mapping[..., typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]], interpolator_settings: InterpolatorSettings, data_first_derivatives: collections.abc.Sequence[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]] = []) -> OneDimensionalInterpolatorMatrixTimeObject:
    """
            ...
            OneDimensionalInterpolatorMatrixTimeObject
                Interpolator object
    """
def create_one_dimensional_scalar_interpolator(data_to_interpolate: collections.abc.Mapping[typing.SupportsFloat, typing.SupportsFloat], interpolator_settings: InterpolatorSettings, data_first_derivatives: collections.abc.Sequence[typing.SupportsFloat] = []) -> OneDimensionalInterpolatorScalar:
    """
     ...
     OneDimensionalInterpolatorScalar
         Interpolator object
    """
def create_one_dimensional_scalar_interpolator_time_object(data_to_interpolate: collections.abc.Mapping[typing.SupportsFloat, typing.SupportsFloat], interpolator_settings: InterpolatorSettings, data_first_derivatives: collections.abc.Sequence[typing.SupportsFloat] = []) -> OneDimensionalInterpolatorScalar:
    """
         ...
         OneDimensionalInterpolatorScalarTimeObject
             Interpolator object
    """
def create_one_dimensional_vector_interpolator(data_to_interpolate: collections.abc.Mapping[typing.SupportsFloat, typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]], interpolator_settings: InterpolatorSettings, data_first_derivatives: collections.abc.Sequence[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]] = []) -> OneDimensionalInterpolatorVector:
    """
     ...
     OneDimensionalInterpolatorVector
         Interpolator object
    """
def create_one_dimensional_vector_interpolator_time_object(data_to_interpolate: collections.abc.Mapping[..., typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]], interpolator_settings: InterpolatorSettings, data_first_derivatives: collections.abc.Sequence[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]] = []) -> OneDimensionalInterpolatorVectorTimeObject:
    """
...
def hermite_spline_interpolation(lookup_scheme: AvailableLookupScheme = ..., boundary_interpolation: BoundaryInterpolationType = ...) -> InterpolatorSettings:
    ...
    """
def interpolator_generation_settings(interpolator_settings: InterpolatorSettings, initial_time: typing.SupportsFloat, final_time: typing.SupportsFloat, time_step: typing.SupportsFloat) -> InterpolatorGenerationSettings:
    """
    No documentation found.
    """
def interpolator_generation_settings_time_object(interpolator_settings: InterpolatorSettings, initial_time: ..., final_time: ..., time_step: ...) -> InterpolatorGenerationSettingsTimeObject:
    ...
    No documentation found.
    """
def lagrange_interpolation(number_of_points: typing.SupportsInt, lookup_scheme: AvailableLookupScheme = ..., boundary_interpolation: BoundaryInterpolationType = ..., lagrange_boundary_handling: LagrangeInterpolatorBoundaryHandling = ...) -> InterpolatorSettings:
    """
...
def piecewise_constant_interpolation(lookup_scheme: AvailableLookupScheme = ..., boundary_interpolation: BoundaryInterpolationType = ...) -> InterpolatorSettings:
    ...
    """
binary_search: AvailableLookupScheme  # value = <AvailableLookupScheme.binary_search: 2>
extrapolate_at_boundary: BoundaryInterpolationType  # value = <BoundaryInterpolationType.extrapolate_at_boundary: 3>
extrapolate_at_boundary_with_warning: BoundaryInterpolationType  # value = <BoundaryInterpolationType.extrapolate_at_boundary_with_warning: 4>
hunting_algorithm: AvailableLookupScheme  # value = <AvailableLookupScheme.hunting_algorithm: 1>
lagrange_cubic_spline_boundary_interpolation: LagrangeInterpolatorBoundaryHandling  # value = <LagrangeInterpolatorBoundaryHandling.lagrange_cubic_spline_boundary_interpolation: 0>
lagrange_no_boundary_interpolation: LagrangeInterpolatorBoundaryHandling  # value = <LagrangeInterpolatorBoundaryHandling.lagrange_no_boundary_interpolation: 4>
throw_exception_at_boundary: BoundaryInterpolationType  # value = <BoundaryInterpolationType.throw_exception_at_boundary: 0>
use_boundary_value: BoundaryInterpolationType  # value = <BoundaryInterpolationType.use_boundary_value: 1>
use_boundary_value_with_warning: BoundaryInterpolationType  # value = <BoundaryInterpolationType.use_boundary_value_with_warning: 2>
