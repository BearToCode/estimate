...
class MaximumIterationHandling:
    ...
    """
    __members__: typing.ClassVar[dict[str, MaximumIterationHandling]]  # value = {'accept_result': <MaximumIterationHandling.accept_result: 0>, 'accept_result_with_warning': <MaximumIterationHandling.accept_result_with_warning: 1>, 'throw_exception': <MaximumIterationHandling.throw_exception: 2>}
    accept_result: typing.ClassVar[MaximumIterationHandling]  # value = <MaximumIterationHandling.accept_result: 0>
    accept_result_with_warning: typing.ClassVar[MaximumIterationHandling]  # value = <MaximumIterationHandling.accept_result_with_warning: 1>
    throw_exception: typing.ClassVar[MaximumIterationHandling]  # value = <MaximumIterationHandling.throw_exception: 2>
...
class NewtonRaphsonCore(RootFinderCore):
    def __init__(self, x_tol: typing.SupportsFloat, max_iter: typing.SupportsInt) -> None:
        ...
...
class RootFinderSettings:
    ...
    """
def bisection(relative_variable_tolerance: typing.SupportsFloat = ..., absolute_variable_tolerance: typing.SupportsFloat = ..., root_function_tolerance: typing.SupportsFloat = ..., maximum_iteration: typing.SupportsInt = 1000, maximum_iteration_handling: MaximumIterationHandling = ...) -> RootFinderSettings:
    """
    ...
    """
def halley(relative_variable_tolerance: typing.SupportsFloat = ..., absolute_variable_tolerance: typing.SupportsFloat = ..., root_function_tolerance: typing.SupportsFloat = ..., maximum_iteration: typing.SupportsInt = 1000, maximum_iteration_handling: MaximumIterationHandling = ...) -> RootFinderSettings:
    """
    ...
    """
def newton_raphson(relative_variable_tolerance: typing.SupportsFloat = ..., absolute_variable_tolerance: typing.SupportsFloat = ..., root_function_tolerance: typing.SupportsFloat = ..., maximum_iteration: typing.SupportsInt = 1000, maximum_iteration_handling: MaximumIterationHandling = ...) -> RootFinderSettings:
    """
    ...
    """
def secant(relative_variable_tolerance: typing.SupportsFloat = ..., absolute_variable_tolerance: typing.SupportsFloat = ..., root_function_tolerance: typing.SupportsFloat = ..., maximum_iteration: typing.SupportsInt = 1000, maximum_iteration_handling: MaximumIterationHandling = ...) -> RootFinderSettings:
    """
    ...
    """
accept_result: MaximumIterationHandling  # value = <MaximumIterationHandling.accept_result: 0>
accept_result_with_warning: MaximumIterationHandling  # value = <MaximumIterationHandling.accept_result_with_warning: 1>
throw_exception: MaximumIterationHandling  # value = <MaximumIterationHandling.throw_exception: 2>
