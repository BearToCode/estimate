...
def hodograph_constant() -> BaseFunctionHodographicShaping:
    ...
    """
def hodograph_cosine(frequency: typing.SupportsFloat) -> BaseFunctionHodographicShaping:
    """
    ...
    """
def hodograph_exponential(exponent: typing.SupportsFloat) -> BaseFunctionHodographicShaping:
    ...
def hodograph_exponential_cosine(exponent: typing.SupportsFloat, frequency: typing.SupportsFloat) -> BaseFunctionHodographicShaping:
    ...
def hodograph_exponential_sine(exponent: typing.SupportsFloat, frequency: typing.SupportsFloat) -> BaseFunctionHodographicShaping:
    ...
def hodograph_power(exponent: typing.SupportsFloat) -> BaseFunctionHodographicShaping:
    ...
def hodograph_power_cosine(exponent: typing.SupportsFloat, frequency: typing.SupportsFloat, scale_factor: typing.SupportsFloat = 1.0) -> BaseFunctionHodographicShaping:
    """
    ...
    """
def hodograph_power_sine(exponent: typing.SupportsFloat, frequency: typing.SupportsFloat, scale_factor: typing.SupportsFloat = 1.0) -> BaseFunctionHodographicShaping:
    """
    ...
    """
def hodograph_scaled_exponential(exponent: typing.SupportsFloat, scale_factor: typing.SupportsFloat = 1.0) -> BaseFunctionHodographicShaping:
    """
    No documentation found.
    """
def hodograph_scaled_exponential_cosine(exponent: typing.SupportsFloat, frequency: typing.SupportsFloat, scale_factor: typing.SupportsFloat = 1.0) -> BaseFunctionHodographicShaping:
    """
    No documentation found.
    """
def hodograph_scaled_exponential_sine(exponent: typing.SupportsFloat, frequency: typing.SupportsFloat, scale_factor: typing.SupportsFloat = 1.0) -> BaseFunctionHodographicShaping:
    """
    No documentation found.
    """
def hodograph_scaled_power(exponent: typing.SupportsFloat, scale_factor: typing.SupportsFloat = 1.0) -> BaseFunctionHodographicShaping:
    """
    No documentation found.
    """
def hodograph_scaled_power_cosine(exponent: typing.SupportsFloat, frequency: typing.SupportsFloat, scale_factor: typing.SupportsFloat) -> BaseFunctionHodographicShaping:
    """
    No documentation found.
    """
def hodograph_scaled_power_sine(exponent: typing.SupportsFloat, frequency: typing.SupportsFloat, scale_factor: typing.SupportsFloat) -> BaseFunctionHodographicShaping:
    """
    No documentation found.
    """
def hodograph_sine(frequency: typing.SupportsFloat) -> BaseFunctionHodographicShaping:
    """
     ...
     BaseFunctionHodographicShaping
         Settings object for a cosine contribution to hodographic shaping.
    """
def recommended_axial_hodograph_functions(time_of_flight: typing.SupportsFloat, number_of_revolutions: typing.SupportsInt) -> list[BaseFunctionHodographicShaping]:
    """
    ...
    """
def recommended_normal_hodograph_functions(time_of_flight: typing.SupportsFloat) -> list[BaseFunctionHodographicShaping]:
    """
     ...
     * Power function, see :func:`hodograph_power`, with exponent = 2.0, scale_factor = :math:`1/T`
     ...
     list[BaseFunctionHodographicShaping]
         List of default settings object for axial hodographic shaping
    """
def recommended_radial_hodograph_functions(time_of_flight: typing.SupportsFloat) -> list[BaseFunctionHodographicShaping]:
    """
