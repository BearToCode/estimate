...
import tudatpy.kernel.trajectory_design.shape_based_thrust
import typing
...
class TransferLeg:
    ...
    """
    def state_along_trajectory(self, time_since_leg_beginning: typing.SupportsFloat) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]:
        """
...
class TransferLegTypes:
    ...
    """
    __members__: typing.ClassVar[dict[str, TransferLegTypes]]  # value = {'unpowered_unperturbed_leg_type': <TransferLegTypes.unpowered_unperturbed_leg_type: 0>, 'dsm_position_based_leg_type': <TransferLegTypes.dsm_position_based_leg_type: 1>, 'dsm_velocity_based_leg_type': <TransferLegTypes.dsm_velocity_based_leg_type: 2>, 'spherical_shaping_low_thrust_leg': <TransferLegTypes.spherical_shaping_low_thrust_leg: 4>, 'hodographic_low_thrust_leg': <TransferLegTypes.hodographic_low_thrust_leg: 3>}
    dsm_position_based_leg_type: typing.ClassVar[TransferLegTypes]  # value = <TransferLegTypes.dsm_position_based_leg_type: 1>
    dsm_velocity_based_leg_type: typing.ClassVar[TransferLegTypes]  # value = <TransferLegTypes.dsm_velocity_based_leg_type: 2>
    hodographic_low_thrust_leg: typing.ClassVar[TransferLegTypes]  # value = <TransferLegTypes.hodographic_low_thrust_leg: 3>
    spherical_shaping_low_thrust_leg: typing.ClassVar[TransferLegTypes]  # value = <TransferLegTypes.spherical_shaping_low_thrust_leg: 4>
    unpowered_unperturbed_leg_type: typing.ClassVar[TransferLegTypes]  # value = <TransferLegTypes.unpowered_unperturbed_leg_type: 0>
...
class TransferTrajectory:
    ...
    """
    def evaluate(self, node_times: collections.abc.Sequence[typing.SupportsFloat], leg_parameters: collections.abc.Sequence[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]], node_parameters: collections.abc.Sequence[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]]) -> None:
        """
                 ...
                 None
                     None
        """
    def inertial_thrust_accelerations_along_trajectory(self, number_of_data_points_per_leg: typing.SupportsInt) -> dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]]:
        """
        ...
        """
    def rsw_thrust_accelerations_along_trajectory(self, number_of_data_points_per_leg: typing.SupportsInt) -> dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]]:
        """
                 ...
                 tuple[numpy.ndarray,numpy.ndarray]
                     Tuple of (state history, time history).
        """
    def single_leg_delta_v(self, leg_index: typing.SupportsInt) -> float:
        """
        ...
        """
    def single_node_delta_v(self, node_index: typing.SupportsInt) -> float:
        """
        ...
        """
    def states_along_trajectory(self, number_of_data_points_per_leg: typing.SupportsInt) -> dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 1]"]]:
        """
                 ...
                 tuple[numpy.ndarray,numpy.ndarray]
                     Tuple of (state history, time history).
        """
    def tnw_thrust_accelerations_along_trajectory(self, number_of_data_points_per_leg: typing.SupportsInt) -> dict[float, typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3, 1]"]]:
        """
    ...
    def time_of_flight(self) -> float:
        """
                 **read-only**
                 ...
                 :type: float
        """
def capture_node(capture_semi_major_axis: typing.SupportsFloat, capture_eccentricity: typing.SupportsFloat) -> TransferNodeSettings:
    """
    ...
    """
def create_transfer_trajectory(bodies: ..., leg_settings: collections.abc.Sequence[TransferLegSettings], node_settings: collections.abc.Sequence[TransferNodeSettings], node_names: collections.abc.Sequence[str], central_body: str) -> TransferTrajectory:
    """
...
def dsm_velocity_based_leg() -> TransferLegSettings:
    """
     ...
     TransferLegSettings
         Transfer leg settings.
    """
def hodographic_shaping_leg(radial_velocity_function_components: collections.abc.Sequence[tudatpy.kernel.trajectory_design.shape_based_thrust.BaseFunctionHodographicShaping], normal_velocity_function_components: collections.abc.Sequence[tudatpy.kernel.trajectory_design.shape_based_thrust.BaseFunctionHodographicShaping], axial_velocity_function_components: collections.abc.Sequence[tudatpy.kernel.trajectory_design.shape_based_thrust.BaseFunctionHodographicShaping]) -> TransferLegSettings:
    """
     ...
     TransferLegSettings
         Transfer leg settings.
    """
def mga_settings_dsm_position_based_legs(body_order: collections.abc.Sequence[str], departure_orbit: tuple[typing.SupportsFloat, typing.SupportsFloat] = ..., arrival_orbit: tuple[typing.SupportsFloat, typing.SupportsFloat] = ..., minimum_pericenters: collections.abc.Mapping[str, typing.SupportsFloat] = {'Earth': 6678000.0, 'Jupiter': 600000000.0, 'Mars': 3689000.0, 'Mercury': 2740000.0, 'Saturn': 70000000.0, 'Venus': 6351800.0}) -> tuple[list[TransferLegSettings], list[TransferNodeSettings]]:
    """
    ...
    """
def mga_settings_dsm_velocity_based_legs(body_order: collections.abc.Sequence[str], departure_orbit: tuple[typing.SupportsFloat, typing.SupportsFloat] = ..., arrival_orbit: tuple[typing.SupportsFloat, typing.SupportsFloat] = ..., minimum_pericenters: collections.abc.Mapping[str, typing.SupportsFloat] = {'Earth': 6678000.0, 'Jupiter': 600000000.0, 'Mars': 3689000.0, 'Mercury': 2740000.0, 'Saturn': 70000000.0, 'Venus': 6351800.0}) -> tuple[list[TransferLegSettings], list[TransferNodeSettings]]:
    """
     Function to get the legs and nodes settings of a transfer constituted by legs with 1 impulsive deep space maneuver (DSM)
     ...
     tuple[ list[TransferLegSettings], list[TransferNodeSettings] ]
         Tuple specifying the settings of each transfer leg and node.
    """
def mga_settings_hodographic_shaping_legs(body_order: collections.abc.Sequence[str], radial_velocity_function_components_per_leg: collections.abc.Sequence[collections.abc.Sequence[tudatpy.kernel.trajectory_design.shape_based_thrust.BaseFunctionHodographicShaping]], normal_velocity_function_components_per_leg: collections.abc.Sequence[collections.abc.Sequence[tudatpy.kernel.trajectory_design.shape_based_thrust.BaseFunctionHodographicShaping]], axial_velocity_function_components_per_leg: collections.abc.Sequence[collections.abc.Sequence[tudatpy.kernel.trajectory_design.shape_based_thrust.BaseFunctionHodographicShaping]], departure_orbit: tuple[typing.SupportsFloat, typing.SupportsFloat] = ..., arrival_orbit: tuple[typing.SupportsFloat, typing.SupportsFloat] = ..., minimum_pericenters: collections.abc.Mapping[str, typing.SupportsFloat] = {'Earth': 6678000.0, 'Jupiter': 600000000.0, 'Mars': 3689000.0, 'Mercury': 2740000.0, 'Saturn': 70000000.0, 'Venus': 6351800.0}) -> tuple[list[TransferLegSettings], list[TransferNodeSettings]]:
    """
     ...
     tuple[ list[TransferLegSettings], list[TransferNodeSettings] ]
         Tuple specifying the settings of each transfer leg and node.
    """
def mga_settings_hodographic_shaping_legs_with_recommended_functions(body_order: collections.abc.Sequence[str], time_of_flight_per_leg: collections.abc.Sequence[typing.SupportsFloat], number_of_revolutions_per_leg: collections.abc.Sequence[typing.SupportsFloat], departure_orbit: tuple[typing.SupportsFloat, typing.SupportsFloat] = ..., arrival_orbit: tuple[typing.SupportsFloat, typing.SupportsFloat] = ..., minimum_pericenters: collections.abc.Mapping[str, typing.SupportsFloat] = {'Earth': 6678000.0, 'Jupiter': 600000000.0, 'Mars': 3689000.0, 'Mercury': 2740000.0, 'Saturn': 70000000.0, 'Venus': 6351800.0}) -> tuple[list[TransferLegSettings], list[TransferNodeSettings]]:
    """
     Function to get the legs and nodes settings of a transfer constituted by low-thrust hodographic shaping legs,
     with user-provided velocity shaping functions.
     ...
     tuple[ list[TransferLegSettings], list[TransferNodeSettings] ]
         Tuple specifying the settings of each transfer leg and node.
    """
def mga_settings_spherical_shaping_legs(body_order: collections.abc.Sequence[str], root_finder_settings: tudatpy.kernel.math.root_finders.RootFinderSettings, departure_orbit: tuple[typing.SupportsFloat, typing.SupportsFloat] = ..., arrival_orbit: tuple[typing.SupportsFloat, typing.SupportsFloat] = ..., lower_bound_free_coefficient: typing.SupportsFloat = ..., upper_bound_free_coefficient: typing.SupportsFloat = ..., initial_value_free_coefficient: typing.SupportsFloat = ..., minimum_pericenters: collections.abc.Mapping[str, typing.SupportsFloat] = {'Earth': 6678000.0, 'Jupiter': 600000000.0, 'Mars': 3689000.0, 'Mercury': 2740000.0, 'Saturn': 70000000.0, 'Venus': 6351800.0}) -> tuple[list[TransferLegSettings], list[TransferNodeSettings]]:
    """
...
def mga_settings_unpowered_unperturbed_legs(body_order: collections.abc.Sequence[str], departure_orbit: tuple[typing.SupportsFloat, typing.SupportsFloat] = ..., arrival_orbit: tuple[typing.SupportsFloat, typing.SupportsFloat] = ..., minimum_pericenters: collections.abc.Mapping[str, typing.SupportsFloat] = {'Earth': 6678000.0, 'Jupiter': 600000000.0, 'Mars': 3689000.0, 'Mercury': 2740000.0, 'Saturn': 70000000.0, 'Venus': 6351800.0}) -> tuple[list[TransferLegSettings], list[TransferNodeSettings]]:
    """
     ...
     tuple[ list[TransferLegSettings], list[TransferNodeSettings] ]
         Tuple specifying the settings of each transfer leg and node.
    """
def print_parameter_definitions(leg_settings: collections.abc.Sequence[TransferLegSettings], node_settings: collections.abc.Sequence[TransferNodeSettings]) -> None:
    """
...
def set_low_thrust_acceleration(transfer_leg: TransferLeg, bodies: ..., body_name: str, engine_name: str) -> None:
    ...
    No documentation found.
    """
def spherical_shaping_leg(root_finder_settings: tudatpy.kernel.math.root_finders.RootFinderSettings, lower_bound_free_coefficient: typing.SupportsFloat = ..., upper_bound_free_coefficient: typing.SupportsFloat = ..., initial_value_free_coefficient: typing.SupportsFloat = ..., time_to_azimuth_interpolator_step_size: typing.SupportsFloat = 86400.0) -> TransferLegSettings:
    """
     ...
     TransferLegSettings
         Transfer leg settings.
    """
def swingby_node(minimum_periapsis: typing.SupportsFloat = ...) -> TransferNodeSettings:
    """
...
dsm_position_based_leg_type: TransferLegTypes  # value = <TransferLegTypes.dsm_position_based_leg_type: 1>
dsm_velocity_based_leg_type: TransferLegTypes  # value = <TransferLegTypes.dsm_velocity_based_leg_type: 2>
hodographic_low_thrust_leg: TransferLegTypes  # value = <TransferLegTypes.hodographic_low_thrust_leg: 3>
spherical_shaping_low_thrust_leg: TransferLegTypes  # value = <TransferLegTypes.spherical_shaping_low_thrust_leg: 4>
unpowered_unperturbed_leg_type: TransferLegTypes  # value = <TransferLegTypes.unpowered_unperturbed_leg_type: 0>
