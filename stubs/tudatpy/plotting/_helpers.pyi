...
__all__: list[str] = ['dual_y_axis', 'matplotlib', 'np', 'pareto_front', 'pareto_optimums', 'plt', 'result2array', 'trajectory_3d']
def dual_y_axis(x_data: list, y_data_1: list, y_data_2: list, x_label: str, y_label_1: str, y_label_2: str, title: str = '', c1: str = 'tab:blue', c2: str = 'tab:red', grid: str = ''):
    ...
    """
def pareto_front(x_objective: list, y_objective: list, x_label: str, y_label: str, title: str = '', c_parameter: typing.Optional[list] = None, c_label: str = '', cmap: typing.Union[matplotlib.colors.Colormap, str] = 'viridis', operator: typing.List[typing.Union[<built-in function min>, <built-in function max>]] = [min, min], alpha: float = 0.85):
    """
