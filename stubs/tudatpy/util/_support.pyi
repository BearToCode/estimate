...
__all__: list[str] = ['compare_results', 'interpolators', 'np', 'os', 'pareto_optimums', 'redirect_std', 'result2array', 'vector2matrix']
class redirect_std:
    """
    ...
    def __init__(self, redirect_file_path: typing.Optional[str] = None, redirect_out: bool = True, redirect_err: bool = True):
        ...
def compare_results(baseline_results: dict[float, numpy.ndarray], new_results: dict[float, numpy.ndarray], difference_epochs: list[float]):
    """
    ...
    """
def pareto_optimums(_points: list, operator: typing.Optional[list[typing.Callable]] = None):
    """
    ...
    """
def result2array(result: dict[float, numpy.ndarray]):
    """
